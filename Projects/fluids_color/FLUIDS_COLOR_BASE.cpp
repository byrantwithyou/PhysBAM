...
//#####################################################################
template class FLUIDS_COLOR_BASE<VECTOR<float,2> >;
template class FLUIDS_COLOR_BASE<VECTOR<float,3> >;
template class FLUIDS_COLOR_BASE<VECTOR<double,2> >;
template class FLUIDS_COLOR_BASE<VECTOR<double,3> >;
}
