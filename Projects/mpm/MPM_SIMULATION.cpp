...
MPM_SIMULATION()
    :dump_matrix(false),test_system(false),min_mass(1e-8),min_rho((T)0),use_plasticity_yield(true),use_gravity(true),FLIP_alpha((T)0.95),friction_coefficient((T)0.1),visco_nu(1e5),visco_tau(200)
{}
//#####################################################################
// Destructor
//#####################################################################
