...
#
# ../mpm -affine -symplectic_euler -o $NAME-apic-symp $ARGS -max_dt 1e-2 >/dev/null &
# ../mpm -symplectic_euler -o $NAME-pic-symp $ARGS -max_dt 1e-2 >/dev/null &
# ../mpm -flip 1 -symplectic_euler -o $NAME-flip-symp $ARGS -max_dt 1e-2 >/dev/null &
# wait
# fi
