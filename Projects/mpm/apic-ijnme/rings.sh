...
# ARGS="4 -max_dt 1e-5 -framerate 2400 -newton_tolerance 1e-2 -regular_seeding -print_stats -last_frame 24"
# if : ; then
...
# ../mpm -affine -symplectic_euler -o $NAME-apic-symp $ARGS >/dev/null &
# ../mpm -symplectic_euler -o $NAME-pic-symp $ARGS >/dev/null &
# ../mpm -flip 1 -symplectic_euler -o $NAME-flip-symp $ARGS >/dev/null &
# wait
# fi
