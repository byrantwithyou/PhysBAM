...
public:
    ...
    using BASE::data_directory;using BASE::output_directory;using BASE::restart;using BASE::dt;using BASE::time;
    ...
    using BASE::Add_Force;using BASE::quad_F_coeff;using BASE::use_penalty_collisions;
