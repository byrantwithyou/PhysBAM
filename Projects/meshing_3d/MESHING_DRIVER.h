...
{  
    ...
    Write_To_File(example.stream_type,example.tetrahedral_meshing.viewer_dir.output_directory,deformable_body_collection.template Find_Structure<TETRAHEDRALIZED_VOLUME<T>&>());
}
//##############################################################################
};
#endif
