...
virtual void Initialize_Implicit_Surface()
{
    // read octree or levelset implicit surface from file
        ...
        Create_From_File(implicit_surface_filename,multiple_levelset_implicit_surface.primary_levelset);
        LOG::Stop_Time();
        ...
        for(int secondary_index=1;;secondary_index++){
            ...
            Create_From_File(LOG::sprintf("%s_secondary_%d",implicit_surface_filename.c_str(),secondary_index),
        ...
        Read_From_File(implicit_surface_filename,levelset_implicit_surface);
