...
#include <Deformables/Forces/SIMPLE_TRIANGLE_BENDING_ELEMENTS.h>
...
public:
        ...
        opt_residuals(false)
    {
        ...
        switch(test_number){
            ...
            case 9:
                if(!user_last_frame){
                    if(test_number==6) last_frame=(int)frame_rate;
                    else if(test_number==9) last_frame=(int)(10*frame_rate);
                    else last_frame=(int)(5*frame_rate);}
            ...
            case 11:
                if(!user_last_frame) last_frame=(int)(14*frame_rate);
            ...
            case 33:
            case 34:
                if(!this->user_frame_rate) frame_rate=1;
                if(!user_last_frame) last_frame=(int)(7*frame_rate);
                aspect_ratio=1;
            ...
            case 41:
                ...
                if(!user_last_frame) last_frame=200;//(int)(200*frame_rate);
                aspect_ratio=1;
                side_length=(T)1;
...
//            tests.Substitute_Soft_Bindings_For_Embedded_Nodes(embedding.material_surface,soft_bindings);
        ...
        case 20:{
            ...
            for(int t=0;t<tetrahedralized_volume.triangulated_surface->mesh.elements.m;t++)
                triangulated_surface->mesh.elements.Append(VECTOR<int,3>(child_particles.Subset(tetrahedralized_volume.triangulated_surface->mesh.elements(t))));
