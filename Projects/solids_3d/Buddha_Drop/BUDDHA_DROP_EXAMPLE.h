...
//#####################################################################
// Class BUDDHA_DROP_EXAMPLE
//##################################################################### 
#ifndef __BUDDHA_DROP_EXAMPLE__
#define __BUDDHA_DROP_EXAMPLE__

#include "../CLOTH_EXAMPLE.h"
namespace PhysBAM{

template<class T>
class BUDDHA_DROP_EXAMPLE:public CLOTH_EXAMPLE<T>
{
public:
    T height;
        ...
        :height(0)
    {
        ...
        use_bending_elements=false;use_bending_springs=true;
        ...
        output_directory="Buddha_Drop/output";
