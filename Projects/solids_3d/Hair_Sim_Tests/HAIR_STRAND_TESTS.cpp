...
Initialize_Bodies()
{
    ...
    Read_From_File(LOG::sprintf("%s/%s/fixed_nodes_start",data_directory.c_str(),sim_folder.c_str()),fixed_nodes_start);
    Read_From_File(LOG::sprintf("%s/%s/fixed_nodes_end",data_directory.c_str(),sim_folder.c_str()),fixed_nodes_end);
