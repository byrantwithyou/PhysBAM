...
//##################################################################### 
#ifndef __BARYCENTRIC_TETRAHEDRON_SPRING_CONSTRAINT__
#define __BARYCENTRIC_TETRAHEDRON_SPRING_CONSTRAINT__
...
template<class T>
class BARYCENTRIC_TETRAHEDRON_SPRING_CONSTRAINT:public SOLIDS_FORCES<T,VECTOR<T,3> >
{
public:
...
public:  
    ...
    ARRAY<VECTOR<T,3> >& constrained_location_weights;
    ARRAY<VECTOR<T,3> >& constrained_node_locations;
...
public: 
    ...
    ~BARYCENTRIC_TETRAHEDRON_SPRING_CONSTRAINT()
    {}
