...
//#####################################################################
// Class ARMADILLO_DROP_BACK_EXAMPLE
//##################################################################### 
#ifndef __ARMADILLO_DROP_BACK_EXAMPLE__
#define __ARMADILLO_DROP_BACK_EXAMPLE__

#include "../CLOTH_EXAMPLE.h"
namespace PhysBAM{

template<class T>
class ARMADILLO_DROP_BACK_EXAMPLE:public CLOTH_EXAMPLE<T>
{
public:
    T height;
    QUATERNION<T> initial_orientation;

    ARMADILLO_DROP_BACK_EXAMPLE()
        :height(0),initial_orientation((T).5*(T)3.14,VECTOR_3D<T>(1,0,0))
    {
        ...
        output_directory="Armadillo_Drop_Back/output";
    ...
    virtual ~ARMADILLO_DROP_BACK_EXAMPLE()
    {}
