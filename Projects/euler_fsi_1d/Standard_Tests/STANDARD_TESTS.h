...
#include <Compressible/Equations_Of_State/EOS_CLAMPED_INTERNAL_ENERGY.h>
...
public:
    ...
    using BASE::solid_body_collection;using BASE::test_number;using BASE::resolution;using BASE::data_directory;
