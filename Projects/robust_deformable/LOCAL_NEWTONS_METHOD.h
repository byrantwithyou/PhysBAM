...
struct LOCAL_NEWTONS_METHOD
{
    ...
    LOCAL_NEWTONS_METHOD()
        ...
        max_krylov_iterations(100000),max_golden_section_iterations(10*sizeof(T)),max_wolfe_iterations(10*sizeof(T)),a_tolerance(-(T)2.0),angle_tolerance(0),use_cg(false),c1(0.00001),c2(0.9)
    {}
