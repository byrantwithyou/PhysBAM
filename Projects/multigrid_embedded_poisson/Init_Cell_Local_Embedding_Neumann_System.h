...
#ifndef PHYSBAM_PROJECTS_MULTIGRID_EMBEDDED_POISSON_INIT_CELL_LOCAL_EMBEDDING_NEUMANN_SYSTEM_HPP
#define PHYSBAM_PROJECTS_MULTIGRID_EMBEDDED_POISSON_INIT_CELL_LOCAL_EMBEDDING_NEUMANN_SYSTEM_HPP
...
//#define PHYSBAM_MULTIGRID_EMBEDDED_POISSON_USE_Q_BAR
...
#ifdef PHYSBAM_MULTIGRID_EMBEDDED_POISSON_USE_Q_BAR
    T average_beta_grad_u_dot_n = 0;
#else // #ifdef PHYSBAM_MULTIGRID_EMBEDDED_POISSON_USE_Q_BAR
    VECTOR< T, STATIC_POW_C<2,D>::value > beta_grad_u_dot_n_times_monomials_integrated_over_boundary; // init'ed to 0
#endif // #ifdef PHYSBAM_MULTIGRID_EMBEDDED_POISSON_USE_Q_BAR
...
template<
    ...
    class T_SYSTEM_RHS_OF_INDEX
>
struct INIT_CELL_LOCAL_EMBEDDING_NEUMANN_SYSTEM_VISITOR
{
    typedef VECTOR<int,D> MULTI_INDEX_TYPE;
    PHYSBAM_DIRECT_INIT_CTOR_DECLARE_PRIVATE_MEMBERS(
        INIT_CELL_LOCAL_EMBEDDING_NEUMANN_SYSTEM_VISITOR,
...
template<
    ...
    class T_SYSTEM_RHS_OF_INDEX
>
inline INIT_CELL_LOCAL_EMBEDDING_NEUMANN_SYSTEM_VISITOR<
    T, D,
    T_PHI_OF_FINE_INDEX,
    T_BETA_OF_INDEX,
    T_F_OF_INDEX,
...
{
    return INIT_CELL_LOCAL_EMBEDDING_NEUMANN_SYSTEM_VISITOR<
        T, D,
        T_PHI_OF_FINE_INDEX,
        T_BETA_OF_INDEX,
        T_F_OF_INDEX,
...
#endif // #ifndef PHYSBAM_PROJECTS_MULTIGRID_EMBEDDED_POISSON_INIT_CELL_LOCAL_EMBEDDING_NEUMANN_SYSTEM_HPP
