...
public:
    ...
    HASHTABLE<std::string,DEFORMABLE_BODY_COLLECTION<TV>*> deformable_body_collections;
    HASHTABLE<std::string,RIGID_BODY_COLLECTION<TV>*> rigid_body_collection_list;
    HASHTABLE<std::string,RIGID_BODY_COLLECTION<TV>*> rigid_body_collection_cached;
...
//#####################################################################
    ...
    RIGID_BODY_COLLECTION<TV>& Get_Rigid_Objects(PARAMETER_LIST& parameters,int frame,std::string& rigid_body_collection_name);
//#####################################################################
};
}
#endif
