...
#include <Rendering/PhysBAM_Ray_Tracing/Rendering_Shaders/RENDERING_ABSORPTION_SPECTRUM_SHADER.h>
#include <Rendering/PhysBAM_Ray_Tracing/Rendering_Shaders/RENDERING_BLEND_IMPLICIT_SURFACE_SHADER.h>
#include <Rendering/PhysBAM_Ray_Tracing/Rendering_Shaders/RENDERING_BLEND_TRIANGULATED_SURFACE_SHADER.h>
#include <Rendering/PhysBAM_Ray_Tracing/Rendering_Shaders/RENDERING_BUMP_MAP_IMAGE_SHADER.h>
#include <Rendering/PhysBAM_Ray_Tracing/Rendering_Shaders/RENDERING_BUMP_MAP_NORMAL_IMAGE_SHADER.h>
#include <Rendering/PhysBAM_Ray_Tracing/Rendering_Shaders/RENDERING_CAMERA_ORIENTED_NORMAL_SHADER.h>
#include <Rendering/PhysBAM_Ray_Tracing/Rendering_Shaders/RENDERING_CHECKERBOARD_TEXTURE_SHADER.h>
#include <Rendering/PhysBAM_Ray_Tracing/Rendering_Shaders/RENDERING_COLOR_BLEND_SHADER.h>
#include <Rendering/PhysBAM_Ray_Tracing/Rendering_Shaders/RENDERING_FIXED_BLEND_SHADER.h>
#include <Rendering/PhysBAM_Ray_Tracing/Rendering_Shaders/RENDERING_HOMOGENEOUS_VOLUME_SHADER.h>
#include <Rendering/PhysBAM_Ray_Tracing/Rendering_Shaders/RENDERING_INFINITE_REFLECTION_SHADER.h>
#include <Rendering/PhysBAM_Ray_Tracing/Rendering_Shaders/RENDERING_KAJIYA_SHADER.h>
#include <Rendering/PhysBAM_Ray_Tracing/Rendering_Shaders/RENDERING_LAMBERTIAN_SHADER.h>
#include <Rendering/PhysBAM_Ray_Tracing/Rendering_Shaders/RENDERING_LIGHT_SHADER.h>
#include <Rendering/PhysBAM_Ray_Tracing/Rendering_Shaders/RENDERING_MARBLE_SHADER.h>
#include <Rendering/PhysBAM_Ray_Tracing/Rendering_Shaders/RENDERING_MASKED_BLEND_SHADER.h>
#include <Rendering/PhysBAM_Ray_Tracing/Rendering_Shaders/RENDERING_NOISE_TEXTURE_SHADER.h>
#include <Rendering/PhysBAM_Ray_Tracing/Rendering_Shaders/RENDERING_NORMAL_ILLUSTRATION_SHADER.h>
#include <Rendering/PhysBAM_Ray_Tracing/Rendering_Shaders/RENDERING_PHONG_SHADER.h>
#include <Rendering/PhysBAM_Ray_Tracing/Rendering_Shaders/RENDERING_PHOTON_SINK.h>
#include <Rendering/PhysBAM_Ray_Tracing/Rendering_Shaders/RENDERING_REFLECTION_MAP_SHADER.h>
#include <Rendering/PhysBAM_Ray_Tracing/Rendering_Shaders/RENDERING_REFLECTION_SHADER.h>
#include <Rendering/PhysBAM_Ray_Tracing/Rendering_Shaders/RENDERING_SHELL_EMISSION_SHADER.h>
#include <Rendering/PhysBAM_Ray_Tracing/Rendering_Shaders/RENDERING_SUBDIVISION_SHADER.h>
#include <Rendering/PhysBAM_Ray_Tracing/Rendering_Shaders/RENDERING_SUM_SHADER.h>
#include <Rendering/PhysBAM_Ray_Tracing/Rendering_Shaders/RENDERING_TEXTURE_IMAGE_SHADER.h>
#include <Rendering/PhysBAM_Ray_Tracing/Rendering_Shaders/RENDERING_TORRANCE_SPARROW_SHADER.h>
#include <Rendering/PhysBAM_Ray_Tracing/Rendering_Shaders/RENDERING_TRANSLUCENCY_SHADER.h>
#include <Rendering/PhysBAM_Ray_Tracing/Rendering_Shaders/RENDERING_TRANSPARENT_MATERIAL_SHADER.h>
#include <Rendering/PhysBAM_Ray_Tracing/Rendering_Shaders/RENDERING_TRANSPARENT_SHADER.h>
#include <Rendering/PhysBAM_Ray_Tracing/Rendering_Shaders/RENDERING_TRIANGULATED_SURFACE_VERTEX_COLOR_SHADER.h>
#include <Rendering/PhysBAM_Ray_Tracing/Rendering_Shaders/RENDERING_TWO_SIDE_SHADER.h>
#include <Rendering/PhysBAM_Ray_Tracing/Rendering_Shaders/RENDERING_UNIFORM_COLOR_SHADER.h>
#include <Rendering/PhysBAM_Ray_Tracing/Rendering_Shaders/RENDERING_VOXEL_FIRE_SHADER.h>
#include <Rendering/PhysBAM_Ray_Tracing/Rendering_Shaders/RENDERING_VOXEL_SHADER.h>
#include <Rendering/PhysBAM_Ray_Tracing/Rendering_Shaders/RENDERING_WOOD_SHADER.h>
#include <cstdio>
