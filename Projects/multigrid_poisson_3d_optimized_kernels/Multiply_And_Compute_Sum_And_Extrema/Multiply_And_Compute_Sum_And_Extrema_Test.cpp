...
int main(int argc,char *argv[]){
    ...
    Multiplication_Size_Specific_Helper<T,size>::Allocate_Data(x,y,diagonal_part);
    ...
    Multiplication_Size_Specific_Helper<T,size>::Initialize_Data(x,y,diagonal_part);
    Multiplication_Helper<T> test(size,size,size,x,y,diagonal_part,(T)1/(T)size);
