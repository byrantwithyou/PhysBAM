...
int main(int argc,char *argv[]){
    ...
    Copy_Size_Specific_Helper<T,size>::Allocate_Data(x,y,result);
    ...
    Copy_Size_Specific_Helper<T,size>::Initialize_Data(x,y,result);
    Copy_Helper<T> test(size,size,size,alpha,x,y,result);
