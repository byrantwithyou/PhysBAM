...
int main(int argc,char *argv[]){
    ...
    Relaxation_And_Dot_Product_Interior_Size_Specific_Helper<T,size>::Allocate_Data(u,b,r,bit_writemask);
    ...
    Relaxation_And_Dot_Product_Interior_Size_Specific_Helper<T,size>::Initialize_Data(u,b,r,bit_writemask);
    Relaxation_And_Dot_Product_Interior_Helper<T> test(size,size,size,u,b,r,bit_writemask);
