...
int main(int argc,char *argv[]){
    ...
    Saxpy_Size_Specific_Helper<T,size>::Allocate_Data(result,u1);
    ...
    Saxpy_Size_Specific_Helper<T,size>::Initialize_Data(result,u1);
    Saxpy_Helper<T> test(size,size,size,c1,u1,result);
