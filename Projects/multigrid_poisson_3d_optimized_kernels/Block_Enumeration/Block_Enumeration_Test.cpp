...
int main(int argc,char *argv[]){
    ...
    Prolongation_Size_Specific_Helper<T,size>::Allocate_Data(u,u_coarse,bit_writemask);
    ...
    Prolongation_Size_Specific_Helper<T,size>::Initialize_Data(u,u_coarse,bit_writemask);
    Prolongation_Helper<T> test(size,size,size,u,u_coarse,bit_writemask);
