...
int main(int argc,char *argv[]){
    ...
    Reduce_Maxabs_Size_Specific_Helper<T,size>::Allocate_Data(x);
    ...
    Reduce_Maxabs_Size_Specific_Helper<T,size>::Initialize_Data(x);
    Reduce_Maxabs_Helper<T> test(size,size,size,x);
