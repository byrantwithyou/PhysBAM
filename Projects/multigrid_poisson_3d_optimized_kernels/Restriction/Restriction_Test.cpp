...
int main(int argc,char *argv[]){
    ...
    T* r;
    T* b_coarse;
    unsigned char* writemask_coarse;
    ...
    Restriction_Size_Specific_Helper<T,size>::Allocate_Data(r,b_coarse,writemask_coarse);
    ...
    Restriction_Size_Specific_Helper<T,size>::Initialize_Data(r,b_coarse,writemask_coarse);
    Restriction_Helper<T> test(size,size,size,r,b_coarse,writemask_coarse);
...
//        test.Run_Parallel(13);
//        test.Run_Parallel(11);
//        test.Run_Parallel(7);
//        test.Run_Parallel(5);
