...
STANDARD_TESTS(const STREAM_TYPE stream_type)
    ...
    circle_radius(0),circle_perturbation(0),oscillation_mode(2),use_massless_structure(false),coupled_particles(0),make_ellipse(false),m(1),s(1),kg(1),solid_refinement(7),
