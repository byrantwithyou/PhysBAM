                      ...
                      public LEVELSET_CALLBACKS<GRID<TV> >,public FLUIDS_PARAMETERS_CALLBACKS<GRID<TV> >,public NONCOPYABLE
{
    ...
    typedef typename LEVELSET_POLICY<GRID<TV> >::FAST_LEVELSET_T T_FAST_LEVELSET;typedef typename MATRIX_POLICY<TV>::SYMMETRIC_MATRIX SYMMETRIC_MATRIX;
...
#endif // #ifndef PHYSBAM_PROJECTS_TWO_PHASE_FLOW_2D_TEST_PLS_FSI_EXAMPLE_H
