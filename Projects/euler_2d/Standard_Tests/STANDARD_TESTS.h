...
public:
    ...
    using BASE::solids_fluids_parameters;
...
void Parse_Options() PHYSBAM_OVERRIDE
{
    ...
    //fluids_parameters.compressible_conservation_method->Scale_Outgoing_Fluxes_To_Clamp_Variable(true,1,1e-6);
...
{   
    if(test_number==1){
       ...
       RIGID_BODY<TV>& rigid_body=*new RIGID_BODY<TV>(solid_body_collection.rigid_body_collection,true);
        ...
        rigid_body_collection.Rigid_Body(sphere).Inertia_Tensor()=mass_properties.Inertia_Tensor();}
