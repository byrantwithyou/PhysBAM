...
void Parse_Options() PHYSBAM_OVERRIDE
{
    ...
    mattress_grid=GRID<TV>(3,3,(T).26,(T).76,(T).81,(T)1.04);
    mattress_grid_stub=GRID<TV>(2,2,(T)20.25,(T)20.75,(T)-21.05,(T)-21.01);
    ...
    switch(test_number){
        ...
        case 5:
        case 6:
            fluids_parameters.grid->Initialize(10*resolution+1,15*resolution+1,0,1,0,1.5);
            last_frame=1000;
            fluids_parameters.density=(T)1000;
            rigid_body_count=6;
        ...
        case 20:
            last_frame=1000;
            (*fluids_parameters.grid).Initialize((int)(1.5*resolution)+1,resolution+1,(T)0,(T)2,(T)0,(T)1);
            //fluids_parameters.density=(T)300;
            fluids_parameters.gravity=(T)9.8;
            fluids_parameters.density=(T)1000;
...
void Adjust_Density_And_Temperature_With_Sources(const T time) PHYSBAM_OVERRIDE
{
    ...
    BASE::Adjust_Density_And_Temperature_With_Sources(BOX<TV>((T).45,(T).55,(T)0,(T).1),MATRIX<T,3>::Identity_Matrix(),1,fluids_parameters.temperature_products);
}
//#####################################################################
...
//            /*TRIANGULATED_AREA<T>& triangulated_area=*/solids_tests.Create_Mattress(mattress_grid,true,RIGID_BODY_STATE<TV>(FRAME<TV>(TV(0,4))));
        ...
        case 11:{
            ...
            rigid_body.Set_Frame(FRAME<TV>(TV((T).5,(T).5)));
            rigid_body.Rotation()=ROTATION<TV>::From_Angle((T)pi/7);
            rigid_body.Set_Coefficient_Of_Restitution((T)0);
        ...
        case 6:{
            ...
            rigid_body_cup.Set_Frame(FRAME<TV>(TV((T).5,(T).3)));
        ...
        case 9:{
            ...
            rigid_body_sphere.X()=TV((T)0,(T)1);
        ...
        case 20:{
            ...
            rigid_body.thin_shell=false;
            rigid_body.Set_Frame(FRAME<TV>(TV((T)1,(T).15)));
            rigid_body.Set_Coefficient_Of_Restitution((T)0);
            rigid_body.Set_Name("circle");
            T density=100;
            rigid_body.Set_Mass((T)pi*sqr(radius)*(T)density*mass_multiplier);
        ...
        case 30:{
            ...
            RIGID_BODY<TV>& rigid_body=solids_tests.Add_Rigid_Body("circle",radius,(T)0);
            rigid_body.thin_shell=false;
            rigid_body.Set_Frame(FRAME<TV>(TV((T).5,(T)1.5)));
            rigid_body.Set_Coefficient_Of_Restitution((T)0);
            rigid_body.Set_Name("circle");
            T density=1000;
            rigid_body.Set_Mass((T)pi*sqr(radius)*(T)density*mass_multiplier);
...
void Falling_Rigid_Circle_Test()
{
    ...
    RIGID_BODY<TV>& rigid_body=solids_tests.Add_Rigid_Body("circle",radius,(T)0);
    rigid_body.thin_shell=false;
    rigid_body.Set_Frame(FRAME<TV>(TV((T).02,(T)0.14)*scale_length));
    rigid_body.Set_Coefficient_Of_Restitution((T)0);
    rigid_body.Set_Name("circle");
...
void Analytic_Test()
{
    ...
    if(use_solid){
        ...
        rigid_body.Set_Frame(FRAME<TV>(scale_length*TV((T).5,.5)));
        rigid_body.Set_Coefficient_Of_Restitution((T)0);
...
//        rigid_body_collection.Rigid_Body(b).is_static=true;}
    ...
    rigid_body.Set_Frame(FRAME<TV>(TV(2,2)));
    rigid_body.Set_Coefficient_Of_Restitution((T)0);
    rigid_body.is_static=true;
    Add_Volumetric_Body_To_Fluid_Simulation(rigid_body);
...
void Flexible_Filament_Test()
{
    ...
    GRID<TV> filament_grid(20,5,(T).5,(T)1.25,(T).475,(T).525);
