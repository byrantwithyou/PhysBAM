...
public:
    ...
    typedef typename GRID<TV>::VECTOR_INT TV_INT;typedef typename GRID<TV>::NODE_ITERATOR NODE_ITERATOR;
    ...
    using BASE::stream_type;using BASE::parse_args;using BASE::test_number;using BASE::resolution;
