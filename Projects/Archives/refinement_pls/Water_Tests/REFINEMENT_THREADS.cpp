...
{        
    ...
    smoke_tests->Map_Coarse_To_Local_Boundary_For_Cell(local_mac_grid,local_face_velocities,smoke_tests->coarse_face_velocities,cell_index);
    smoke_tests->Map_Coarse_To_Local_Interior_For_Cell(local_mac_grid,local_face_velocities,smoke_tests->coarse_face_velocities,cell_index,false);
    ...
    smoke_tests->Set_Local_Boundary_Conditions(local_mac_grid,local_projection,cell_index);
