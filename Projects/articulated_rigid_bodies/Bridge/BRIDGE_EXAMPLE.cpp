...
BRIDGE_EXAMPLE(const STREAM_TYPE stream_type)
    :BASE(stream_type,0,fluids_parameters.NONE),tests(*this,solid_body_collection),box1(0),box2(0),start_rolling(100),num_rolling_frames(1000),start_drop(2000),num_rungs(10),
    selection(0)
{
