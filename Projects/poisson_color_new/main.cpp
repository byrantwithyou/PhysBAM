...
template<class T,class TV>
void Dump_Vector(const INTERFACE_POISSON_SYSTEM_COLOR_NEW<TV>& ips,const INTERFACE_POISSON_SYSTEM_VECTOR_COLOR<TV>& v,const char* title)
{
    char buff[100];
    for(int c=0;c<ips.cdi->colors;c++){
        Dump_Interface<T,TV>(ips);
...
template<class T,class TV>
void Dump_Vector(const INTERFACE_POISSON_SYSTEM_COLOR_NEW<TV>& ips,const ARRAY<T,VECTOR<int,TV::m> >& u,const char* title)
{
