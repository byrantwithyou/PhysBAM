...
template<class T> enable_if_t<is_same<NUMBER,T>::value,NUMBER>  abs(const T& v)
{
    NUMBER n;
    n.val="ABS("+v.val+")";
    if(v.valid)
...
template<class T> enable_if_t<is_same<NUMBER,T>::value,NUMBER>  floor(const T& v){NUMBER n;n.val="FLOOR("+v.val+")";return n;}
template<class T> enable_if_t<is_same<NUMBER,T>::value,NUMBER>  ceil(const T& v){NUMBER n;n.val="CEIL("+v.val+")";return n;}
template<class T> enable_if_t<is_same<NUMBER,T>::value,NUMBER>  rint(const T& v){NUMBER n;n.val="RINT("+v.val+")";return n;}
template<class T> enable_if_t<is_same<NUMBER,T>::value,NUMBER>  exp(const T& v){NUMBER n;n.val="EXP("+v.val+")";return n;}
template<class T> enable_if_t<is_same<NUMBER,T>::value,NUMBER>  log(const T& v){NUMBER n;n.val="LOG("+v.val+")";return n;}
template<class T> enable_if_t<is_same<NUMBER,T>::value,NUMBER>  sin(const T& v){NUMBER n;n.val="SIN("+v.val+")";return n;}
template<class T> enable_if_t<is_same<NUMBER,T>::value,NUMBER>  cos(const T& v){NUMBER n;n.val="COS("+v.val+")";return n;}
template<class T> enable_if_t<is_same<NUMBER,T>::value,NUMBER>  tan(const T& v){NUMBER n;n.val="TAN("+v.val+")";return n;}
template<class T> enable_if_t<is_same<NUMBER,T>::value,NUMBER>  asin(const T& v){NUMBER n;n.val="ASIN("+v.val+")";return n;}
template<class T> enable_if_t<is_same<NUMBER,T>::value,NUMBER>  acos(const T& v){NUMBER n;n.val="ACOS("+v.val+")";return n;}
template<class T> enable_if_t<is_same<NUMBER,T>::value,NUMBER>  atan(const T& v){NUMBER n;n.val="ATAN("+v.val+")";return n;}
template<class T> enable_if_t<is_same<NUMBER,T>::value,NUMBER>  sqrt(const T& v)
{
    NUMBER n;
    n.val="SQRT("+v.val+")";
...
template<class T> enable_if_t<is_same<NUMBER,T>::value,NUMBER>  Inverse(const T& v){NUMBER n;n.val="INV("+v.val+")";return n;}
template<class T,class U> enable_if_t<is_same<NUMBER,T>::value||is_same<NUMBER,U>::value,NUMBER>  min(const T& a,const U& b){NUMBER n;n.val="MIN("+a.val+","+b.val+")";return n;}
template<class T,class U> enable_if_t<is_same<NUMBER,T>::value||is_same<NUMBER,U>::value,NUMBER>  max(const T& a,const U& b){NUMBER n;n.val="MAX("+a.val+","+b.val+")";return n;}
template<class T,class U> enable_if_t<is_same<NUMBER,T>::value||is_same<NUMBER,U>::value,NUMBER> pow(const T& a,const U& b){NUMBER n;n.val="POW("+a.val+","+b.val+")";return n;}
template<class T,class U> enable_if_t<is_same<NUMBER,T>::value||is_same<NUMBER,U>::value,NUMBER> atan2(const T& a,const U& b){NUMBER n;n.val="ATAN2("+a.val+","+b.val+")";return n;}
...
template<class T> enable_if_t<is_same<NUMBER,T>::value,NUMBER> Magnitude_Squared(const T& a){return a*a;}
