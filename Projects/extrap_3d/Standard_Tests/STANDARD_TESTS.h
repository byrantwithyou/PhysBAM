...
//            curve.Add_Control_Point(0,FRAME<TV>(box1.X(),ROTATION<TV>(0*(T)pi/2.0,TV(0,0,1))));
  //          curve.Add_Control_Point(.2,FRAME<TV>(box1.X(),ROTATION<TV>(0*(T)pi/2.0,TV(0,0,1))));
    //        curve.Add_Control_Point(.25,FRAME<TV>(box1.X(),ROTATION<TV>(-(T)pi/2.0,TV(0,0,1))));
            ...
            curve2.Add_Control_Point(.3,FRAME<TV>(box2.X()));
            curve2.Add_Control_Point(.31,FRAME<TV>(box2.X()-TV(0,.2*board_height,0)));
            curve2.Add_Control_Point(.33,FRAME<TV>(box2.X()-TV(-2.5*bound,.2*board_height,0)));
            curve3.Add_Control_Point(0,FRAME<TV>(box3.X()));
            curve3.Add_Control_Point(.4,FRAME<TV>(box3.X()));
            curve3.Add_Control_Point(.41,FRAME<TV>(box3.X()-TV(0,.2*board_height,0)));
            curve3.Add_Control_Point(.43,FRAME<TV>(box3.X()-TV(-2.5*bound,.2*board_height,0)));
            curve4.Add_Control_Point(0,FRAME<TV>(box4.X()));
            curve4.Add_Control_Point(.5,FRAME<TV>(box4.X()));
            curve4.Add_Control_Point(.51,FRAME<TV>(box4.X()-TV(0,.2*board_height,0)));
            curve4.Add_Control_Point(.53,FRAME<TV>(box4.X()-TV(-2.5*bound,.2*board_height,0)));
            curve5.Add_Control_Point(0,FRAME<TV>(box5.X()));
            curve5.Add_Control_Point(.5,FRAME<TV>(box5.X()));
            curve5.Add_Control_Point(.51,FRAME<TV>(box5.X()-TV(0,.2*board_height,0)));
            curve5.Add_Control_Point(.53,FRAME<TV>(box5.X()-TV(-2.5*bound,.2*board_height,0)));
