...
*/
    ...
    for(int i=0;i<rigid_body_collection.rigid_body_particle.Size();i++) if(rigid_body_collection.Is_Active(i)) rigid_body_collection.Rigid_Body(i).coefficient_of_friction=1;
}
//#####################################################################
