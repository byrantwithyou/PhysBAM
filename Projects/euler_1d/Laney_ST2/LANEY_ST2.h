...
//#####################################################################
#ifndef __LANEY_ST2__
#define __LANEY_ST2__
...
template <class T>
class LANEY_ST2:public EULER_1D_EXAMPLE<T>
{
public:    
    LANEY_ST2()                                                                      
    {
        //grid
        m=50; xmin=-10.; xmax=15.;
        //time
        initial_time=0.;final_time=25*4.01e-4;if(!this->user_frame_rate) frame_rate=25./final_time;
        cfl_number=1.;
        //custom stuff . . . 
        eos = new EOS_GAMMA<T>;
        conservation_method = new CONSERVATION_ENO_RF<T>;
        strcpy(output_directory,"Laney_ST2/matlab");
    }
...
//#####################################################################
template<class T> void LANEY_ST2<T>::
