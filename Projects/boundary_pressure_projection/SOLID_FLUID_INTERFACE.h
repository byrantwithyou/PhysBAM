...
public:
    ...
    virtual void Get_Boundary(SOLID_BOUNDARY_VECTOR<TV>* v) const=0;
    virtual void Get_Boundary(FLUID_BOUNDARY_VECTOR<TV>* v) const=0;
    virtual void Compute_Coupling_Weights(const SOLID_SOLVER<TV>* solid_solver,const FLUID_SOLVER<TV>* fluid_solver,T time,T dt)=0;
};
}
#endif
