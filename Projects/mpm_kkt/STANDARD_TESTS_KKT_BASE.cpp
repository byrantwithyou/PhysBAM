...
// Constructor
//#####################################################################
template<class TV> STANDARD_TESTS_KKT_BASE<TV>::
STANDARD_TESTS_KKT_BASE(const STREAM_TYPE stream_type_input,PARSE_ARGS& parse_args)
    :MPM_KKT_EXAMPLE<TV>(stream_type_input),test_number(0),resolution(32),user_resolution(false),stored_last_frame(0),
...
//#####################################################################
template<class TV> template<class T_STRUCTURE> T_STRUCTURE& STANDARD_TESTS_KKT_BASE<TV>::
...
template TRIANGULATED_AREA<float>& STANDARD_TESTS_KKT_BASE<VECTOR<float,2> >::Seed_Lagrangian_Particles<TRIANGULATED_AREA<float> >(TRIANGULATED_AREA<float>&,std::function<VECTOR<float,2> (VECTOR<float,2> const&)>,std::function<MATRIX<float,2,2> (VECTOR<float,2> const&)>,float,bool,bool);
template OPENSUBDIV_SURFACE<VECTOR<double,3>,3>& STANDARD_TESTS_KKT_BASE<VECTOR<double,3> >::Seed_Lagrangian_Particles<OPENSUBDIV_SURFACE<VECTOR<double,3>,3> >(OPENSUBDIV_SURFACE<VECTOR<double,3>,3>&,std::function<VECTOR<double,3> (VECTOR<double,3> const&)>,std::function<MATRIX<double,3,3> (VECTOR<double,3> const&)>,double,bool,bool);
template OPENSUBDIV_SURFACE<VECTOR<float,3>,3>& STANDARD_TESTS_KKT_BASE<VECTOR<float,3> >::Seed_Lagrangian_Particles<OPENSUBDIV_SURFACE<VECTOR<float,3>,3> >(OPENSUBDIV_SURFACE<VECTOR<float,3>,3>&,std::function<VECTOR<float,3> (VECTOR<float,3> const&)>,std::function<MATRIX<float,3,3> (VECTOR<float,3> const&)>,float,bool,bool);
template SEGMENTED_CURVE_2D<double>& STANDARD_TESTS_KKT_BASE<VECTOR<double,2> >::Seed_Lagrangian_Particles<SEGMENTED_CURVE_2D<double> >(SEGMENTED_CURVE_2D<double>&,std::function<VECTOR<double,2> (VECTOR<double,2> const&)>,std::function<MATRIX<double,2,2> (VECTOR<double,2> const&)>,double,bool,bool);
template SEGMENTED_CURVE_2D<float>& STANDARD_TESTS_KKT_BASE<VECTOR<float,2> >::Seed_Lagrangian_Particles<SEGMENTED_CURVE_2D<float> >(SEGMENTED_CURVE_2D<float>&,std::function<VECTOR<float,2> (VECTOR<float,2> const&)>,std::function<MATRIX<float,2,2> (VECTOR<float,2> const&)>,float,bool,bool);
template TRIANGULATED_SURFACE<double>& STANDARD_TESTS_KKT_BASE<VECTOR<double,3> >::Seed_Lagrangian_Particles<TRIANGULATED_SURFACE<double> >(TRIANGULATED_SURFACE<double>&,std::function<VECTOR<double,3> (VECTOR<double,3> const&)>,std::function<MATRIX<double,3,3> (VECTOR<double,3> const&)>,double,bool,bool);
template TRIANGULATED_SURFACE<float>& STANDARD_TESTS_KKT_BASE<VECTOR<float,3> >::Seed_Lagrangian_Particles<TRIANGULATED_SURFACE<float> >(TRIANGULATED_SURFACE<float>&,std::function<VECTOR<float,3> (VECTOR<float,3> const&)>,std::function<MATRIX<float,3,3> (VECTOR<float,3> const&)>,float,bool,bool);
}
