...
#        if env['fast_math']:optimization_flags+=' -ffast-math'
    ...
    env.Append(CXXFLAGS=' -Wall -Werror -Winit-self -Woverloaded-virtual -Wstrict-aliasing=2 -fno-strict-aliasing -std=gnu++14 -Wno-unknown-pragmas -Wno-strict-overflow')
