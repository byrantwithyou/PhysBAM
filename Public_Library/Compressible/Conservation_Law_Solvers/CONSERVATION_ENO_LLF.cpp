...
//#####################################################################
template<class TV,int d> template<int eno_order> void CONSERVATION_ENO_LLF<TV,d>::
Conservation_Solver_Helper_Experimental(const int m,const T dx,const ARRAY<bool,VECTOR<int,1> >& psi,const ARRAY<TV_DIMENSION,VECTOR<int,1> >& U,ARRAY<TV_DIMENSION,VECTOR<int,1> >& Fx,EIGENSYSTEM<T,d>& eigensystem,EIGENSYSTEM<T,d>& eigensystem_explicit,
    const VECTOR<bool,2>& outflow_boundaries,ARRAY<TV_DIMENSION,VECTOR<int,1> >* U_flux)
{
...
//#####################################################################
namespace PhysBAM{
template class CONSERVATION_ENO_LLF<VECTOR<double,1>,1>;
template class CONSERVATION_ENO_LLF<VECTOR<double,1>,2>;
template class CONSERVATION_ENO_LLF<VECTOR<double,1>,3>;
template class CONSERVATION_ENO_LLF<VECTOR<double,1>,4>;
template class CONSERVATION_ENO_LLF<VECTOR<double,2>,2>;
template class CONSERVATION_ENO_LLF<VECTOR<double,2>,3>;
template class CONSERVATION_ENO_LLF<VECTOR<double,2>,4>;
template class CONSERVATION_ENO_LLF<VECTOR<double,2>,5>;
template class CONSERVATION_ENO_LLF<VECTOR<double,3>,5>;
template class CONSERVATION_ENO_LLF<VECTOR<double,3>,6>;
template class CONSERVATION_ENO_LLF<VECTOR<float,1>,1>;
template class CONSERVATION_ENO_LLF<VECTOR<float,1>,2>;
template class CONSERVATION_ENO_LLF<VECTOR<float,1>,3>;
template class CONSERVATION_ENO_LLF<VECTOR<float,1>,4>;
template class CONSERVATION_ENO_LLF<VECTOR<float,2>,2>;
template class CONSERVATION_ENO_LLF<VECTOR<float,2>,3>;
template class CONSERVATION_ENO_LLF<VECTOR<float,2>,4>;
template class CONSERVATION_ENO_LLF<VECTOR<float,2>,5>;
template class CONSERVATION_ENO_LLF<VECTOR<float,3>,5>;
template class CONSERVATION_ENO_LLF<VECTOR<float,3>,6>;
}
