...
Force(const VECTOR_T& V,VECTOR_T& F) const
{
    ...
    if(fully_implicit) solid_body_collection.Add_Implicit_Velocity_Independent_Forces(V.V.array,V.rigid_V.array,F.V.array,F.rigid_V.array,dt,current_velocity_time+dt);
