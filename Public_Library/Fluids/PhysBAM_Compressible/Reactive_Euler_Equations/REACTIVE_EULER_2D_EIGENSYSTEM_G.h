...
#include <Fluids/PhysBAM_Compressible/Conservation_Law_Solvers/EIGENSYSTEM.h>
#include <Fluids/PhysBAM_Compressible/Reactive_Euler_Equations/REACTIVE_EULER.h>
namespace PhysBAM{

template<class T_input>
class REACTIVE_EULER_2D_EIGENSYSTEM_G:public EIGENSYSTEM<T_input,VECTOR<T_input,5> >,public REACTIVE_EULER<GRID<VECTOR<T_input,2> > >
{
...
//#####################################################################
    void Flux(const int n,const ARRAY<TV_DIMENSION,VECTOR<int,1> >& U,ARRAY<TV_DIMENSION,VECTOR<int,1> >& G,ARRAY<TV_DIMENSION,VECTOR<int,1> >* U_clamped=0) PHYSBAM_OVERRIDE;        
