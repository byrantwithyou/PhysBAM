...
#include <Fluids/PhysBAM_Compressible/Shallow_Water_Equations/SHALLOW_WATER.h>
#include <Fluids/PhysBAM_Compressible/Shallow_Water_Equations/SHALLOW_WATER_1D_SPECIALIZED_EIGENSYSTEM_F.h>
namespace PhysBAM{
