...
class EULER_3D_EIGENSYSTEM_F:public EULER_EIGENSYSTEM<GRID<VECTOR<T_input,3> > >
{
...
public:
    ...
    EULER_3D_EIGENSYSTEM_F(bool only_pressure_flux_input=false):only_pressure_flux(only_pressure_flux_input)
    {}
