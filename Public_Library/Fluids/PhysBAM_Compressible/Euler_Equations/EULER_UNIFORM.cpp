...
#include <Fluids/PhysBAM_Compressible/Euler_Equations/EULER_1D_EIGENSYSTEM_F_ADVECTION_ONLY.h>
#include <Fluids/PhysBAM_Compressible/Euler_Equations/EULER_2D_EIGENSYSTEM_F.h>
#include <Fluids/PhysBAM_Compressible/Euler_Equations/EULER_2D_EIGENSYSTEM_F_ADVECTION_ONLY.h>
#include <Fluids/PhysBAM_Compressible/Euler_Equations/EULER_2D_EIGENSYSTEM_G.h>
#include <Fluids/PhysBAM_Compressible/Euler_Equations/EULER_2D_EIGENSYSTEM_G_ADVECTION_ONLY.h>
#include <Fluids/PhysBAM_Compressible/Euler_Equations/EULER_3D_EIGENSYSTEM_F.h>
#include <Fluids/PhysBAM_Compressible/Euler_Equations/EULER_3D_EIGENSYSTEM_F_ADVECTION_ONLY.h>
#include <Fluids/PhysBAM_Compressible/Euler_Equations/EULER_3D_EIGENSYSTEM_G.h>
#include <Fluids/PhysBAM_Compressible/Euler_Equations/EULER_3D_EIGENSYSTEM_G_ADVECTION_ONLY.h>
#include <Fluids/PhysBAM_Compressible/Euler_Equations/EULER_3D_EIGENSYSTEM_H.h>
#include <Fluids/PhysBAM_Compressible/Euler_Equations/EULER_3D_EIGENSYSTEM_H_ADVECTION_ONLY.h>
    ...
    const EULER_PROJECTION_UNIFORM<T_GRID>& euler_projection,const bool advection_only)
{
    ...
    if(eigensystems_pressureonly[0]) delete eigensystems_pressureonly[0];eigensystems_pressureonly[0]=new EULER_2D_EIGENSYSTEM_F<T>(true);
    if(eigensystems_pressureonly[1]) delete eigensystems_pressureonly[1];eigensystems_pressureonly[1]=new EULER_2D_EIGENSYSTEM_G<T>(true);
    if(eigensystems[0]) delete eigensystems[0];
    ...
    const EULER_PROJECTION_UNIFORM<T_GRID>& euler_projection,const bool advection_only)
{
    ...
    if(eigensystems_default[2]) delete eigensystems_default[2];eigensystems_default[2]=new EULER_3D_EIGENSYSTEM_H<T>();
    if(eigensystems_pressureonly[0]) delete eigensystems_pressureonly[0];eigensystems_pressureonly[0]=new EULER_3D_EIGENSYSTEM_F<T>(true);
    if(eigensystems_pressureonly[1]) delete eigensystems_pressureonly[1];eigensystems_pressureonly[1]=new EULER_3D_EIGENSYSTEM_G<T>(true);
    if(eigensystems_pressureonly[2]) delete eigensystems_pressureonly[2];eigensystems_pressureonly[2]=new EULER_3D_EIGENSYSTEM_H<T>(true);
    if(eigensystems[0]) delete eigensystems[0];
    if(eigensystems[1]) delete eigensystems[1];
