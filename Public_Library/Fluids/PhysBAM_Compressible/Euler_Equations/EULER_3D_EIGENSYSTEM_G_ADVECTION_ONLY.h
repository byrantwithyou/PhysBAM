...
class EULER_3D_EIGENSYSTEM_G_ADVECTION_ONLY:public EULER_EIGENSYSTEM<GRID<VECTOR<T_input,3> > >
{
...
template<class T> void EULER_3D_EIGENSYSTEM_G_ADVECTION_ONLY<T>::
