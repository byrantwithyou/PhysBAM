...
public:
    using RENDERING_OBJECT<T>::small_number;using RENDERING_OBJECT<T>::World_Space_Bounding_Box;using RENDERING_OBJECT<T>::Object_Space_Point;
    using RENDERING_OBJECT<T>::World_Space_Point;using RENDERING_OBJECT<T>::Inside;using RENDERING_OBJECT<T>::Intersection;
    using RENDERING_OBJECT<T>::World_Space_Vector;using RENDERING_OBJECT<T>::Object_Space_Ray;using RENDERING_OBJECT<T>::Object_Space_Vector;
    ...
    void Get_Object_Space_Tangent_And_Bitangent(const VECTOR<T,3>& object_space_point,const VECTOR<T,3>& object_space_normal,const int aggregate,VECTOR<T,3>& object_tangent,VECTOR<T,3>& object_bitangent) const override
    ...
    void Get_World_Space_Tangent_And_Bitangent(const VECTOR<T,3>& world_space_point,const VECTOR<T,3>& world_space_normal,const int aggregate,VECTOR<T,3>& world_tangent,VECTOR<T,3>& world_bitangent) const override
