                         ...
                         const ARRAY<T,VECTOR<int,2> >& energy,ARRAY<T,VECTOR<int,2> >& Q1,ARRAY<T,VECTOR<int,2> >& Q2,ARRAY<T,VECTOR<int,2> >& Q3,ARRAY<T,VECTOR<int,2> >& Q4)
{
    ...
    ARRAY<T,VECTOR<int,2> > NN1_x(1,m-1,1,n-1),NN1_y(1,m-1,1,n-1),NN2_x(1,m-1,1,n-1),NN2_y(1,m-1,1,n-1),NN3_x(1,m-1,1,n-1),NN3_y(1,m-1,1,n-1),NN4_x(1,m-1,1,n-1),NN4_y(1,m-1,1,n-1);
