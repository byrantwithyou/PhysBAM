...
class TEMPERATURE_CONTAINER:public GRID_AND_ARRAY_CONTAINER<T_GRID,typename T_GRID::SCALAR>
{
    ...
    typedef UNIFORM_GRID_ITERATOR_CELL<TV> CELL_ITERATOR;typedef typename COLLISION_GEOMETRY_COLLECTION_POLICY<T_GRID>::GRID_BASED_COLLISION_GEOMETRY T_GRID_BASED_COLLISION_GEOMETRY;
