...
public:
    ...
    CYLINDER()
        :height(1),radius(1),plane2(plane1.x0-height*plane1.normal,-plane1.normal)
    {}
    ...
    plane1.x0=point1;plane1.normal=height_vector;
    plane2.x0=point2;plane2.normal=-plane1.normal;}
    ...
    {Read_Binary<RW>(input,plane1.x0,plane2.x0,radius);
    Set_Endpoints(plane1.x0,plane2.x0);}

    template<class RW>
    void Write(std::ostream& output) const
    {Write_Binary<RW>(output,plane1.x0,plane2.x0,radius);}
