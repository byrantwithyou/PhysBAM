...
#include <Geometry/Collisions_And_Grids/GRID_BASED_COLLISION_GEOMETRY.h>
...
class AVERAGING_COLLIDABLE_UNIFORM
{
    ...
    typedef typename COLLISION_BODY_COLLECTION_POLICY<T_GRID>::GRID_BASED_COLLISION_GEOMETRY T_GRID_BASED_COLLISION_GEOMETRY;typedef typename INTERPOLATION_POLICY<T_GRID>::LINEAR_INTERPOLATION_MAC_HELPER T_LINEAR_INTERPOLATION_MAC_HELPER;
public:
    ...
    AVERAGING_COLLIDABLE_UNIFORM(const T_GRID_BASED_COLLISION_GEOMETRY& body_list_input,const T default_replacement_value_input)
    ...
    static TV Face_To_Node_Vector(const T_GRID& grid,const TV_INT& node_index,const T_FACE_LOOKUP& u_face)
    ...
    static TV Face_To_Cell_Vector(const T_GRID& grid,const TV_INT& cell_index,const T_FACE_LOOKUP& u_face)
