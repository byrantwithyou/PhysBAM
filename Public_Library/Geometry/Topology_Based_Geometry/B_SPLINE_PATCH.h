...
public:
    ...
    ARRAY<ARRAY<int> > control_points;
...
template<class TV> void Smooth_Fit(B_SPLINE_PATCH<TV,3>& bs,const ARRAY<ARRAY<TV> >& X);
template<class TV> void Smooth_Fit_Loop(B_SPLINE_PATCH<TV,3>& bs,const ARRAY<ARRAY<TV> >& X);
