...
//#####################################################################
template<class TV,int static_degree> template<class ...Args> void BASIS_INTEGRATION_UNIFORM_COLOR<TV,static_degree>::
Add_Volume_Block(SYSTEM_VOLUME_BLOCK_HELPER_COLOR<TV>& helper,const ARRAY<T>& scale,Args&& ...args)
{
    VOLUME_BLOCK* vb=new VOLUME_BLOCK;
    vb->Initialize(helper,scale,args...);
...
template void BASIS_INTEGRATION_UNIFORM_COLOR<VECTOR<double,2>,2>::Add_Surface_Block_Scalar<1>(SYSTEM_SURFACE_BLOCK_SCALAR_HELPER_COLOR<VECTOR<double,2> >&,BASIS_STENCIL_UNIFORM<VECTOR<double,2>,1> const&,bool,std::function<double (VECTOR<double,2> const&,int,int)>,std::function<double (VECTOR<double,2> const&,int,int)>,ARRAY<ARRAY<double,int>,int>&,double);
...
template void BASIS_INTEGRATION_UNIFORM_COLOR<VECTOR<double,3>,2>::Add_Surface_Block_Scalar<1>(SYSTEM_SURFACE_BLOCK_SCALAR_HELPER_COLOR<VECTOR<double,3> >&,BASIS_STENCIL_UNIFORM<VECTOR<double,3>,1> const&,bool,std::function<double (VECTOR<double,3> const&,int,int)>,std::function<double (VECTOR<double,3> const&,int,int)>,ARRAY<ARRAY<double,int>,int>&,double);
...
template void BASIS_INTEGRATION_UNIFORM_COLOR<VECTOR<float,2>,2>::Add_Surface_Block_Scalar<1>(SYSTEM_SURFACE_BLOCK_SCALAR_HELPER_COLOR<VECTOR<float,2> >&,BASIS_STENCIL_UNIFORM<VECTOR<float,2>,1> const&,bool,std::function<float (VECTOR<float,2> const&,int,int)>,std::function<float (VECTOR<float,2> const&,int,int)>,ARRAY<ARRAY<float,int>,int>&,float);
...
template void BASIS_INTEGRATION_UNIFORM_COLOR<VECTOR<float,3>,2>::Add_Surface_Block_Scalar<1>(SYSTEM_SURFACE_BLOCK_SCALAR_HELPER_COLOR<VECTOR<float,3> >&,BASIS_STENCIL_UNIFORM<VECTOR<float,3>,1> const&,bool,std::function<float (VECTOR<float,3> const&,int,int)>,std::function<float (VECTOR<float,3> const&,int,int)>,ARRAY<ARRAY<float,int>,int>&,float);
template void BASIS_INTEGRATION_UNIFORM_COLOR<VECTOR<double,2>,2>::Add_Volume_Block<BASIS_STENCIL_UNIFORM<VECTOR<double,2>,0>&,BASIS_STENCIL_UNIFORM<VECTOR<double,2>,1>&>(SYSTEM_VOLUME_BLOCK_HELPER_COLOR<VECTOR<double,2> >&,ARRAY<double,int> const&,BASIS_STENCIL_UNIFORM<VECTOR<double,2>,0>&,BASIS_STENCIL_UNIFORM<VECTOR<double,2>,1>&);
template void BASIS_INTEGRATION_UNIFORM_COLOR<VECTOR<double,2>,2>::Add_Volume_Block<BASIS_STENCIL_UNIFORM<VECTOR<double,2>,1>&,BASIS_STENCIL_UNIFORM<VECTOR<double,2>,1>&,BASIS_STENCIL_UNIFORM<VECTOR<double,2>,1>&>(SYSTEM_VOLUME_BLOCK_HELPER_COLOR<VECTOR<double,2> >&,ARRAY<double,int> const&,BASIS_STENCIL_UNIFORM<VECTOR<double,2>,1>&,BASIS_STENCIL_UNIFORM<VECTOR<double,2>,1>&,BASIS_STENCIL_UNIFORM<VECTOR<double,2>,1>&);
template void BASIS_INTEGRATION_UNIFORM_COLOR<VECTOR<double,2>,2>::Add_Volume_Block<BASIS_STENCIL_UNIFORM<VECTOR<double,2>,1>&,BASIS_STENCIL_UNIFORM<VECTOR<double,2>,1>&>(SYSTEM_VOLUME_BLOCK_HELPER_COLOR<VECTOR<double,2> >&,ARRAY<double,int> const&,BASIS_STENCIL_UNIFORM<VECTOR<double,2>,1>&,BASIS_STENCIL_UNIFORM<VECTOR<double,2>,1>&);
template void BASIS_INTEGRATION_UNIFORM_COLOR<VECTOR<double,3>,2>::Add_Volume_Block<BASIS_STENCIL_UNIFORM<VECTOR<double,3>,0>&,BASIS_STENCIL_UNIFORM<VECTOR<double,3>,1>&>(SYSTEM_VOLUME_BLOCK_HELPER_COLOR<VECTOR<double,3> >&,ARRAY<double,int> const&,BASIS_STENCIL_UNIFORM<VECTOR<double,3>,0>&,BASIS_STENCIL_UNIFORM<VECTOR<double,3>,1>&);
template void BASIS_INTEGRATION_UNIFORM_COLOR<VECTOR<double,3>,2>::Add_Volume_Block<BASIS_STENCIL_UNIFORM<VECTOR<double,3>,1>&,BASIS_STENCIL_UNIFORM<VECTOR<double,3>,1>&,BASIS_STENCIL_UNIFORM<VECTOR<double,3>,1>&>(SYSTEM_VOLUME_BLOCK_HELPER_COLOR<VECTOR<double,3> >&,ARRAY<double,int> const&,BASIS_STENCIL_UNIFORM<VECTOR<double,3>,1>&,BASIS_STENCIL_UNIFORM<VECTOR<double,3>,1>&,BASIS_STENCIL_UNIFORM<VECTOR<double,3>,1>&);
template void BASIS_INTEGRATION_UNIFORM_COLOR<VECTOR<double,3>,2>::Add_Volume_Block<BASIS_STENCIL_UNIFORM<VECTOR<double,3>,1>&,BASIS_STENCIL_UNIFORM<VECTOR<double,3>,1>&>(SYSTEM_VOLUME_BLOCK_HELPER_COLOR<VECTOR<double,3> >&,ARRAY<double,int> const&,BASIS_STENCIL_UNIFORM<VECTOR<double,3>,1>&,BASIS_STENCIL_UNIFORM<VECTOR<double,3>,1>&);
template void BASIS_INTEGRATION_UNIFORM_COLOR<VECTOR<float,2>,2>::Add_Volume_Block<BASIS_STENCIL_UNIFORM<VECTOR<float,2>,0>&,BASIS_STENCIL_UNIFORM<VECTOR<float,2>,1>&>(SYSTEM_VOLUME_BLOCK_HELPER_COLOR<VECTOR<float,2> >&,ARRAY<float,int> const&,BASIS_STENCIL_UNIFORM<VECTOR<float,2>,0>&,BASIS_STENCIL_UNIFORM<VECTOR<float,2>,1>&);
template void BASIS_INTEGRATION_UNIFORM_COLOR<VECTOR<float,2>,2>::Add_Volume_Block<BASIS_STENCIL_UNIFORM<VECTOR<float,2>,1>&,BASIS_STENCIL_UNIFORM<VECTOR<float,2>,1>&,BASIS_STENCIL_UNIFORM<VECTOR<float,2>,1>&>(SYSTEM_VOLUME_BLOCK_HELPER_COLOR<VECTOR<float,2> >&,ARRAY<float,int> const&,BASIS_STENCIL_UNIFORM<VECTOR<float,2>,1>&,BASIS_STENCIL_UNIFORM<VECTOR<float,2>,1>&,BASIS_STENCIL_UNIFORM<VECTOR<float,2>,1>&);
template void BASIS_INTEGRATION_UNIFORM_COLOR<VECTOR<float,2>,2>::Add_Volume_Block<BASIS_STENCIL_UNIFORM<VECTOR<float,2>,1>&,BASIS_STENCIL_UNIFORM<VECTOR<float,2>,1>&>(SYSTEM_VOLUME_BLOCK_HELPER_COLOR<VECTOR<float,2> >&,ARRAY<float,int> const&,BASIS_STENCIL_UNIFORM<VECTOR<float,2>,1>&,BASIS_STENCIL_UNIFORM<VECTOR<float,2>,1>&);
template void BASIS_INTEGRATION_UNIFORM_COLOR<VECTOR<float,3>,2>::Add_Volume_Block<BASIS_STENCIL_UNIFORM<VECTOR<float,3>,0>&,BASIS_STENCIL_UNIFORM<VECTOR<float,3>,1>&>(SYSTEM_VOLUME_BLOCK_HELPER_COLOR<VECTOR<float,3> >&,ARRAY<float,int> const&,BASIS_STENCIL_UNIFORM<VECTOR<float,3>,0>&,BASIS_STENCIL_UNIFORM<VECTOR<float,3>,1>&);
template void BASIS_INTEGRATION_UNIFORM_COLOR<VECTOR<float,3>,2>::Add_Volume_Block<BASIS_STENCIL_UNIFORM<VECTOR<float,3>,1>&,BASIS_STENCIL_UNIFORM<VECTOR<float,3>,1>&,BASIS_STENCIL_UNIFORM<VECTOR<float,3>,1>&>(SYSTEM_VOLUME_BLOCK_HELPER_COLOR<VECTOR<float,3> >&,ARRAY<float,int> const&,BASIS_STENCIL_UNIFORM<VECTOR<float,3>,1>&,BASIS_STENCIL_UNIFORM<VECTOR<float,3>,1>&,BASIS_STENCIL_UNIFORM<VECTOR<float,3>,1>&);
template void BASIS_INTEGRATION_UNIFORM_COLOR<VECTOR<float,3>,2>::Add_Volume_Block<BASIS_STENCIL_UNIFORM<VECTOR<float,3>,1>&,BASIS_STENCIL_UNIFORM<VECTOR<float,3>,1>&>(SYSTEM_VOLUME_BLOCK_HELPER_COLOR<VECTOR<float,3> >&,ARRAY<float,int> const&,BASIS_STENCIL_UNIFORM<VECTOR<float,3>,1>&,BASIS_STENCIL_UNIFORM<VECTOR<float,3>,1>&);
}
