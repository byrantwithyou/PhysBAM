...
#ifndef PHYSBAM_PUBLIC_LIBRARY_JEFFREY_UTILITIES_GEOMETRY_POLYTOPE_LOCAL_INTEGRATE_MONOMIAL_OVER_BOUNDARY_HPP
#define PHYSBAM_PUBLIC_LIBRARY_JEFFREY_UTILITIES_GEOMETRY_POLYTOPE_LOCAL_INTEGRATE_MONOMIAL_OVER_BOUNDARY_HPP
...
struct POLYTOPE_LOCAL_INTEGRATE_MONOMIAL_OVER_BOUNDARY
{
        ...
        T_MULTI_POWER) const
    {
        ...
        return polytope.alignment == SUB_CUBE_POLYTOPE_ALIGNMENT_BOUNDARY_ALIGNED ||
               ...
               polytope.template Integrate< QUADRATURE_RULE_TYPE >(vertices_x, MONOMIAL< T_MULTI_POWER >()) :
               static_cast<T>(0);
    }
};
...
#endif // #ifndef PHYSBAM_PUBLIC_LIBRARY_JEFFREY_UTILITIES_GEOMETRY_POLYTOPE_LOCAL_INTEGRATE_MONOMIAL_OVER_BOUNDARY_HPP
