...
//#####################################################################
    void Parallel_Solve_Fluid_Part(FLUID_SYSTEM_MPI_SLIP<TV>& fluid_system,KRYLOV_VECTOR_WRAPPER<T,ARRAY<T>&>& x_array,KRYLOV_VECTOR_WRAPPER<T,ARRAY<T>&>& b_array,KRYLOV_VECTOR_WRAPPER<T,ARRAY<T>&>& p_array,KRYLOV_VECTOR_WRAPPER<T,ARRAY<T>&>& ap_array,
        KRYLOV_VECTOR_WRAPPER<T,ARRAY<T>&>& ar_array,KRYLOV_VECTOR_WRAPPER<T,ARRAY<T>&>& r_array,KRYLOV_VECTOR_WRAPPER<T,ARRAY<T>&>& z_array,KRYLOV_VECTOR_WRAPPER<T,ARRAY<T>&>& zaq_array,const int min_iterations,const int max_iterations,
...
private:
    void Fill_Ghost_Cells(KRYLOV_VECTOR_WRAPPER<T,ARRAY<T>&>& v_array);
