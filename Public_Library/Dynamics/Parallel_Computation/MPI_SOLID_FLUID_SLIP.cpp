...
#ifdef BRICK
    LOG::cout<<cell_count-count_before<<" real cells in region "<<region_index<<std::endl;
#endif
...
#ifdef BRICK
    LOG::cout<<cell_count-count_before<<" ghost cells in region "<<region_index<<std::endl;
#endif
    count_before=cell_count;
    
    /*for(FACE_ITERATOR<TV> iterator(local_grid,0,region_type,side);iterator.Valid();iterator.Next()){
...
#ifdef BRICK
                LOG::cout<<"Found boundary ghost cell across face (1, "<<second_axis<<", "<<cell_index<<") with index "<<face_ghost_cell_index(1,second_axis,cell_index)<<std::endl;
#endif
...
#ifdef BRICK
                LOG::cout<<"Found boundary ghost cell across face (2, "<<second_axis<<", "<<cell_index+axis_vector<<") with index "<<face_ghost_cell_index(2,second_axis,cell_index+axis_vector)<<std::endl;
#endif
...
#ifdef BRICK
    LOG::cout<<boundary_cell_count-count_before<<" real cells in boundary region "<<domain_side<<std::endl;
#endif
...
#ifdef BRICK
    LOG::cout<<boundary_cell_count-count_before<<" ghost cells in boundary region "<<domain_side<<std::endl;
    count_before=boundary_cell_count;
#endif
