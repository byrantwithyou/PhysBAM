...
public:
    ...
    void Find_A_Part_Two(RANGE<VECTOR<int,TV::m> >& domain,ARRAY<SPARSE_MATRIX_FLAT_MXN<T> >& A_array,ARRAY<ARRAY<T> >& b_array,ARRAY<int,TV_INT>& cell_index_to_matrix_index)
