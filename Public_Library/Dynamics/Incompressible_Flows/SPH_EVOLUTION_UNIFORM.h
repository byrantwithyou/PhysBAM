...
class SPH_EVOLUTION_UNIFORM:public NONCOPYABLE
{
    ...
    typedef ARRAY<ARRAY<PAIR<TV_INT,int> >,TV_INT> T_ARRAYS_ARRAY_PAIR_TV_INT_INT;
    typedef ARRAY<ARRAY<T>,TV_INT> T_ARRAYS_ARRAY_SCALAR;
    typedef ARRAY<TV_INT,TV_INT> T_ARRAYS_TV_INT;
