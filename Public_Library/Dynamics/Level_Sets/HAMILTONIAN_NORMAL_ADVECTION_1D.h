...
#include <Dynamics/Level_Sets/HAMILTONIAN_1D.h>
namespace PhysBAM{
...
//#####################################################################
    T H(const T phi_x,const int i=0,const T t=0) override;
    T Maxabs_H1(const T phi_x_1,const T phi_x_2,const int i=0,const T t=0) override;
//#####################################################################
};   
}
#endif
