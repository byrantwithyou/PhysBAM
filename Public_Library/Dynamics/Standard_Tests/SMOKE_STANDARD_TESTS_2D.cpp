...
{
    if(test_number==2){
        int id=rigid_body_collection.Add_Rigid_Body(example.data_directory+"/Rigid_Bodies_2D/circle",(T).125,true,true,false);
        ...
        oriented_box=rigid_body_collection.Add_Rigid_Body(example.data_directory+"/Rigid_Bodies_2D/square",(T).8/sqrt((T)2),true,true,false);
