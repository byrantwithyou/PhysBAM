...
template GRID<VECTOR<float,1> > GRID<VECTOR<float,1> >::Create_Grid_Given_Cell_Size(RANGE<VECTOR<float,1> > const&,float,bool,int);
...
template GRID<VECTOR<double,1> > GRID<VECTOR<double,1> >::Create_Grid_Given_Cell_Size(RANGE<VECTOR<double,1> > const&,double,bool,int);
