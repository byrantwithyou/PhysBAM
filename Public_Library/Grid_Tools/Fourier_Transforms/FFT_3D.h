...
//#####################################################################
    ...
    void First_Derivatives(const ARRAY<std::complex<T>,TV_INT>& u_hat,ARRAY<std::complex<T>,TV_INT>& ux_hat,ARRAY<std::complex<T>,TV_INT>& uy_hat,ARRAY<std::complex<T>,TV_INT>& uz_hat) const;
    void Make_Divergence_Free(ARRAY<std::complex<T>,TV_INT>& u_hat,ARRAY<std::complex<T>,TV_INT>& v_hat,ARRAY<std::complex<T>,TV_INT>& w_hat) const;
