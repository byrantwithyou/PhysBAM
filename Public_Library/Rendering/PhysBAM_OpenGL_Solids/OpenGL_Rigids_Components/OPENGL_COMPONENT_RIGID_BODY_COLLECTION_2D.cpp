...
#include <Rendering/PhysBAM_OpenGL/OpenGL/OPENGL_RIGID_BODY_HINTS.h>
...
#include <Rendering/PhysBAM_OpenGL/OpenGL_Components/OPENGL_COMPONENT_TRIANGULATED_AREA_BASED_VECTOR_FIELD.h>
...
//#####################################################################
template<class T,class RW> int OPENGL_COMPONENT_RIGID_BODY_COLLECTION_2D<T,RW>::
Get_Draw_Mode() const
{
...
//#####################################################################
template<class T,class RW> bool OPENGL_COMPONENT_RIGID_BODY_COLLECTION_2D<T,RW>::
...
//#####################################################################
template<class T,class RW> RANGE<VECTOR<float,3> > OPENGL_COMPONENT_RIGID_BODY_COLLECTION_2D<T,RW>::
Bounding_Box() const
{
...
//#####################################################################
template<class T> RANGE<VECTOR<float,3> > OPENGL_SELECTION_COMPONENT_RIGID_BODY_COLLECTION_2D<T>::
Bounding_Box() const
{
...
Read_Articulated_Information(const std::string& filename)
{
    ...
    for(int i=0;i<numpoints;i++) Read_Binary<RW,VECTOR<T,2> >(*input,articulation_points(i));
    delete input;
}
//#####################################################################
// Function Display
