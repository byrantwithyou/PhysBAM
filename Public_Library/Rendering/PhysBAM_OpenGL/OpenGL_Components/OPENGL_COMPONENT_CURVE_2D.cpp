...
#include <Rendering/PhysBAM_OpenGL/OpenGL_Components/OPENGL_COMPONENT_CURVE_2D.h>
...
Display(const int in_color) const
{
...
#endif
    {
        ...
        vertices.Resize(0);
        OpenGL_Line(VECTOR<T,2>(domain_xmin,-1000),VECTOR<T,2>(domain_xmin,1000),vertices);
        OpenGL_Line(VECTOR<T,2>(domain_xmax,-1000),VECTOR<T,2>(domain_xmax,1000),vertices);
        OpenGL_Draw_Arrays(GL_LINES,2,vertices);
        OPENGL_COLOR::Gray(0.3).Send_To_GL_Pipeline();
        vertices.Resize(0);
        OpenGL_Line(VECTOR<T,2>(domain_xmin,0),VECTOR<T,2>(domain_xmax,0),vertices);
        OpenGL_Draw_Arrays(GL_LINES,2,vertices);
