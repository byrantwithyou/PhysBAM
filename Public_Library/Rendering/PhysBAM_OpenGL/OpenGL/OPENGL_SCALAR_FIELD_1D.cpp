...
#include <Rendering/PhysBAM_OpenGL/OpenGL/OPENGL_SCALAR_FIELD_1D.h>
...
Bounding_Box() const
{
    ...
    for(int i=min_corner;i<max_corner;i++) box.Enlarge_To_Include_Point(VECTOR<float,3>(grid.X(TV_INT(i)).x,values(i),(T)0));
