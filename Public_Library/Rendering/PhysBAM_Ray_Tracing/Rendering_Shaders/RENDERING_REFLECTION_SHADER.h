...
//#####################################################################
#ifndef __RENDERING_REFLECTION_SHADER__
#define __RENDERING_REFLECTION_SHADER__
...
template<class T>
class RENDERING_REFLECTION_SHADER:public MATERIAL_SHADER<T>
{
public:
    using MATERIAL_SHADER<T>::world;

    RENDERING_REFLECTION_SHADER(RENDER_WORLD<T>& world_input) 
    ...
    return world.Cast_Ray(outgoing_ray,ray);}
