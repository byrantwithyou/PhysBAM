...
RIGIDS_KINEMATIC_EVOLUTION(RIGID_BODY_COLLECTION<TV>& rigid_body_collection_input,RIGIDS_EXAMPLE_FORCES_AND_VELOCITIES<TV>& rigid_body_example_velocities)
    :BASE(rigid_body_collection_input,rigid_body_example_velocities),rigid_body_collection(rigid_body_collection_input)
{
}
template<class TV> RIGIDS_KINEMATIC_EVOLUTION<TV>::
...
Set_Kinematic_Velocities(TWIST<TV>& twist,const T frame_dt,const T time,const int id)
{
    ...
    BASE::Set_Kinematic_Velocities(twist,frame_dt,time,new_id);
}
//#####################################################################
