...
//#####################################################################
    ...
    RIGID_BODY<TV>& Add_Analytic_Bowl(const TV& location,const TV& axis,const T hole_radius,const T depth,const T thickness,int res_radial=32,int res_vertical=8);
