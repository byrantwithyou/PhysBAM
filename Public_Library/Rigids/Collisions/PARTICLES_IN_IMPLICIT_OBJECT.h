...
template<class TV>
void Get_Interfering_Simplices(const RIGID_BODY<TV>& body0,const RIGID_BODY<TV>& body1,ARRAY<int>& simplex_list,MATRIX<typename TV::SCALAR,TV::dimension,TV::dimension>& rotation,TV& translation,const bool use_triangle_hierarchy_center_phi_test);
template<class TV>
