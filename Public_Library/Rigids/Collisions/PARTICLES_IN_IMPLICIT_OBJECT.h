...
struct PARTICLES_IN_IMPLICIT_OBJECT
{
    ...
    static void Get_Interfering_Simplices(const RIGID_BODY<TV>& body0,const RIGID_BODY<TV>& body1,ARRAY<int>& simplex_list,MATRIX<typename TV::SCALAR,TV::dimension,TV::dimension>& rotation,TV& translation,const bool use_triangle_hierarchy_center_phi_test);
    static const typename TOPOLOGY_BASED_SIMPLEX_POLICY<TV,TV::dimension-1>::HIERARCHY& Simplex_Hierarchy(const RIGID_BODY<TV>& rigid_body);
