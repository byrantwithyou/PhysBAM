...
#define INSTANTIATION_HELPER(T,d) \
    template void Append_All_Intersections<VECTOR<T,d> >(RIGID_BODY<VECTOR<T,d> >& body0, RIGID_BODY<VECTOR<T,d> >& body1,ARRAY<RIGID_BODY_PARTICLE_INTERSECTION<VECTOR<T,d> > >& particle_intersections,const T contour_value,const bool use_triangle_hierarchy,const bool use_edge_intersection,const bool use_triangle_hierarchy_center_phi_test); \
    template void Append_All_Intersections_Points<VECTOR<T,d> >(RIGID_BODY<VECTOR<T,d> >& body0, RIGID_BODY<VECTOR<T,d> >& body1,ARRAY<RIGID_BODY_PARTICLE_INTERSECTION<VECTOR<T,d> > >& particle_intersections,const T contour_value); \
    template void Append_All_Intersections_Triangles<VECTOR<T,d> >(RIGID_BODY<VECTOR<T,d> >& body0,RIGID_BODY<VECTOR<T,d> >& body1,ARRAY<RIGID_BODY_PARTICLE_INTERSECTION<VECTOR<T,d> > >& particle_intersections,const T contour_value,const bool use_triangle_hierarchy_center_phi_test); \
    template void Append_All_Intersections_Edges<VECTOR<T,d> >(RIGID_BODY<VECTOR<T,d> >& body0,RIGID_BODY<VECTOR<T,d> >& body1,ARRAY<RIGID_BODY_PARTICLE_INTERSECTION<VECTOR<T,d> > >& particle_intersections,const T contour_value,const bool use_triangle_hierarchy_center_phi_test); \
...
#define INSTANTIATION_HELPER(T,d) \
    ...
    template void Append_All_Intersections_Triangles<VECTOR<T,d> >(RIGID_BODY<VECTOR<T,d> >& body0,RIGID_BODY<VECTOR<T,d> >& body1,ARRAY<RIGID_BODY_PARTICLE_INTERSECTION<VECTOR<T,d> > >& particle_intersections,const T contour_value,const bool use_triangle_hierarchy_center_phi_test); \
    template void Append_All_Intersections_Edges<VECTOR<T,d> >(RIGID_BODY<VECTOR<T,d> >& body0,RIGID_BODY<VECTOR<T,d> >& body1,ARRAY<RIGID_BODY_PARTICLE_INTERSECTION<VECTOR<T,d> > >& particle_intersections,const T contour_value,const bool use_triangle_hierarchy_center_phi_test); \
    template void Get_Interfering_Simplices<VECTOR<T,d> >(const RIGID_BODY<VECTOR<T,d> >& body0,const RIGID_BODY<VECTOR<T,d> >& body1,ARRAY<int>& simplex_list,MATRIX<T,d>& rotation,VECTOR<T,d>& translation,const bool use_triangle_hierarchy_center_phi_test); \
