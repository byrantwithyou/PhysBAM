...
namespace ARRAYS_COMPUTATIONS
{
    ...
    {assert(a1.Size()==a2.Size());return (m*(a1*a2)).Sum();}
    ...
    typename T_ARRAY2::SCALAR result(0);ID size=a1.Size();for(ID i(0);i<size;i++) result+=m(i).Inner_Product(a1(i),a2(i));return result;}
    ...
    {assert(a1.Size()==a2.Size());return (m*(a1*a2)).Sum().Sum();}
    ...
    {assert(a1.Size()==a2.Size());
    double result(0);ID size=a1.Size();for(ID i(0);i<size;i++) result+=m(i).Inner_Product(a1(i),a2(i));return result;}
}
}
#endif
