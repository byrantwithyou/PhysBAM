...
{
    regions(0)=RANGE<VECTOR<int,1> >(ghost.min_corner.x,domain.min_corner.x-1); // left
    regions(1)=RANGE<VECTOR<int,1> >(domain.max_corner.x+1,ghost.max_corner.x); // right
}
...
{
    regions(0)=RANGE<VECTOR<int,2> >(ghost.min_corner.x,domain.min_corner.x-1,domain.min_corner.y,domain.max_corner.y); // left
    regions(1)=RANGE<VECTOR<int,2> >(domain.max_corner.x+1,ghost.max_corner.x,domain.min_corner.y,domain.max_corner.y); // right
    regions(2)=RANGE<VECTOR<int,2> >(ghost.min_corner.x,ghost.max_corner.x,ghost.min_corner.y,domain.min_corner.y-1); // bottom
    regions(3)=RANGE<VECTOR<int,2> >(ghost.min_corner.x,ghost.max_corner.x,domain.max_corner.y+1,ghost.max_corner.y); // top
}
...
{
    regions(0)=RANGE<VECTOR<int,3> >(ghost.min_corner.x,domain.min_corner.x-1,domain.min_corner.y,domain.max_corner.y,domain.min_corner.z,domain.max_corner.z); // left
    regions(1)=RANGE<VECTOR<int,3> >(domain.max_corner.x+1,ghost.max_corner.x,domain.min_corner.y,domain.max_corner.y,domain.min_corner.z,domain.max_corner.z); // right
    regions(2)=RANGE<VECTOR<int,3> >(ghost.min_corner.x,ghost.max_corner.x,ghost.min_corner.y,domain.min_corner.y-1,domain.min_corner.z,domain.max_corner.z); // bottom
    regions(3)=RANGE<VECTOR<int,3> >(ghost.min_corner.x,ghost.max_corner.x,domain.max_corner.y+1,ghost.max_corner.y,domain.min_corner.z,domain.max_corner.z); // top
    regions(4)=RANGE<VECTOR<int,3> >(ghost.min_corner.x,ghost.max_corner.x,ghost.min_corner.y,ghost.max_corner.y,ghost.min_corner.z,domain.min_corner.z-1); // front
    regions(5)=RANGE<VECTOR<int,3> >(ghost.min_corner.x,ghost.max_corner.x,ghost.min_corner.y,ghost.max_corner.y,domain.max_corner.z+1,ghost.max_corner.z); // back
}
template<class T_GRID,class T2> void BOUNDARY_UNIFORM<T_GRID,T2>::
