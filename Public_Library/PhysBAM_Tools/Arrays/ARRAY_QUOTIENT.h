...
template<class T_ARRAY1,class T_ARRAY2> struct IS_ARRAY<ARRAY_QUOTIENT<T_ARRAY1,T_ARRAY2> > {static const bool value=true;};
template<class T_ARRAY1,class T_ARRAY2> struct IS_ARRAY_VIEW<ARRAY_QUOTIENT<T_ARRAY1,T_ARRAY2> > {static const bool value=true;};

template<class T_ARRAY1,class T_ARRAY2>
class ARRAY_QUOTIENT:public ARRAY_EXPRESSION<typename T_ARRAY1::ELEMENT,ARRAY_QUOTIENT<T_ARRAY1,T_ARRAY2>,typename T_ARRAY1::INDEX>
{
...
public:
    ...
    ARRAY_QUOTIENT(const T_ARRAY1& array1,const T_ARRAY2& array2)
...
template<class T1,class T2,class T_ARRAY1,class T_ARRAY2> ARRAY_QUOTIENT<T_ARRAY1,T_ARRAY2>
...
{return ARRAY_QUOTIENT<T_ARRAY1,T_ARRAY2>(array1.Derived(),array2.Derived());}
...
{typedef ARRAY_QUOTIENT<T_ARRAY1,T_ARRAY2> TYPE;};
