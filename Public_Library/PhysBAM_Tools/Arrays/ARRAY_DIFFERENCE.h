...
template<class T_ARRAY1,class T_ARRAY2,class ENABLE=void> struct ARRAY_DIFFERENCE_VALID {static const bool value=false;};
template<class T_ARRAY1,class T_ARRAY2> struct ARRAY_DIFFERENCE_VALID<T_ARRAY1,T_ARRAY2,typename ENABLE_IF<IS_SAME<typename EQUIVALENT_ARRAY<T_ARRAY1>::TYPE,typename EQUIVALENT_ARRAY<T_ARRAY2>::TYPE>::value>::TYPE>
...
template<class T1,class T2,class T_ARRAY1,class T_ARRAY2> typename ENABLE_IF<ARRAY_DIFFERENCE_VALID<T_ARRAY1,T_ARRAY2>::value,ARRAY_DIFFERENCE<T_ARRAY1,T_ARRAY2> >::TYPE
...
template<class T_ARRAY1,class T_ARRAY2> struct DIFFERENCE<T_ARRAY1,T_ARRAY2,typename ENABLE_IF<ARRAY_DIFFERENCE_VALID<T_ARRAY1,T_ARRAY2>::value>::TYPE>
