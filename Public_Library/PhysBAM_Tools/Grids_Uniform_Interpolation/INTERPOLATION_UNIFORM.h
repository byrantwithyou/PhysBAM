...
public:
    ...
    static TV_INT Clamped_Index(const T_GRID& grid,const ARRAYS_ND_BASE<T2,TV_INT>& u,const TV& location,int start_offset=0,int end_offset=0) 
    ...
    static TV_INT Clamped_Index_End_Minus_One(const T_GRID& grid,const ARRAYS_ND_BASE<T2,TV_INT>& u,const TV& location)
    {return Clamped_Index(grid,u,location,0,1);}

    static TV_INT Clamped_Index_Interior(const T_GRID& grid,const ARRAYS_ND_BASE<T2,TV_INT>& u,const TV& location)
    {return Clamped_Index(grid,u,location,1,1);}

    static TV_INT Clamped_Index_Interior_End_Minus_One(const T_GRID& grid,const ARRAYS_ND_BASE<T2,TV_INT>& u,const TV& location)
    ...
    T2 Clamped_To_Array_Node(const T_GRID& grid,const ARRAYS_ND_BASE<T2,TV_INT>& u,const TV& X) const
    {return Clamped_To_Array(grid,u,X);}
    ...
    VECTOR<T2,2> Extrema_Clamped_To_Array_Cell(const T_GRID& grid,const ARRAYS_ND_BASE<T2,TV_INT>& u_min,const ARRAYS_ND_BASE<T2,TV_INT>& u_max,const TV& X) const
    {return Extrema_Clamped_To_Array(grid,u_min,u_max,X);}

    VECTOR<T2,2> Extrema_Clamped_To_Array_Node(const T_GRID& grid,const ARRAYS_ND_BASE<T2,TV_INT>& u_min,const ARRAYS_ND_BASE<T2,TV_INT>& u_max,const TV& X) const
    {return Extrema_Clamped_To_Array(grid,u_min,u_max,X);}
...
//#####################################################################
    virtual T2 Clamped_To_Array_No_Extrema(const T_GRID& grid,const ARRAYS_ND_BASE<T2,TV_INT>& u,const TV& X) const {PHYSBAM_FUNCTION_IS_NOT_DEFINED();}
    virtual ARRAY<PAIR<TV_INT,T> > Clamped_To_Array_Weights(const T_GRID& grid,const ARRAYS_ND_BASE<T2,TV_INT>& u,const TV& X) const {PHYSBAM_FUNCTION_IS_NOT_DEFINED();}
    virtual T2 Clamped_To_Array(const T_GRID& grid,const ARRAYS_ND_BASE<T2,TV_INT>& u,const TV& X) const {PHYSBAM_FUNCTION_IS_NOT_DEFINED();}
    virtual ARRAY<PAIR<TV_INT,T> > From_Base_Node_Weights(const T_GRID& grid,const ARRAYS_ND_BASE<T2,TV_INT>& u,const TV& X,const TV_INT& index) const {PHYSBAM_FUNCTION_IS_NOT_DEFINED();}
    virtual T2 From_Base_Node(const T_GRID& grid,const ARRAYS_ND_BASE<T2,TV_INT>& u,const TV& X,const TV_INT& index) const {PHYSBAM_FUNCTION_IS_NOT_DEFINED();}
    ...
    {PHYSBAM_FUNCTION_IS_NOT_DEFINED();}
    virtual VECTOR<T2,2> Extrema_Clamped_To_Array(const T_GRID& grid,const ARRAYS_ND_BASE<T2,TV_INT>& u_min,const ARRAYS_ND_BASE<T2,TV_INT>& u_max,const TV& X) const 
    {PHYSBAM_FUNCTION_IS_NOT_DEFINED();}
    virtual VECTOR<T2,2> Extrema_From_Base_Node(const T_GRID& grid,const ARRAYS_ND_BASE<T2,TV_INT>& u_min,const ARRAYS_ND_BASE<T2,TV_INT>& u_max,const TV& X,const TV_INT& index) const
    {PHYSBAM_FUNCTION_IS_NOT_DEFINED();}
