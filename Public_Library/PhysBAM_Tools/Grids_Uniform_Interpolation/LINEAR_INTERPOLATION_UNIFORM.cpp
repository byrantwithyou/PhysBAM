...
template class LINEAR_INTERPOLATION_UNIFORM<GRID<VECTOR<float,3> >,MATRIX<float,3>,FACE_LOOKUP_UNIFORM<GRID<VECTOR<float,3> > > >;
...
template class LINEAR_INTERPOLATION_UNIFORM<GRID<VECTOR<double,3> >,MATRIX<double,3>,FACE_LOOKUP_UNIFORM<GRID<VECTOR<double,3> > > >;
