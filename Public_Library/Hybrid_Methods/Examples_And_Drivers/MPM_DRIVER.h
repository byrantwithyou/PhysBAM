...
public:
    ...
    void Reflect_Boundary_Particle_Force(ARRAY<TV,TV_INT>& force);
    void Reflect_Boundary_Grid_Force(ARRAY<TV,TV_INT>& force);
    template<class S, class N> void Reflect_Boundary(S func_s,N func_n,RI flag) const;
