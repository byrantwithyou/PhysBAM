...
class ARRAY_PLUS_SCALAR:public ARRAY_EXPRESSION<decltype(*(T0*)0+*(typename T_ARRAY1::ELEMENT*)0),ARRAY_PLUS_SCALAR<T0,T_ARRAY1>,typename T_ARRAY1::INDEX>
{
...
template<class T0,class T_ARRAY1> struct ARRAY_PLUS_SCALAR_VALID
