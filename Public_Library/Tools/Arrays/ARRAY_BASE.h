...
#include <Tools/Math_Tools/maxmag.h>
...
public:
    ...
    template<class T2,class T_ARRAY1> typename DISABLE_IF<IS_SCALAR<T2>::value,SCALAR>::TYPE
    ...
    template<class T2,class T_ARRAY1> typename DISABLE_IF<IS_SCALAR<T2>::value,double>::TYPE
