...
class ARRAY_LEFT_MULTIPLE:public ARRAY_EXPRESSION<decltype(*(T0*)0**(typename T_ARRAY1::ELEMENT*)0),ARRAY_LEFT_MULTIPLE<T0,T_ARRAY1>,typename T_ARRAY1::INDEX>
{
...
template<class T0,class T_ARRAY1> struct ARRAY_LEFT_MULTIPLE_VALID<T0,T_ARRAY1,typename FIRST<void,decltype(*(T0*)0**(typename T_ARRAY1::ELEMENT*)0)>::TYPE>
