...
#include <Tools/Adaptive_Arithmetic/ADAPTIVE_WRAPPER_BASE.h>
...
struct IS_ADAPTIVE<ADAPTIVE_SUM<T_ADAPTIVE0,T_ADAPTIVE1> > {static const bool value=true;};

template<class T_ADAPTIVE0,class T_ADAPTIVE1>
class ADAPTIVE_SUM:public ADAPTIVE_BASE<ADAPTIVE_SUM<T_ADAPTIVE0,T_ADAPTIVE1>,typename EXACT_ARITHMETIC_POLICY<typename T_ADAPTIVE0::EXACT_TYPE,typename T_ADAPTIVE1::EXACT_TYPE>::SUM_TYPE>
{
...
public:
    typedef ADAPTIVE_SUM<T_ADAPTIVE0,T_ADAPTIVE1> THIS;
    typedef ADAPTIVE_BASE<THIS,typename EXACT_ARITHMETIC_POLICY<typename T_ADAPTIVE0::EXACT_TYPE,typename T_ADAPTIVE1::EXACT_TYPE>::SUM_TYPE > BASE;
    typedef typename BASE::EXACT_TYPE EXACT_TYPE;
    typedef typename BASE::FP_TYPE FP_TYPE;

    ADAPTIVE_SUM(const T_ADAPTIVE0& a1_input,const T_ADAPTIVE1& a2_input)
