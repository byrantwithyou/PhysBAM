...
struct IS_ADAPTIVE<ADAPTIVE_DIFFERENCE<T_ADAPTIVE0,T_ADAPTIVE1> > {static const bool value=true;};

template<class T_ADAPTIVE0,class T_ADAPTIVE1>
class ADAPTIVE_DIFFERENCE:public ADAPTIVE_BASE<ADAPTIVE_DIFFERENCE<T_ADAPTIVE0,T_ADAPTIVE1>,typename EXACT_ARITHMETIC_POLICY<typename T_ADAPTIVE0::EXACT_TYPE,typename T_ADAPTIVE1::EXACT_TYPE>::SUM_TYPE>
{
    STATIC_ASSERT((IS_ADAPTIVE<T_ADAPTIVE0>::value));
    STATIC_ASSERT((IS_ADAPTIVE<T_ADAPTIVE1>::value));

public:
    typedef ADAPTIVE_BASE<ADAPTIVE_DIFFERENCE,typename EXACT_ARITHMETIC_POLICY<typename T_ADAPTIVE0::EXACT_TYPE,typename T_ADAPTIVE1::EXACT_TYPE>::SUM_TYPE> BASE;
...
public:
    ADAPTIVE_DIFFERENCE(const T_ADAPTIVE0& a1_input,const T_ADAPTIVE1& a2_input)
