...
template<class TV,class T2,class T_AVERAGING=AVERAGING_UNIFORM<TV>,class T_INTERPOLATION=LINEAR_INTERPOLATION_UNIFORM<TV,T2> > class THREADED_ADVECTION_SEMI_LAGRANGIAN_UNIFORM;
...
template<class TV,class T2,class T_AVERAGING,class T_INTERPOLATION,class T_NEW> struct REBIND<ADVECTION_SEMI_LAGRANGIAN_UNIFORM<TV,T2,T_AVERAGING,T_INTERPOLATION>,T_NEW>{
    typedef ADVECTION_SEMI_LAGRANGIAN_UNIFORM<TV,T_NEW,T_AVERAGING,typename REBIND<T_INTERPOLATION,T_NEW>::TYPE> TYPE;};
template<class TV,class T2,class T_AVERAGING,class T_INTERPOLATION,class T_NEW> struct REBIND<ADVECTION_SEMI_LAGRANGIAN_UNIFORM_BETA<TV,T2,T_AVERAGING,T_INTERPOLATION>,T_NEW>{
    typedef ADVECTION_SEMI_LAGRANGIAN_UNIFORM_BETA<TV,T_NEW,T_AVERAGING,typename REBIND<T_INTERPOLATION,T_NEW>::TYPE> TYPE;};
