...
struct NEWTONS_METHOD
{
    ...
    NEWTONS_METHOD()
        ...
        use_gradient_descent_failsafe(true),tolerance((T)5e-10),
        ...
        max_golden_section_iterations(10*sizeof(T)),angle_tolerance(0),use_cg(true),use_gmres(false),
        max_newton_step_size(0),debug(false),
