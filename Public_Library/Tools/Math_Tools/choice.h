...
template<int i,class T1,class T2>
inline typename IF<i==0,const T1&,const T2&>::TYPE choice(const T1& a,const T2& b)
{return choice_helper<i,const T1,const T2,void>::helper(a,b);}

template<int i,class T1,class T2>
inline typename IF<i==0,T1&,const T2&>::TYPE choice(T1& a,const T2& b)
{return choice_helper<i,T1,const T2,void>::helper(a,b);}

template<int i,class T1,class T2>
inline typename IF<i==0,const T1&,T2&>::TYPE choice(const T1& a,T2& b)
{return choice_helper<i,const T1,T2,void>::helper(a,b);}

template<int i,class T1,class T2,class T3>
inline typename IF<i==0,T1&,typename IF<i==1,T2&,T3&>::TYPE>::TYPE choice(T1& a,T2& b,T3& c)
