...
public:
    ...
    void Project_Nullspace(KRYLOV_VECTOR_BASE<T>& bx) const override
    ...
    void Apply_Preconditioner(const KRYLOV_VECTOR_BASE<T>& br,KRYLOV_VECTOR_BASE<T>& bz) const override // solve Mz=r
