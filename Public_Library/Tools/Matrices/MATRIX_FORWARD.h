...
template<class T,int d> struct IS_MATRIX<ZERO_MATRIX<T,d> > {static const bool value=true;};
template<class T,int d> struct IS_MATRIX<MATRIX<T,d> > {static const bool value=true;};
