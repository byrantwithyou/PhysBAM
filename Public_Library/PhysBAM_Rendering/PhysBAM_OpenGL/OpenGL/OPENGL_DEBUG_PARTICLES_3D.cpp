...
#include <PhysBAM_Rendering/PhysBAM_OpenGL/OpenGL/OPENGL_DEBUG_PARTICLES_3D.h>
...
OPENGL_DEBUG_PARTICLES_3D(GEOMETRY_PARTICLES<TV>& particle_input,const OPENGL_COLOR& color_input)
    :particles(particle_input),default_color(color_input),velocity_color(OPENGL_COLOR(1,(T).078,(T).576)),draw_velocities(false),scale_velocities((T).025)
{}
//#####################################################################
// Destructor
//#####################################################################
...
//#####################################################################
template<class T> RANGE<VECTOR<float,3> > OPENGL_DEBUG_PARTICLES_3D<T>::
Bounding_Box() const
{
...
//#####################################################################
template<class T> OPENGL_SELECTION *OPENGL_DEBUG_PARTICLES_3D<T>::
...
// Function Bounding_Box
//#####################################################################
template<class T> RANGE<VECTOR<float,3> > OPENGL_SELECTION_DEBUG_PARTICLES_3D<T>::
Bounding_Box() const
{
