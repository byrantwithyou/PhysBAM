...
//#####################################################################
// Class OPENGL_COMPONENT_RLE_CELL_SCALAR_FIELD_2D
//#####################################################################
#ifndef __OPENGL_COMPONENT_RLE_CELL_SCALAR_FIELD_2D__
#define __OPENGL_COMPONENT_RLE_CELL_SCALAR_FIELD_2D__
...
class OPENGL_COMPONENT_RLE_CELL_SCALAR_FIELD_2D:public OPENGL_COMPONENT
{
public:
    OPENGL_RLE_CELL_SCALAR_FIELD_2D<T,T2> opengl_rle_cell_scalar_field;
...
public:
    ...
    DEFINE_COMPONENT_CALLBACK(OPENGL_COMPONENT_RLE_CELL_SCALAR_FIELD_2D, Increase_Point_Size, "Increase point size");
    DEFINE_COMPONENT_CALLBACK(OPENGL_COMPONENT_RLE_CELL_SCALAR_FIELD_2D, Decrease_Point_Size, "Decrease point size");
