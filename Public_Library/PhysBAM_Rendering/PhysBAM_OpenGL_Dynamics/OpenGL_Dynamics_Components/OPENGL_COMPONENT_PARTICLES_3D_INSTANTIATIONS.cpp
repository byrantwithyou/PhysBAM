...
template class OPENGL_COMPONENT_PARTICLES_3D<float,DEFORMABLE_PARTICLES<VECTOR<float,3> >,float>;
...
template class OPENGL_COMPONENT_PARTICLES_3D<double,DEFORMABLE_PARTICLES<VECTOR<double,3> >,double>;
