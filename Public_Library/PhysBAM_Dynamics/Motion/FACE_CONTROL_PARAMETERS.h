...
public:
    ...
    void Get(ARRAY<T>& values) const;
    void Get(ARRAY<T>& values,const ARRAY<int>& subset) const;
    void Get_Active(ARRAY<bool>& active) const;
    void Get_Active(ARRAY<bool>& active,const ARRAY<int>& subset) const;
    void Set(const ARRAY<T>& values);
    void Set(const ARRAY<T>& values,const ARRAY<int>& subset);
    ...
    T Penalty() const;
    ARRAY<T> Penalty_Gradient() const;
    MATRIX_MXN<T> Penalty_Hessian() const;
    void Save_Controls();
    void Print_Diagnostics(std::ostream& output=LOG::cout) const;
    ...
    void Identity_Controls(ARRAY<T>& values) const;
