...
//#####################################################################
template<class TV> template<class GEOMETRY> void PLS_FC_EXAMPLE<TV>::
...
{       
    LOG::SCOPE scope("PLS_FC_EXAMPLE parameters");
    BASE::Log_Parameters();
