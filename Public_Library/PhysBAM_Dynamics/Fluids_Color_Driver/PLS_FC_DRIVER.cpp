...
PLS_FC_DRIVER(PLS_FC_EXAMPLE<TV>& example_input)
...
// Function Compute_Dt
//#####################################################################
template<class TV> typename TV::SCALAR PLS_FC_DRIVER<TV>::
Compute_Dt(const T time,const T target_time,bool& done)
{
    ...
    PLS_FC_EXAMPLE<TV>::Clamp_Time_Step_With_Target_Time(time,target_time,dt,done,solids_parameters.min_dt);
    return dt;
}
//#####################################################################
...
// Function Delete_Particles_Inside_Objects
//#####################################################################
template<class TV> template<class T_PARTICLES> void PLS_FC_DRIVER<TV>::
