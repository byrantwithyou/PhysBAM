//#####################################################################
// Copyright 2002-2009, Ronald Fedkiw, Geoffrey Irving, Andrew Selle, Tamar Shinar, Jonathan Su.
// This file is part of PhysBAM whose distribution is governed by the license contained in the accompanying file PHYSBAM_COPYRIGHT.txt.
//#####################################################################
// Class LEVELSET_ADVECTION_1D
//##################################################################### 
#ifndef __LEVELSET_ADVECTION_1D__
#define __LEVELSET_ADVECTION_1D__
...
template<class T>
class LEVELSET_ADVECTION_1D:public LEVELSET_ADVECTION_UNIFORM<GRID<VECTOR<T,1> > >
{
...
public:
    ...
    LEVELSET_ADVECTION_1D(T_LEVELSET* _levelset):BASE(_levelset){};
    LEVELSET_ADVECTION_1D():BASE(0){};
...
private:
    void Euler_Step_Of_Reinitialization(const ARRAY<T,VECTOR<int,1> >& sign_phi,const T dt,const T time);
};
