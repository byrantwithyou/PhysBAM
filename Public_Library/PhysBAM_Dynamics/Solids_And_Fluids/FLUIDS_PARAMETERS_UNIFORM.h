...
class FLUIDS_PARAMETERS_UNIFORM:public FLUIDS_PARAMETERS<T_GRID>
{
    ...
    typedef typename T_GRID::VECTOR_INT TV_INT;typedef UNIFORM_GRID_ITERATOR_NODE<TV> NODE_ITERATOR;typedef UNIFORM_GRID_ITERATOR_FACE<TV> FACE_ITERATOR;
    typedef UNIFORM_GRID_ITERATOR_CELL<TV> CELL_ITERATOR;typedef INCOMPRESSIBLE_UNIFORM<T_GRID> T_INCOMPRESSIBLE;
