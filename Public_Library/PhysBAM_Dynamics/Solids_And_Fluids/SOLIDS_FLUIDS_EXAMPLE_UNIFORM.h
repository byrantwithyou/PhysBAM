    ...
    public FLUIDS_PARAMETERS_CALLBACKS<T_GRID>
{
    ...
    typedef typename T_GRID::VECTOR_INT T_VECTOR_INT;typedef ARRAY<T,TV_INT> T_ARRAYS_SCALAR;
    ...
    typedef typename TV::SPIN T_ANGULAR_VELOCITY;typedef typename COLLISION_BODY_COLLECTION_POLICY<T_GRID>::GRID_BASED_COLLISION_GEOMETRY T_GRID_BASED_COLLISION_GEOMETRY;
...
public:
    ...
    void Get_Levelset_Velocity(const T_GRID& grid,LEVELSET<TV>& levelset,T_FACE_ARRAYS_SCALAR& V_levelset,const T time) const PHYSBAM_OVERRIDE
...
//#####################################################################
    ...
    void Get_Levelset_Velocity(const T_GRID& grid,LEVELSET_MULTIPLE<T_GRID>& levelset_multiple,T_FACE_ARRAYS_SCALAR& V_levelset,const T time) const PHYSBAM_OVERRIDE;
