...
FLUIDS_PARAMETERS(const TYPE type)
    ...
    variable_viscosity(false),implicit_viscosity(true),use_explicit_part_of_implicit_viscosity(false),implicit_viscosity_iterations(40),
    ...
    soot_advection_order(2),ambient_soot(0),ambient_density(0),ambient_temperature(298),
    soot_container(*grid),soot_fuel_container(*grid),density_container(*grid),temperature_container(*grid),
    use_soot_fuel_combustion(false),burn_temperature_threshold(2000),burn_rate(.2),
    soot_fuel_calorific_value((T)54000),
    soot_boundary(0),density_boundary(0),temperature_boundary(0),
    temperature_fuel(298),temperature_products(3000),
    ...
    use_strain(false),elastic_modulus(1000),plasticity_alpha(0),plasticity_gamma(0),adhesion_coefficient(0),adhesion_normal_strain(0),adhesion_half_bandwidth((T)1.5),
    ...
    compressible_set_max_time_step(false),compressible_max_time_step(1.e8),compressible_spatial_order(3),compressible_rungekutta_order(3),compressible_tolerance((T)1e-8),
    ...
    compressible_use_sound_speed_based_dt_multiple_for_cfl(false),compressible_multiplication_factor_for_sound_speed_based_dt(1.),
...
Log_Parameters() const
{
    ...
    LOG::cout<<"solid_affects_fluid="<<solid_affects_fluid<<std::endl;
    LOG::cout<<"fluid_affects_solid="<<fluid_affects_solid<<std::endl;
    // compressible parameters
    LOG::cout<<"compressible_set_max_time_step="<<compressible_set_max_time_step<<std::endl;
    LOG::cout<<"compressible_max_time_step="<<compressible_max_time_step<<std::endl;
    LOG::cout<<"compressible_spatial_order="<<compressible_spatial_order<<std::endl;
    LOG::cout<<"compressible_rungekutta_order="<<compressible_rungekutta_order<<std::endl;
    LOG::cout<<"compressible_timesplit="<<compressible_timesplit<<std::endl;
    LOG::cout<<"compressible_monitor_conservation_error="<<compressible_monitor_conservation_error<<std::endl;
    LOG::cout<<"compressible_perform_rungekutta_for_implicit_part="<<compressible_perform_rungekutta_for_implicit_part<<std::endl;
    LOG::cout<<"compressible_use_sound_speed_for_cfl="<<compressible_use_sound_speed_for_cfl<<std::endl;
    LOG::cout<<"compressible_use_sound_speed_based_dt_multiple_for_cfl="<<compressible_use_sound_speed_based_dt_multiple_for_cfl<<std::endl;
    LOG::cout<<"compressible_multiplication_factor_for_sound_speed_based_dt="<<compressible_multiplication_factor_for_sound_speed_based_dt<<std::endl;
    LOG::cout<<"compressible_log_extremas="<<compressible_log_extremas<<std::endl;
