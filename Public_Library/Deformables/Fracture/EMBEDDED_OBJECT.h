...
public:
    ...
    else{assert(parent_particles(embedded_particle)(1)==old_parent_particle);parent_particles(embedded_particle)(1)=new_parent_particle;}}
    ...
    node_in_simplex_is_material.Resize(simplicial_object.mesh.elements.m,no_init);
    node_in_simplex_is_material.Flattened().Fill(true);}
