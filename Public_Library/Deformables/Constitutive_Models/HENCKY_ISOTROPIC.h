...
//#####################################################################
// Class HENCKY_ISOTROPIC
//##################################################################### 
#ifndef __HENCKY_ISOTROPIC__
#define __HENCKY_ISOTROPIC__

#include <Deformables/Constitutive_Models/ISOTROPIC_CONSTITUTIVE_MODEL.h>
namespace PhysBAM{

template<class T,int d>
class HENCKY_ISOTROPIC:public ISOTROPIC_CONSTITUTIVE_MODEL<T,d>
{
...
public:
    ...
    HENCKY_ISOTROPIC(const T youngs_modulus_input=3e6,const T poissons_ratio_input=.475,const T Rayleigh_coefficient=.05);
    virtual ~HENCKY_ISOTROPIC();
