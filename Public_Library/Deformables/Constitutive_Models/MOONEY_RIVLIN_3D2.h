...
public:
    ...
    alpha.x11=2*Jcc*(mu_10+Jcc*mu_01*(I_C-C.x.x-C.x.x));alpha.x21=2*Jcc*(mu_10+Jcc*mu_01*(I_C-C.x.y-C.x.x));alpha.x31=2*Jcc*(mu_10+Jcc*mu_01*(I_C-C.x.z-C.x.x));
    alpha.x22=2*Jcc*(mu_10+Jcc*mu_01*(I_C-C.x.y-C.x.y));alpha.x32=2*Jcc*(mu_10+Jcc*mu_01*(I_C-C.x.z-C.x.y));alpha.x33=2*Jcc*(mu_10+Jcc*mu_01*(I_C-C.x.z-C.x.z));
    SYMMETRIC_MATRIX<T,3> beta;
    beta.x11=(Jcc*(T)two_thirds*(mu_10*I_C+Jcc*mu_01*(I_C*I_C-II_C))-kappa*log(J))*F_inverse.x.x*F_inverse.x.x-2*Jcc*Jcc*mu_01*F_threshold.x.x*F_threshold.x.x;
    beta.x21=(Jcc*(T)two_thirds*(mu_10*I_C+Jcc*mu_01*(I_C*I_C-II_C))-kappa*log(J))*F_inverse.x.y*F_inverse.x.x-2*Jcc*Jcc*mu_01*F_threshold.x.y*F_threshold.x.x;
    beta.x31=(Jcc*(T)two_thirds*(mu_10*I_C+Jcc*mu_01*(I_C*I_C-II_C))-kappa*log(J))*F_inverse.x.z*F_inverse.x.x-2*Jcc*Jcc*mu_01*F_threshold.x.z*F_threshold.x.x;
    beta.x22=(Jcc*(T)two_thirds*(mu_10*I_C+Jcc*mu_01*(I_C*I_C-II_C))-kappa*log(J))*F_inverse.x.y*F_inverse.x.y-2*Jcc*Jcc*mu_01*F_threshold.x.y*F_threshold.x.y;
    beta.x32=(Jcc*(T)two_thirds*(mu_10*I_C+Jcc*mu_01*(I_C*I_C-II_C))-kappa*log(J))*F_inverse.x.z*F_inverse.x.y-2*Jcc*Jcc*mu_01*F_threshold.x.z*F_threshold.x.y;
    beta.x33=(Jcc*(T)two_thirds*(mu_10*I_C+Jcc*mu_01*(I_C*I_C-II_C))-kappa*log(J))*F_inverse.x.z*F_inverse.x.z-2*Jcc*Jcc*mu_01*F_threshold.x.z*F_threshold.x.z;
