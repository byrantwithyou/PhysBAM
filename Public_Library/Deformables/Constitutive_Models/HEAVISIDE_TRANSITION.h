...
public:
    ...
    HEAVISIDE_TRANSITION(const T input_x_min, const T input_x_max)
    ...
    void Initialize(const T input_x_min, const T input_x_max)
    {
        assert(input_x_max>input_x_min);
        x_min=input_x_min;
        x_max=input_x_max;
