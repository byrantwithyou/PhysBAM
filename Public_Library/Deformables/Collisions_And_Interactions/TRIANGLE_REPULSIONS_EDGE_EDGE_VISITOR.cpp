...
#include <Deformables/Collisions_And_Interactions/TRIANGLE_REPULSIONS_EDGE_EDGE_VISITOR.h>
...
template void BOX_HIERARCHY<VECTOR<double,3> >::Intersection_List<BOX_VISITOR_MPI<TRIANGLE_REPULSIONS_EDGE_EDGE_VISITOR<VECTOR<double,3> > > >(
    BOX_HIERARCHY<VECTOR<double,3> > const&,BOX_VISITOR_MPI<TRIANGLE_REPULSIONS_EDGE_EDGE_VISITOR<VECTOR<double,3> > >&,double) const;
template void BOX_HIERARCHY<VECTOR<double,3> >::Intersection_List<TRIANGLE_REPULSIONS_EDGE_EDGE_VISITOR<VECTOR<double,3> > >(
    BOX_HIERARCHY<VECTOR<double,3> > const&,TRIANGLE_REPULSIONS_EDGE_EDGE_VISITOR<VECTOR<double,3> >&,double) const;
template void BOX_HIERARCHY<VECTOR<float,3> >::Intersection_List<BOX_VISITOR_MPI<TRIANGLE_REPULSIONS_EDGE_EDGE_VISITOR<VECTOR<float,3> > > >(
    BOX_HIERARCHY<VECTOR<float,3> > const&,BOX_VISITOR_MPI<TRIANGLE_REPULSIONS_EDGE_EDGE_VISITOR<VECTOR<float,3> > >&,float) const;
template void BOX_HIERARCHY<VECTOR<float,3> >::Intersection_List<TRIANGLE_REPULSIONS_EDGE_EDGE_VISITOR<VECTOR<float,3> > >(
    BOX_HIERARCHY<VECTOR<float,3> > const&,TRIANGLE_REPULSIONS_EDGE_EDGE_VISITOR<VECTOR<float,3> >&,float) const;
}
