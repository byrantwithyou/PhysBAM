...
class INCOMPRESSIBLE:public NONCOPYABLE
{
    ...
    typedef ADVECTION_SEMI_LAGRANGIAN_COLLIDABLE_FACE_SLIP_UNIFORM<TV,FACE_LOOKUP_COLLIDABLE_SLIP_UNIFORM<TV> > T_ADVECTION_SEMI_LAGRANGIAN_COLLIDABLE_SLIP_FACE;
