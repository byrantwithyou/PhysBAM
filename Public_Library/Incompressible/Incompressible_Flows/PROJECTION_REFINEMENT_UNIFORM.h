...
public:
    ...
    ARRAY<T,FACE_INDEX<TV::m> > coarse_face_velocities,coarse_face_velocities_save,face_velocities_save,local_face_velocities;
    ARRAY<T,FACE_INDEX<TV::m> > &beta_face;
    ARRAY<bool,FACE_INDEX<TV::m> > fine_psi_N;
...
//#####################################################################
    ...
    void Set_Beta_Face_For_Boundary_Conditions(ARRAY<T,FACE_INDEX<TV::m> >& coarse_face_velocities);
    ...
    void Map_Coarse_To_Fine(const ARRAY<T,FACE_INDEX<TV::m> >& coarse_face_velocities,ARRAY<T,FACE_INDEX<TV::m> >& face_velocities);
    void Map_Fine_To_Local_Boundary_For_Cell(GRID<TV>& local_mac_grid,ARRAY<T,FACE_INDEX<TV::dimension> >& local_face_velocities,ARRAY<T,FACE_INDEX<TV::m> >& fine_face_velocities,TV_INT coarse_cell_index);
    void Map_Fine_To_Local_Interior_For_Cell(GRID<TV>& local_mac_grid,ARRAY<T,FACE_INDEX<TV::dimension> >& local_face_velocities,ARRAY<T,FACE_INDEX<TV::m> >& fine_face_velocities,TV_INT coarse_cell_index,bool zero_out);
    ...
    void Map_Local_To_Fine_Interior_For_Cell(GRID<TV>& local_mac_grid,ARRAY<T,FACE_INDEX<TV::dimension> >& local_face_velocities,ARRAY<T,FACE_INDEX<TV::m> >& fine_face_velocities,TV_INT cell_index);
    ...
    void Threaded_Local_Projection_PCG(ARRAY<T,FACE_INDEX<TV::m> >& fine_face_velocities,const T dt,const T time);
    void Local_Projection_PCG(ARRAY<T,FACE_INDEX<TV::m> >& fine_face_velocities,const T dt,const T time);
