...
public:
    ...
    ADVECTION_WRAPPER_COLLIDABLE_CELL(T_NESTED_ADVECTION& nested_advection_input,const GRID_BASED_COLLISION_GEOMETRY_UNIFORM<TV>& body_list_input,const ARRAY<bool,FACE_INDEX<TV::m> >& face_velocities_valid_mask_input)
