...
public:
    ...
    SYMMETRIC_MATRIX(const SYMMETRIC_MATRIX<T,2>& matrix_input)
        :x00(matrix_input.x00),x10(matrix_input.x10),x11(matrix_input.x11)
    {}
    ...
    {return SYMMETRIC_MATRIX(x00*x00+x10*x10,x10*x00+x11*x10,x10*x10+x11*x11);}
