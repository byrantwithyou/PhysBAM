...
template void PhysBAM::Debug_Particle_Set_Attribute<VECTOR<float,1>,float>(ATTRIBUTE_ID,float const&);
template void PhysBAM::Debug_Particle_Set_Attribute<VECTOR<float,2>,float>(ATTRIBUTE_ID,float const&);
template void PhysBAM::Debug_Particle_Set_Attribute<VECTOR<float,3>,float>(ATTRIBUTE_ID,float const&);
...
template void PhysBAM::Debug_Particle_Set_Attribute<VECTOR<double,1>,double>(ATTRIBUTE_ID,double const&);
template void PhysBAM::Debug_Particle_Set_Attribute<VECTOR<double,2>,double>(ATTRIBUTE_ID,double const&);
template void PhysBAM::Debug_Particle_Set_Attribute<VECTOR<double,3>,double>(ATTRIBUTE_ID,double const&);
