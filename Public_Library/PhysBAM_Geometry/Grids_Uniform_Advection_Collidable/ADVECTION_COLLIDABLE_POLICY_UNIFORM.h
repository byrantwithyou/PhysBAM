...
public:
    ...
    // slip collidable
    typedef ADVECTION_SEMI_LAGRANGIAN_COLLIDABLE_FACE_SLIP_UNIFORM<T_GRID,FACE_LOOKUP_COLLIDABLE_SLIP_UNIFORM<T_GRID> > ADVECTION_SEMI_LAGRANGIAN_COLLIDABLE_SLIP_FACE;
};
