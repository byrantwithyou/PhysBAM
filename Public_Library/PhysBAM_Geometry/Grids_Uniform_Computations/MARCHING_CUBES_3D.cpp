...
Initialize_Case_Table(ARRAY<typename MARCHING_CUBES_3D<T>::CASE>& table)
{
    ...
    static CASE c21 = {{TRI(18,9,8,0), TRI(14,18,8,0), TRI(10,14,8,0)}, {TRI(18,2,9,0), TRI(10,8,1,0), TRI(10,1,5,0)}};
    static CASE c22 = {{TRI(13,17,8,0), TRI(10,14,16,0), TRI(18,9,12,1)}, {TRI(17,5,8,0), TRI(5,0,8,0), TRI(5,10,0,0), TRI(10,16,0,0), TRI(18,6,9,1), TRI(9,6,3,1), TRI(3,6,7,1)}};
    static CASE c23 = {{TRI(18,9,14,0), TRI(9,10,14,0), TRI(9,13,10,0), TRI(13,17,10,0)}, {TRI(2,9,18,0), TRI(10,17,5,0)}};
    static CASE c24 = {{TRI(10,14,16,0), TRI(9,13,19,1)}, {TRI(5,0,1,0), TRI(5,10,0,0), TRI(10,16,0,0), TRI(9,19,7,1), TRI(9,7,2,1), TRI(7,6,2,1)}};
    static CASE c25 = {{TRI(10,14,12,0), TRI(10,12,8,0), TRI(9,13,19,1)}, {TRI(5,8,1,0), TRI(5,10,8,0), TRI(9,19,7,1), TRI(9,7,2,1), TRI(7,6,2,1)}};
    static CASE c27 = {{TRI(10,14,12,0), TRI(10,12,9,0), TRI(10,9,17,0), TRI(9,19,17,0)}, {TRI(5,10,17,0), TRI(3,19,9,0)}};
    static CASE c28 = {{TRI(10,14,16,0), TRI(12,18,13,1), TRI(13,18,19,1)}, {TRI(5,0,1,0), TRI(5,10,0,0), TRI(10,16,0,0), TRI(18,7,19,1), TRI(6,7,18,1)}};
    static CASE c29 = {{TRI(10,14,18,0), TRI(19,10,18,0), TRI(19,13,10,0), TRI(13,8,10,0)}, {TRI(5,8,1,0), TRI(5,10,8,0), TRI(19,18,2,0), TRI(19,2,3,0)}};
    static CASE c30 = {{TRI(18,19,12,0), TRI(12,19,8,0), TRI(19,17,8,0), TRI(10,14,16,0)}, {TRI(17,5,8,0), TRI(5,0,8,0), TRI(5,10,0,0), TRI(10,16,0,0), TRI(18,3,19,0), TRI(18,2,3,0)}};
    static CASE c60 = {{TRI(15,14,16,0), TRI(15,16,17,0), TRI(12,18,13,1), TRI(13,18,19,1)}, {TRI(17,0,1,0), TRI(17,16,0,0), TRI(18,7,19,1), TRI(6,7,18,1)}};
    static CASE c61 = {{TRI(15,14,17,0), TRI(14,8,17,0), TRI(14,13,8,0), TRI(14,19,13,0), TRI(14,18,19,0)}, {TRI(17,8,1,0), TRI(18,3,19,0), TRI(18,2,3,0)}};
    ...
    static CASE c105 = {{TRI(16,12,8,0), TRI(17,15,10,0), TRI(9,13,19,1), TRI(11,14,18,1)}, {TRI(16,8,4,0), TRI(8,1,4,0), TRI(1,10,4,0), TRI(1,17,10,0), TRI(9,19,7,1), TRI(9,7,2,1), TRI(7,11,2,1), TRI(11,18,2,1)}};
    static CASE c107 = {{TRI(16,12,9,0), TRI(16,9,19,0), TRI(10,16,19,0), TRI(19,15,10,0), TRI(11,14,18,1)}, {TRI(16,10,4,0), TRI(9,3,19,0), TRI(3,7,2,1), TRI(7,11,2,1), TRI(11,18,2,1)}}; // TODO: Not done.
