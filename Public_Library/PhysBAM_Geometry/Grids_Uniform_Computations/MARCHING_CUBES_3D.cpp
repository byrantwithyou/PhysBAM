...
Initialize_Case_Table(ARRAY<typename MARCHING_CUBES_3D<T>::CASE>& table)
{
    ...
    static CASE c151 = {{TRI(10,1,6,1), TRI(1,2,6,0), TRI(1,5,2,0), TRI(5,9,2,0), TRI(11,3,7,1)}, {TRI(10,6,14,1), TRI(6,16,14,0), TRI(16,12,14,0), TRI(5,13,9,0), TRI(11,7,19,1)}, 0, 1};
