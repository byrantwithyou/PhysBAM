...
template void MARCHING_CUBES<VECTOR<float,3> >::Create_Double_Fine_Surface(TRIANGULATED_SURFACE<float>&,GRID<VECTOR<float,3> > const&,GRID<VECTOR<float,3> > const&,ARRAY<float,VECTOR<int,3> > const&);
template void MARCHING_CUBES<VECTOR<float,2> >::Create_Double_Fine_Surface(SEGMENTED_CURVE_2D<float>&,GRID<VECTOR<float,2> > const&,GRID<VECTOR<float,2> > const&,ARRAY<float,VECTOR<int,2> > const&);
#endif
...
template void MARCHING_CUBES<VECTOR<double,3> >::Create_Double_Fine_Surface(TRIANGULATED_SURFACE<double>&,GRID<VECTOR<double,3> > const&,GRID<VECTOR<double,3> > const&,ARRAY<double,VECTOR<int,3> > const&);
template void MARCHING_CUBES<VECTOR<double,2> >::Create_Double_Fine_Surface(SEGMENTED_CURVE_2D<double>&,GRID<VECTOR<double,2> > const&,GRID<VECTOR<double,2> > const&,ARRAY<double,VECTOR<int,2> > const&);
