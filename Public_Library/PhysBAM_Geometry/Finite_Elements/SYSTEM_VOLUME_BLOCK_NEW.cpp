...
template<class TV,int static_degree> void SYSTEM_VOLUME_BLOCK_NEW<TV,static_degree>::
...
template class SYSTEM_VOLUME_BLOCK_NEW<VECTOR<float,2>,2>;
template class SYSTEM_VOLUME_BLOCK_NEW<VECTOR<float,3>,2>;
template void SYSTEM_VOLUME_BLOCK_NEW<VECTOR<float,2>,2>::Initialize<0,1>(SYSTEM_VOLUME_BLOCK_HELPER_NEW<VECTOR<float,2> >&,
    BASIS_STENCIL_UNIFORM<VECTOR<float,2>,0> const&,BASIS_STENCIL_UNIFORM<VECTOR<float,2>,1> const&,VECTOR<float,2> const&);
template void SYSTEM_VOLUME_BLOCK_NEW<VECTOR<float,2>,2>::Initialize<1,1>(SYSTEM_VOLUME_BLOCK_HELPER_NEW<VECTOR<float,2> >&,
    BASIS_STENCIL_UNIFORM<VECTOR<float,2>,1> const&,BASIS_STENCIL_UNIFORM<VECTOR<float,2>,1> const&,VECTOR<float,2> const&);
template void SYSTEM_VOLUME_BLOCK_NEW<VECTOR<float,3>,2>::Initialize<0,1>(SYSTEM_VOLUME_BLOCK_HELPER_NEW<VECTOR<float,3> >&,
    BASIS_STENCIL_UNIFORM<VECTOR<float,3>,0> const&,BASIS_STENCIL_UNIFORM<VECTOR<float,3>,1> const&,VECTOR<float,2> const&);
template void SYSTEM_VOLUME_BLOCK_NEW<VECTOR<float,3>,2>::Initialize<1,1>(SYSTEM_VOLUME_BLOCK_HELPER_NEW<VECTOR<float,3> >&,
    BASIS_STENCIL_UNIFORM<VECTOR<float,3>,1> const&,BASIS_STENCIL_UNIFORM<VECTOR<float,3>,1> const&,VECTOR<float,2> const&);
#ifndef COMPILE_WITHOUT_DOUBLE_SUPPORT
template class SYSTEM_VOLUME_BLOCK_NEW<VECTOR<double,2>,2>;
template class SYSTEM_VOLUME_BLOCK_NEW<VECTOR<double,3>,2>;
template void SYSTEM_VOLUME_BLOCK_NEW<VECTOR<double,2>,2>::Initialize<0,1>(SYSTEM_VOLUME_BLOCK_HELPER_NEW<VECTOR<double,2> >&,
    BASIS_STENCIL_UNIFORM<VECTOR<double,2>,0> const&,BASIS_STENCIL_UNIFORM<VECTOR<double,2>,1> const&,VECTOR<double,2> const&);
template void SYSTEM_VOLUME_BLOCK_NEW<VECTOR<double,2>,2>::Initialize<1,1>(SYSTEM_VOLUME_BLOCK_HELPER_NEW<VECTOR<double,2> >&,
    BASIS_STENCIL_UNIFORM<VECTOR<double,2>,1> const&,BASIS_STENCIL_UNIFORM<VECTOR<double,2>,1> const&,VECTOR<double,2> const&);
template void SYSTEM_VOLUME_BLOCK_NEW<VECTOR<double,3>,2>::Initialize<0,1>(SYSTEM_VOLUME_BLOCK_HELPER_NEW<VECTOR<double,3> >&,
    BASIS_STENCIL_UNIFORM<VECTOR<double,3>,0> const&,BASIS_STENCIL_UNIFORM<VECTOR<double,3>,1> const&,VECTOR<double,2> const&);
template void SYSTEM_VOLUME_BLOCK_NEW<VECTOR<double,3>,2>::Initialize<1,1>(SYSTEM_VOLUME_BLOCK_HELPER_NEW<VECTOR<double,3> >&,
