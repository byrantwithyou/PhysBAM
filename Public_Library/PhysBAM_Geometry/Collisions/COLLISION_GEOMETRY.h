...
public:
    typedef TV VECTOR_T;
    enum STATE_INDEX {FLUID_COLLISION_GEOMETRY_NEW_STATE=0,FLUID_COLLISION_GEOMETRY_OLD_STATE,FLUID_COLLISION_GEOMETRY_SAVED_OLD_STATE,FLUID_COLLISION_GEOMETRY_SAVED_NEW_STATE};
