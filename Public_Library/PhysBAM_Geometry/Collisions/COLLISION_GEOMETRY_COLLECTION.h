...
public:
    COLLISION_GEOMETRY_SPATIAL_PARTITION<TV,const ARRAY<COLLISION_GEOMETRY<TV>*,COLLISION_GEOMETRY_ID>,COLLISION_GEOMETRY_ID>* spatial_partition;
private:
...
public:
    ...
    void Set_Collision_Body_Thickness(T collision_body_thickness_input)
    {
        ...
        for(COLLISION_GEOMETRY_ID id(0);id<bodies.Size();++id) bodies(id)->collision_thickness=collision_body_thickness;
    }
