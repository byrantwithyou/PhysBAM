...
//#####################################################################
template IMPLICIT_OBJECT_TRANSFORMED<VECTOR<float,1>,RIGID_BODY<VECTOR<float,1> > >::IMPLICIT_OBJECT_TRANSFORMED(IMPLICIT_OBJECT<VECTOR<float,1> >*,bool,RIGID_BODY<VECTOR<float,1> > const*);
template IMPLICIT_OBJECT_TRANSFORMED<VECTOR<float,2>,RIGID_BODY<VECTOR<float,2> > >::IMPLICIT_OBJECT_TRANSFORMED(IMPLICIT_OBJECT<VECTOR<float,2> >*,bool,RIGID_BODY<VECTOR<float,2> > const*);
template IMPLICIT_OBJECT_TRANSFORMED<VECTOR<float,3>,RIGID_BODY<VECTOR<float,3> > >::IMPLICIT_OBJECT_TRANSFORMED(IMPLICIT_OBJECT<VECTOR<float,3> >*,bool,RIGID_BODY<VECTOR<float,3> > const*);
...
template IMPLICIT_OBJECT_TRANSFORMED<VECTOR<double,1>,RIGID_BODY<VECTOR<double,1> > >::IMPLICIT_OBJECT_TRANSFORMED(IMPLICIT_OBJECT<VECTOR<double,1> >*,bool,RIGID_BODY<VECTOR<double,1> > const*);
template IMPLICIT_OBJECT_TRANSFORMED<VECTOR<double,2>,RIGID_BODY<VECTOR<double,2> > >::IMPLICIT_OBJECT_TRANSFORMED(IMPLICIT_OBJECT<VECTOR<double,2> >*,bool,RIGID_BODY<VECTOR<double,2> > const*);
template IMPLICIT_OBJECT_TRANSFORMED<VECTOR<double,3>,RIGID_BODY<VECTOR<double,3> > >::IMPLICIT_OBJECT_TRANSFORMED(IMPLICIT_OBJECT<VECTOR<double,3> >*,bool,RIGID_BODY<VECTOR<double,3> > const*);
