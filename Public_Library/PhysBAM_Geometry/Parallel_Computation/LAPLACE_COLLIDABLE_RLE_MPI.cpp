...
//#####################################################################
template<class T_GRID> void LAPLACE_COLLIDABLE_RLE_MPI<T_GRID>::
...
//#####################################################################
template<class T_GRID> template<class T_FACE> void LAPLACE_COLLIDABLE_RLE_MPI<T_GRID>::
...
//#####################################################################
template<class T_GRID> void LAPLACE_COLLIDABLE_RLE_MPI<T_GRID>::Find_Matrix_Indices(ARRAY<int,VECTOR<int,1> >&,ARRAY<int>&,ARRAY<ARRAY<int> >&,const VECTOR<T,2>&){PHYSBAM_FUNCTION_IS_NOT_DEFINED();}
template<class T_GRID> void LAPLACE_COLLIDABLE_RLE_MPI<T_GRID>::Find_Matrix_Indices(ARRAY<int,VECTOR<int,1> >&,ARRAY<int>&,ARRAY<ARRAY<int> >&,const VECTOR<T,3>&){PHYSBAM_FUNCTION_IS_NOT_DEFINED();}
//#####################################################################
#endif

//#####################################################################
template LAPLACE_COLLIDABLE_RLE_MPI<RLE_GRID_2D<float> >::LAPLACE_COLLIDABLE_RLE_MPI(LAPLACE_COLLIDABLE_RLE<RLE_GRID_2D<float> >&);
template LAPLACE_COLLIDABLE_RLE_MPI<RLE_GRID_3D<float> >::LAPLACE_COLLIDABLE_RLE_MPI(LAPLACE_COLLIDABLE_RLE<RLE_GRID_3D<float> >&);
#ifndef COMPILE_WITHOUT_DOUBLE_SUPPORT
template LAPLACE_COLLIDABLE_RLE_MPI<RLE_GRID_2D<double> >::LAPLACE_COLLIDABLE_RLE_MPI(LAPLACE_COLLIDABLE_RLE<RLE_GRID_2D<double> >&);
template LAPLACE_COLLIDABLE_RLE_MPI<RLE_GRID_3D<double> >::LAPLACE_COLLIDABLE_RLE_MPI(LAPLACE_COLLIDABLE_RLE<RLE_GRID_3D<double> >&);
#endif
#endif
