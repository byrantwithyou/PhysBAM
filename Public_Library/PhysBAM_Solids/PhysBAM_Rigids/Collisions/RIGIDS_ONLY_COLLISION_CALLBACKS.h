...
//#####################################################################
// Class RIGIDS_ONLY_COLLISION_CALLBACKS
//##################################################################### 
#ifndef __RIGIDS_ONLY_COLLISION_CALLBACKS__
#define __RIGIDS_ONLY_COLLISION_CALLBACKS__
...
template<class TV>
class RIGIDS_ONLY_COLLISION_CALLBACKS:public RIGIDS_COLLISION_CALLBACKS<TV>
{
    typedef typename TV::SCALAR T;
    typedef typename TV::SPIN T_SPIN;
public:
    RIGIDS_EVOLUTION<TV>& evolution;
    ...
    virtual ~RIGIDS_ONLY_COLLISION_CALLBACKS();
