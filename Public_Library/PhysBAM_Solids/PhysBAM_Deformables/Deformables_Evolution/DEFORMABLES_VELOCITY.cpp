...
DEFORMABLES_VELOCITY(ARRAY_VIEW<TV> V_full,DEFORMABLE_BODY_COLLECTION<TV>& deformable_body_collection)
    :V(V_full,deformable_body_collection.dynamic_particles),rigid_V(ARRAY_VIEW<TWIST<TV> >(0,0),ARRAY<int>())
{}
//#####################################################################
// Constructor
//#####################################################################
...
DEFORMABLES_VELOCITY(ARRAY_VIEW<TV> V_full,ARRAY<int>& dynamic_particles,ARRAY_VIEW<TWIST<TV> > rigid_V_full)
    :V(V_full,dynamic_particles),rigid_V(rigid_V_full,ARRAY<int>(IDENTITY_ARRAY<int>(rigid_V_full.Size())))
{}
//#####################################################################
// Operator +=
//#####################################################################
