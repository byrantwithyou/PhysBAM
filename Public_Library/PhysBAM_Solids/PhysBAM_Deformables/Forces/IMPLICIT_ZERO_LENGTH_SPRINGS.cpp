...
template IMPLICIT_ZERO_LENGTH_SPRINGS<VECTOR<float,3> >* Create_Edge_Zero_Length_Springs<float,VECTOR<float,3> >(PARTICLES<VECTOR<float,3> >&,SEGMENT_MESH&,float,float,bool);
...
template IMPLICIT_ZERO_LENGTH_SPRINGS<VECTOR<double,3> >* Create_Edge_Zero_Length_Springs<double,VECTOR<double,3> >(PARTICLES<VECTOR<double,3> >&,SEGMENT_MESH&,double,double,bool);
#endif
