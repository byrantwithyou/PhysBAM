...
#include <PhysBAM_Solids/PhysBAM_Deformables/Forces/FLUIDS_COLOR_FORCE.h>
#include <PhysBAM_Solids/PhysBAM_Deformables/Particles/DEFORMABLE_PARTICLES.h>
using namespace PhysBAM;
//#####################################################################
// Constructor
//#####################################################################
template<class TV> FLUIDS_COLOR_FORCE<TV>::
FLUIDS_COLOR_FORCE(SEGMENTED_CURVE_2D<T>& surface_input,T surface_tension_coefficient_input)
...
//#####################################################################
template<class TV> void FLUIDS_COLOR_FORCE<TV>::
...
//#####################################################################
template<class TV> int FLUIDS_COLOR_FORCE<TV>::
...
//#####################################################################
template<class TV> typename TV::SCALAR FLUIDS_COLOR_FORCE<TV>::
...
template class FLUIDS_COLOR_FORCE<VECTOR<float,2> >;
#ifndef COMPILE_WITHOUT_DOUBLE_SUPPORT
template class FLUIDS_COLOR_FORCE<VECTOR<double,2> >;
#endif
