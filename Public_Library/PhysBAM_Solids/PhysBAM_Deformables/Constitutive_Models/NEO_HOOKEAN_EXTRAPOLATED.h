...
public:
    ...
    T Energy_Density(const DIAGONAL_MATRIX<T,2>& F,const int simplex) const PHYSBAM_OVERRIDE;
    DIAGONAL_MATRIX<T,d> P_From_Strain(const DIAGONAL_MATRIX<T,2>& F,const T scale,const int simplex) const PHYSBAM_OVERRIDE;
