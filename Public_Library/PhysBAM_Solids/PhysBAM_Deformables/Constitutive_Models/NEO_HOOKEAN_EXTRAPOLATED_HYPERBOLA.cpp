...
Isotropic_Stress_Derivative_Helper(const DIAGONAL_MATRIX<T,3>& F,DIAGONALIZED_ISOTROPIC_STRESS_DERIVATIVE<T,3>& dP_dF,const int triangle) const
{
    ...
    T den = (3.0*a*a+2.0*a*(s1+s2+s3)+(s1*s2+s1*s3+s2*s3));if(fabs(den)<panic_threshold) den=den<0?-panic_threshold:panic_threshold;
    ...
    t533 = s3*s3;
    t534 = t520*t521;
    t535 = a*s1*t519*t521*2.0;
    t536 = t519*t523;
    t537 = t533*t533;
    t538 = mu*t520*t521;
    t539 = a*mu*s1*t519*t521*2.0;
    t540 = mu*t519*t523;
    t541 = la*t519*t521*t532;
    t542 = a*a1*k*s1*t523*2.0;
    t543 = a*a1*k*s1*t519*t521*2.0;
    t544 = a1*k*t519*t523*4.0;
    t545 = a*la*s1*t521*t532*2.0;
    t546 = a*a1*la*s1*t519*t532;
    t547 = a*a1*la*s1*t521*t532*2.0;
    t548 = a1*la*t519*t521*t532*2.0;
    t549 = t363*t363;
    t550 = a1*s1;
    t583 = la*t532;
    t551 = la+mu-t583;
    ...
    t553 = a1*t519*2.0;
    t554 = a*a1*s1*4.0;
    t555 = a*mu*s2*t521*2.0;
    t556 = a*mu*s3*t521*2.0;
    t557 = la*t518*t521;
    t558 = la*t521*t533;
    t559 = mu*t518*t521;
    t560 = mu*t521*t533;
    t561 = a*la*s2*t521*2.0;
    t562 = a*la*s3*t521*2.0;
    t563 = a*a2*la*s2*t518;
    t564 = a*a2*la*s2*t521*4.0;
    t565 = a*a3*la*s3*t533;
    t566 = a*a3*la*s3*t521*4.0;
    t567 = a*a2*mu*s2*t518;
    t568 = a*a2*mu*s2*t521*2.0;
    t569 = a*a2*mu*s2*t523*3.0;
    t570 = a*a3*mu*s3*t533;
    t571 = a*a3*mu*s3*t521*2.0;
    t572 = a*a3*mu*s3*t523*3.0;
    t573 = a2*la*t518*t521*4.0;
    t574 = a3*la*t521*t533*4.0;
    t575 = a2*mu*t518*t521*2.0;
    t576 = a*a2*mu*s2*t518*t521*3.0;
    t577 = a2*mu*t518*t523*6.0;
    t578 = a3*mu*t521*t533*2.0;
    t579 = a*a3*mu*s3*t521*t533*3.0;
    t580 = a3*mu*t523*t533*6.0;
    t581 = t365*t365;
    t582 = t366*t366;
    t584 = a*mu*s2*t519*t521*2.0;
    t585 = a*mu*s1*t519*t533*2.0;
    t586 = mu*s1*s3*t519*t521*4.0;
    t587 = a*mu*s2*t521*t533*2.0;
    t588 = a*mu*s1*t523*2.0;
    t589 = a*la*s1*t519*t521*2.0;
    t590 = la*t519*t523*5.0;
    t591 = mu*t519*t523*4.0;
    t592 = a*mu*s3*t521*t533*2.0;
    t593 = a*la*s1*t523*3.0;
    t594 = a*mu*s1*t518*t519*2.0;
    t595 = mu*s1*s2*t519*t521*4.0;
    t596 = a*mu*s1*t521*t533*2.0;
    t597 = a*mu*s3*t519*t521*2.0;
    t598 = a*mu*s3*t518*t533*2.0;
    t599 = mu*s2*s3*t521*t533*4.0;
    t600 = a*la*s1*t368*t518*t521*2.0;
    t601 = la*s2*s3*t519*t521*4.0;
    t602 = mu*s2*s3*t519*t521*4.0;
    t603 = a1*k*t518*t523*t533*4.0;
    t604 = la*t368*t518*t521*t533*4.0;
    t605 = a1*k*s2*s3*t521*t523*4.0;
    t606 = la*s2*s3*t368*t523*4.0;
    t607 = a*la*s1*s2*s3*t519;
    t608 = a*mu*s1*s2*s3*t519*2.0;
    t609 = a*a1*k*s1*t518*t521*t533*8.0;
    t610 = a1*la*s2*s3*t368*t523*4.0;
    t611 = a*a1*k*s1*s2*s3*t523*8.0;
    t612 = a1*k*t518*t519*t521*t533*4.0;
    t613 = a1*k*s2*s3*t519*t523*4.0;
    t614 = a*la*s1*t368*t518*t533*2.0;
    t615 = a1*la*t368*t518*t521*t533*2.0;
    t616 = a1*la*s2*s3*t368*t519*t521*2.0;
    t617 = a*a1*la*s1*s2*s3*t368*t521*4.0;
    t618 = la*t518*t519*t521*3.0;
    t619 = la*t519*t521*t533*3.0;
    t620 = mu*t518*t519*t521*4.0;
    t621 = mu*t519*t521*t533*4.0;
    t622 = a*la*s2*t368*t523*2.0;
    t623 = a*la*s3*t368*t523*2.0;
    t624 = la*s1*s2*t523*5.0;
    t625 = la*s1*s3*t523*5.0;
    t626 = mu*s1*s2*t523*4.0;
    t627 = mu*s1*s3*t523*4.0;
    t628 = a*la*s2*t368*t518*t521*2.0;
    t629 = la*t368*t518*t523*4.0;
    t630 = a*la*s3*t368*t521*t533*2.0;
    t631 = la*t368*t523*t533*4.0;
    t632 = a*la*s2*t368*t521*t533*2.0;
    t633 = a*la*s3*t368*t518*t521*2.0;
    t634 = a*la*s2*t519*t533;
    t635 = a*la*s3*t518*t519;
    t636 = a*mu*s2*t519*t533*2.0;
    t637 = a*mu*s3*t518*t519*2.0;
    t638 = a2*la*t519*t521*t533*4.0;
    t639 = a3*la*t518*t519*t521*4.0;
    t640 = a2*mu*t519*t521*t533*2.0;
    t641 = a3*mu*t518*t519*t521*2.0;
    t642 = a2*mu*t519*t523*t533*6.0;
    t643 = a3*mu*t518*t519*t523*6.0;
    t644 = a2*la*s1*s3*t523*1.2E1;
    t645 = a3*la*s1*s2*t523*1.2E1;
    t646 = a2*mu*s1*s3*t523*4.0;
    t647 = a3*mu*s1*s2*t523*4.0;
    t648 = a2*mu*s1*s3*t521*t523*6.0;
    t649 = a3*mu*s1*s2*t521*t523*6.0;
    t650 = a*a2*mu*s2*t519*t521*t533*1.2E1;
    t651 = a*a3*mu*s3*t518*t519*t521*1.2E1;
    t652 = a*a2*la*s1*s2*s3*t521*1.4E1;
    t653 = a*a3*la*s1*s2*s3*t521*1.4E1;
    t654 = a*a2*mu*s1*s2*s3*t521*4.0;
    t655 = a*a2*mu*s1*s2*s3*t523*1.2E1;
    t656 = a*a3*mu*s1*s2*s3*t521*4.0;
    t657 = a*a3*mu*s1*s2*s3*t523*1.2E1;
    t658 = a*la*s1*s2*s3*t368*t533*2.0;
    t659 = a*la*s1*s2*s3*t368*t518*2.0;
    t660 = a2*mu*t518*t519*t521*t533*6.0;
    t661 = a3*mu*t518*t519*t521*t533*6.0;
    t662 = a*a2*la*s2*t519*t533*2.0;
    t663 = a2*la*s1*s3*t518*t521*4.0;
    t664 = a*a3*la*s3*t518*t519*2.0;
    t665 = a3*la*s1*s2*t521*t533*4.0;
    t666 = a2*mu*s1*s3*t518*t521*2.0;
    t667 = a2*mu*s1*s3*t518*t523*6.0;
    t668 = a3*mu*s1*s2*t521*t533*2.0;
    t669 = a3*mu*s1*s2*t523*t533*6.0;
    t670 = la*s1*s2*t368*t521*t533*4.0;
    t671 = la*s1*s3*t368*t518*t521*4.0;
    dP_dF.x1111 = a*(t395-a11*mu-a11*mu*t374+mu*t373*t375*2.0+a11*la*t368*t374-la*t368*t373*t375*2.0-la*t369*t371*t374*t394+la*t362*t364*t371*t374*t385+a1*la*t369*t371*t375*t385*3.0)+a*(t395-a11*mu-a11*mu*t386+mu*t373*t387*2.0+a11*la*t368*t386-la*t368*t373*t387*2.0-la*t369*t370*t386*t394+la*t362*t364*t370*t385*t386+a1*la*t369*t370*t385*t387*3.0)-a1*t446*2.0-a1*t463*2.0-a1*t466*2.0-a11*t402-a11*t405-a11*t408+k*t373*2.0+mu*(t373*4.0+t397*2.0+a11*t377+a11*t379+a11*t381)*(1.0/2.0)+a*a11*k*2.0-a*a11*mu-a*a11*mu*t364+a*mu*t397*t398*2.0+a*a11*la*t364*t368-a*la*t368*t397*t398*2.0-mu*t369*t370*t371*t394+la*t364*t374*(t385*t385)*t386+la*t368*t369*t370*t371*t394+mu*t362*t364*t370*t371*t385-a*la*t364*t370*t371*t394+a1*mu*t369*t371*t374*t385+a1*mu*t369*t370*t385*t386+a*a1*la*t364*t371*t374*t385+a*a1*la*t364*t370*t385*t386+a*la*t362*t370*t371*t385*t398*3.0-a1*la*t368*t369*t371*t374*t385-a1*la*t368*t369*t370*t385*t386-la*t362*t364*t368*t370*t371*t385;
    dP_dF.x2222 = a*(t421-a22*mu-a22*mu*t364+mu*t398*t409*2.0+a22*la*t364*t368-la*t368*t398*t409*2.0-la*t364*t370*t371*t420+la*t364*t371*t374*t399*t413+a2*la*t370*t371*t398*t413*3.0)+a*(t421-a22*mu-a22*mu*t386+mu*t387*t409*2.0+a22*la*t368*t386-la*t368*t387*t409*2.0-la*t369*t370*t386*t420+la*t369*t374*t386*t399*t413+a2*la*t369*t370*t387*t413*3.0)-a2*t450*2.0-a2*t469*2.0-a2*t472*2.0-a22*t402-a22*t405-a22*t408+k*t409*2.0+mu*(t409*4.0+t423*2.0+a22*t377+a22*t379+a22*t381)*(1.0/2.0)+a*a22*k*2.0-a*a22*mu-a*a22*mu*t374+a*mu*t375*t423*2.0+a*a22*la*t368*t374-a*la*t368*t375*t423*2.0-mu*t369*t370*t371*t420+la*t364*t374*t386*(t413*t413)+la*t368*t369*t370*t371*t420+mu*t369*t371*t374*t399*t413-a*la*t369*t371*t374*t420+a2*mu*t364*t370*t371*t413+a2*mu*t369*t370*t386*t413+a*a2*la*t364*t371*t374*t413+a*a2*la*t369*t374*t386*t413+a*la*t369*t371*t375*t399*t413*3.0-a2*la*t364*t368*t370*t371*t413-a2*la*t368*t369*t370*t386*t413-la*t368*t369*t371*t374*t399*t413;
    dP_dF.x3333 = a*(t440-a33*mu-a33*mu*t374+mu*t375*t428*2.0+a33*la*t368*t374-la*t368*t375*t428*2.0-la*t369*t371*t374*t439+la*t369*t374*t386*t424*t432+a3*la*t369*t371*t375*t432*3.0)+a*(t440-a33*mu-a33*mu*t364+mu*t398*t428*2.0+a33*la*t364*t368-la*t368*t398*t428*2.0-la*t364*t370*t371*t439+la*t364*t370*t386*t424*t432+a3*la*t370*t371*t398*t432*3.0)-a3*t477*2.0-a3*t494*2.0-a3*t497*2.0-a33*t402-a33*t405-a33*t408+k*t428*2.0+mu*(t428*4.0+t442*2.0+a33*t377+a33*t379+a33*t381)*(1.0/2.0)+a*a33*k*2.0-a*a33*mu-a*a33*mu*t386+a*mu*t387*t442*2.0+a*a33*la*t368*t386-a*la*t368*t387*t442*2.0-mu*t369*t370*t371*t439+la*t364*t374*t386*(t432*t432)+la*t368*t369*t370*t371*t439+mu*t369*t370*t386*t424*t432-a*la*t369*t370*t386*t439+a3*mu*t364*t370*t371*t432+a3*mu*t369*t371*t374*t432+a*a3*la*t364*t370*t386*t432+a*a3*la*t369*t374*t386*t432+a*la*t369*t370*t387*t424*t432*3.0-a3*la*t364*t368*t370*t371*t432-a3*la*t368*t369*t371*t374*t432-la*t368*t369*t370*t386*t424*t432;
    dP_dF.x2211 = a*(-a12*mu-a12*mu*t386+a1*a2*mu*t387*2.0+a12*la*t368*t386-a1*a2*la*t368*t387*2.0-la*t369*t370*t386*t460+la*t369*t374*t385*t386*t399+a1*la*t369*t370*t387*t413+a2*la*t364*t370*t385*t386+a2*la*t369*t370*t385*t387*2.0)-a1*t450-a1*t469-a1*t472-a12*t402-a12*t405-a12*t408-a2*t446-a2*t463-a2*t466+a*(-a12*mu-a12*mu*t374+a12*la*t368*t374+a1*mu*t375*t399*2.0-a1*la*t368*t375*t399*2.0-la*t369*t371*t374*t460+la*t369*t371*t375*t385*t399*2.0+a1*la*t369*t371*t375*t413+a2*la*t364*t371*t374*t385+a2*la*t369*t374*t385*t386)+mu*(a1*a2*2.0+a12*t377+a12*t379+a12*t381+a1*t503+a2*t479)*(1.0/2.0)+a*a12*k*2.0+a1*a2*k*2.0-a*a12*mu-a*a12*mu*t364+a*a12*la*t364*t368+a*a2*mu*t362*t398*2.0-mu*t369*t370*t371*t460+la*t364*t374*t385*t386*t413+la*t368*t369*t370*t371*t460+mu*t369*t371*t374*t385*t399-a*a2*la*t362*t368*t398*2.0-a*la*t364*t370*t371*t460+a2*mu*t364*t370*t371*t385+a2*mu*t369*t370*t385*t386+a*a2*la*t364*t370*t385*t386+a*a2*la*t370*t371*t385*t398*2.0+a*la*t364*t371*t374*t385*t399+a*la*t362*t370*t371*t398*t413-a2*la*t364*t368*t370*t371*t385-a2*la*t368*t369*t370*t385*t386-la*t368*t369*t371*t374*t385*t399;
    dP_dF.x3311 = a*(-a13*mu-a13*mu*t374+a1*a3*mu*t375*2.0+a13*la*t368*t374-a1*a3*la*t368*t375*2.0-la*t369*t371*t374*t489+la*t369*t374*t385*t386*t424+a1*la*t369*t371*t375*t432+a3*la*t364*t371*t374*t385+a3*la*t369*t371*t375*t385*2.0)-a1*t477-a1*t494-a1*t497-a13*t402-a13*t405-a13*t408-a3*t446-a3*t463-a3*t466+a*(-a13*mu-a13*mu*t386+a13*la*t368*t386+a1*mu*t387*t424*2.0-a1*la*t368*t387*t424*2.0-la*t369*t370*t386*t489+la*t369*t370*t385*t387*t424*2.0+a1*la*t369*t370*t387*t432+a3*la*t364*t370*t385*t386+a3*la*t369*t374*t385*t386)+mu*(a1*a3*2.0+a13*t377+a13*t379+a13*t381+a1*t501+a3*t479)*(1.0/2.0)+a*a13*k*2.0+a1*a3*k*2.0-a*a13*mu-a*a13*mu*t364+a*a13*la*t364*t368+a*a3*mu*t362*t398*2.0-mu*t369*t370*t371*t489+la*t364*t374*t385*t386*t432+la*t368*t369*t370*t371*t489+mu*t369*t370*t385*t386*t424-a*a3*la*t362*t368*t398*2.0-a*la*t364*t370*t371*t489+a3*mu*t364*t370*t371*t385+a3*mu*t369*t371*t374*t385+a*a3*la*t364*t371*t374*t385+a*a3*la*t370*t371*t385*t398*2.0+a*la*t364*t370*t385*t386*t424+a*la*t362*t370*t371*t398*t432-a3*la*t364*t368*t370*t371*t385-a3*la*t368*t369*t371*t374*t385-la*t368*t369*t370*t385*t386*t424;
    dP_dF.x3322 = a*(-a23*mu-a23*mu*t364+a2*a3*mu*t398*2.0+a23*la*t364*t368-a2*a3*la*t368*t398*2.0-la*t364*t370*t371*t513+la*t364*t370*t386*t413*t424+a2*la*t370*t371*t398*t432+a3*la*t364*t371*t374*t413+a3*la*t370*t371*t398*t413*2.0)-a2*t477-a2*t494-a2*t497-a23*t402-a23*t405-a23*t408-a3*t450-a3*t469-a3*t472+a*(-a23*mu-a23*mu*t386+a23*la*t368*t386+a2*mu*t387*t424*2.0-a2*la*t368*t387*t424*2.0-la*t369*t370*t386*t513+la*t369*t370*t387*t413*t424*2.0+a2*la*t369*t370*t387*t432+a3*la*t364*t370*t386*t413+a3*la*t369*t374*t386*t413)+mu*(a2*a3*2.0+a23*t377+a23*t379+a23*t381+a2*t501+a3*t503)*(1.0/2.0)+a*a23*k*2.0+a2*a3*k*2.0-a*a23*mu-a*a23*mu*t374+a*a23*la*t368*t374+a*a3*mu*t375*t399*2.0-mu*t369*t370*t371*t513+la*t364*t374*t386*t413*t432+la*t368*t369*t370*t371*t513+mu*t369*t370*t386*t413*t424-a*a3*la*t368*t375*t399*2.0-a*la*t369*t371*t374*t513+a3*mu*t364*t370*t371*t413+a3*mu*t369*t371*t374*t413+a*a3*la*t364*t371*t374*t413+a*a3*la*t369*t371*t375*t413*2.0+a*la*t369*t371*t375*t399*t432+a*la*t369*t374*t386*t413*t424-a3*la*t364*t368*t370*t371*t413-a3*la*t368*t369*t371*t374*t413-la*t368*t369*t370*t386*t413*t424;
    dP_dF.x2121 = (t538+t539+t540+t541+t542+t543+t544+t545+t546+t547+t548+t555+t557+t559+t561+t563+t564+t567+t568+t569+t573+t575+t576+t577+t584+t594+t595-la*t519*t521+mu*t518*t520-mu*t519*t521-mu*t518*t523-mu*t519*t522-mu*t521*t522-a2*k*t518*t523*4.0-a*la*s1*t521*2.0-a*mu*s1*t521*2.0-a*mu*s1*t522*2.0+a*mu*s2*t520*2.0-a1*la*t519*t521*4.0-a1*mu*t519*t521*2.0-a1*mu*t519*t523*6.0-la*t518*t521*t532-a*a2*k*s2*t523*2.0-a*a1*la*s1*t518-a*a1*la*s1*t519-a*a1*la*s1*t521*4.0+a*a2*la*s1*t518*2.0-a*a1*la*s2*t519*2.0+a*a2*la*s2*t519-a*a1*mu*s1*t518-a*a1*mu*s1*t519-a*a1*mu*s1*t521*2.0-a*a1*mu*s1*t523*3.0+a*a2*mu*s2*t519+a1*k*s1*s2*t523*4.0-a2*k*s1*s2*t523*4.0-a1*la*s1*s2*t521*4.0+a2*la*s1*s2*t521*4.0+a1*k*t518*t519*t521*4.0-a2*k*t518*t519*t521*4.0-a*la*s2*t521*t532*2.0-a1*mu*s1*s2*t521*2.0-a1*mu*s1*s2*t523*6.0+a2*mu*s1*s2*t521*2.0+a2*mu*s1*s2*t523*6.0-a*mu*s1*t518*t521*2.0-a*mu*s2*t518*t519*2.0-a*mu*s2*t518*t521*2.0-a2*la*t518*t521*t532*2.0-a1*mu*t518*t519*t521*6.0+a2*mu*t518*t519*t521*6.0-mu*s1*s2*t518*t521*4.0+a*a1*k*s1*t518*t519*2.0+a*a1*k*s1*t518*t521*2.0-a*a2*k*s1*t518*t521*8.0+a*a1*k*s2*t519*t521*8.0-a*a2*k*s2*t518*t519*2.0-a*a2*k*s2*t518*t521*2.0-a*a2*k*s2*t519*t521*2.0+a*a1*la*s1*t518*t532-a*a2*la*s2*t518*t532-a*a2*la*s2*t519*t532-a*a2*la*s2*t521*t532*2.0-a*a1*mu*s1*t518*t519*3.0-a*a1*mu*s1*t518*t521*3.0-a*a1*mu*s1*t519*t521*3.0+a*a2*mu*s1*t518*t521*1.2E1-a*a1*mu*s2*t519*t521*1.2E1+a*a2*mu*s2*t518*t519*3.0+a*a2*mu*s2*t519*t521*3.0+a1*k*s1*s2*t519*t521*4.0-a2*k*s1*s2*t518*t521*4.0+a1*la*s1*s2*t521*t532*2.0-a2*la*s1*s2*t521*t532*2.0-a1*mu*s1*s2*t519*t521*6.0+a2*mu*s1*s2*t518*t521*6.0)/(t534+t535+t536+t518*t520-t518*t523-t519*t522-t521*t522-a*s1*t522*2.0+a*s2*t520*2.0+a*s1*t518*t519*2.0-a*s1*t518*t521*2.0-a*s2*t518*t519*2.0-a*s2*t518*t521*2.0+a*s2*t519*t521*2.0-s1*s2*t518*t521*4.0+s1*s2*t519*t521*4.0)-(t364*t374*(a*la*t363*t365*t371*(t552+t553+t554-a*s2-a2*t518*2.0-a*a2*s2*4.0+a1*s1*s2*2.0-a2*s1*s2*2.0)+a*t386*t549*t551*t581*(t550-a2*s2)))/((s1+s2)*(s1-s2));
    dP_dF.x3131 = (t538+t539+t540+t541+t542+t543+t544+t545+t546+t547+t548+t556+t558+t560+t562+t565+t566+t570+t571+t572+t574+t578+t579+t580+t585+t586+t597-la*t519*t521-mu*t519*t521-mu*t519*t537+mu*t520*t533-mu*t523*t533-mu*t521*t537-a3*k*t523*t533*4.0-a*la*s1*t521*2.0-a*mu*s1*t521*2.0-a*mu*s1*t537*2.0+a*mu*s3*t520*2.0-a1*la*t519*t521*4.0-a1*mu*t519*t521*2.0-a1*mu*t519*t523*6.0-la*t521*t532*t533-a*a3*k*s3*t523*2.0-a*a1*la*s1*t519-a*a1*la*s1*t521*4.0-a*a1*la*s1*t533-a*a1*la*s3*t519*2.0+a*a3*la*s1*t533*2.0+a*a3*la*s3*t519-a*a1*mu*s1*t519-a*a1*mu*s1*t521*2.0-a*a1*mu*s1*t523*3.0-a*a1*mu*s1*t533+a*a3*mu*s3*t519+a1*k*s1*s3*t523*4.0-a3*k*s1*s3*t523*4.0-a1*la*s1*s3*t521*4.0+a3*la*s1*s3*t521*4.0+a1*k*t519*t521*t533*4.0-a3*k*t519*t521*t533*4.0-a*la*s3*t521*t532*2.0-a1*mu*s1*s3*t521*2.0-a1*mu*s1*s3*t523*6.0+a3*mu*s1*s3*t521*2.0+a3*mu*s1*s3*t523*6.0-a*mu*s1*t521*t533*2.0-a*mu*s3*t519*t533*2.0-a*mu*s3*t521*t533*2.0-a3*la*t521*t532*t533*2.0-a1*mu*t519*t521*t533*6.0+a3*mu*t519*t521*t533*6.0-mu*s1*s3*t521*t533*4.0+a*a1*k*s1*t519*t533*2.0+a*a1*k*s1*t521*t533*2.0+a*a1*k*s3*t519*t521*8.0-a*a3*k*s1*t521*t533*8.0-a*a3*k*s3*t519*t521*2.0-a*a3*k*s3*t519*t533*2.0-a*a3*k*s3*t521*t533*2.0+a*a1*la*s1*t532*t533-a*a3*la*s3*t519*t532-a*a3*la*s3*t521*t532*2.0-a*a3*la*s3*t532*t533-a*a1*mu*s1*t519*t521*3.0-a*a1*mu*s1*t519*t533*3.0-a*a1*mu*s1*t521*t533*3.0-a*a1*mu*s3*t519*t521*1.2E1+a*a3*mu*s1*t521*t533*1.2E1+a*a3*mu*s3*t519*t521*3.0+a*a3*mu*s3*t519*t533*3.0+a1*k*s1*s3*t519*t521*4.0-a3*k*s1*s3*t521*t533*4.0+a1*la*s1*s3*t521*t532*2.0-a3*la*s1*s3*t521*t532*2.0-a1*mu*s1*s3*t519*t521*6.0+a3*mu*s1*s3*t521*t533*6.0)/(t534+t535+t536-t519*t537+t520*t533-t523*t533-t521*t537-a*s1*t537*2.0+a*s3*t520*2.0+a*s1*t519*t533*2.0-a*s1*t521*t533*2.0+a*s3*t519*t521*2.0-a*s3*t519*t533*2.0-a*s3*t521*t533*2.0+s1*s3*t519*t521*4.0-s1*s3*t521*t533*4.0)-(t364*t386*(a*la*t363*t366*t370*(t552+t553+t554-a*s3-a3*t533*2.0-a*a3*s3*4.0+a1*s1*s3*2.0-a3*s1*s3*2.0)+a*t374*t549*t551*t582*(t550-a3*s3)))/((s1+s3)*(s1-s3));
    dP_dF.x3232 = -(t555-t556+t557-t558+t559-t560+t561-t562+t563+t564-t565-t566+t567+t568+t569-t570-t571-t572+t573-t574+t575+t576+t577-t578-t579-t580+t587+t592+t598+t599-mu*t518*t523-mu*t521*t522+mu*t518*t537-mu*t522*t533+mu*t523*t533+mu*t521*t537-a2*k*t518*t523*4.0+a3*k*t523*t533*4.0+a*mu*s2*t537*2.0-a*mu*s3*t522*2.0-la*t518*t521*t532+la*t521*t532*t533-a*a2*k*s2*t523*2.0+a*a3*k*s3*t523*2.0+a*a2*la*s2*t533+a*a2*la*s3*t518*2.0-a*a3*la*s2*t533*2.0-a*a3*la*s3*t518+a*a2*mu*s2*t533-a*a3*mu*s3*t518-a2*k*s2*s3*t523*4.0+a3*k*s2*s3*t523*4.0+a2*la*s2*s3*t521*4.0-a3*la*s2*s3*t521*4.0-a2*k*t518*t521*t533*4.0+a3*k*t518*t521*t533*4.0-a*la*s2*t521*t532*2.0+a*la*s3*t521*t532*2.0+a2*mu*s2*s3*t521*2.0+a2*mu*s2*s3*t523*6.0-a3*mu*s2*s3*t521*2.0-a3*mu*s2*s3*t523*6.0-a*mu*s2*t518*t521*2.0-a*mu*s2*t518*t533*2.0-a*mu*s3*t518*t521*2.0-a2*la*t518*t521*t532*2.0+a3*la*t521*t532*t533*2.0+a2*mu*t518*t521*t533*6.0-a3*mu*t518*t521*t533*6.0-mu*s2*s3*t518*t521*4.0-a*a2*k*s2*t518*t521*2.0-a*a2*k*s2*t518*t533*2.0-a*a2*k*s2*t521*t533*2.0-a*a2*k*s3*t518*t521*8.0+a*a3*k*s2*t521*t533*8.0+a*a3*k*s3*t518*t521*2.0+a*a3*k*s3*t518*t533*2.0+a*a3*k*s3*t521*t533*2.0-a*a2*la*s2*t518*t532-a*a2*la*s2*t521*t532*2.0-a*a2*la*s2*t532*t533+a*a3*la*s3*t518*t532+a*a3*la*s3*t521*t532*2.0+a*a3*la*s3*t532*t533+a*a2*mu*s2*t518*t533*3.0+a*a2*mu*s2*t521*t533*3.0+a*a2*mu*s3*t518*t521*1.2E1-a*a3*mu*s2*t521*t533*1.2E1-a*a3*mu*s3*t518*t521*3.0-a*a3*mu*s3*t518*t533*3.0-a2*k*s2*s3*t518*t521*4.0+a3*k*s2*s3*t521*t533*4.0-a2*la*s2*s3*t521*t532*2.0+a3*la*s2*s3*t521*t532*2.0+a2*mu*s2*s3*t518*t521*6.0-a3*mu*s2*s3*t521*t533*6.0)/(t518*t523+t521*t522-t518*t537+t522*t533-t523*t533-t521*t537-a*s2*t537*2.0+a*s3*t522*2.0+a*s2*t518*t521*2.0+a*s2*t518*t533*2.0-a*s2*t521*t533*2.0+a*s3*t518*t521*2.0-a*s3*t518*t533*2.0-a*s3*t521*t533*2.0+s2*s3*t518*t521*4.0-s2*s3*t521*t533*4.0)-(t374*t386*(a*la*t365*t366*t369*(a*s2-a*s3+a2*t518*2.0-a3*t533*2.0+a*a2*s2*4.0-a*a3*s3*4.0+a2*s2*s3*2.0-a3*s2*s3*2.0)+a*t364*t551*t581*t582*(a2*s2-a3*s3)))/((s2+s3)*(s2-s3));
    dP_dF.x2112 = -(t364*t374*t386*(t539+t584+t585+t586--la*t518*t523*5.0-mu*t518*t523*4.0-a*la*s2*t523*3.0-a*mu*s2*t523*2.0-a1*la*t518*t523*1.2E1+a2*la*t519*t523*1.2E1-a1*mu*t518*t523*4.0+a2*mu*t519*t523*4.0-la*s2*s3*t523*5.0-mu*s2*s3*t523*4.0-la*t368*t519*t523*4.0-la*t518*t521*t533*3.0-mu*t518*t521*t533*4.0-a*a1*la*s2*t523*9.0+a*a2*la*s1*t523*9.0-a*a1*mu*s2*t523*3.0+a*a2*mu*s1*t523*3.0-a1*la*s1*s2*t523*1.2E1+a2*la*s1*s2*t523*1.2E1-a1*la*s2*s3*t523*1.2E1+a1*k*t518*t519*t523*4.0+a1*k*t518*t521*t523*4.0-a2*k*t518*t519*t523*4.0-a2*k*t519*t521*t523*4.0-a2*k*t519*t523*t533*4.0-a*la*s1*t368*t523*2.0-a*la*s1*t518*t521*3.0-a*la*s1*t518*t533+a*la*s1*t519*t533+a*la*s1*t521*t533*2.0-a*la*s2*t518*t521*2.0+a*la*s2*t519*t521*3.0-a*la*s2*t518*t533-a*la*s2*t521*t533*2.0-a*la*s3*t518*t521*8.0+a*la*s3*t519*t521*8.0-a1*mu*s1*s2*t523*4.0+a2*mu*s1*s2*t523*4.0-a1*mu*s2*s3*t523*4.0-a*mu*s1*t518*t521*2.0-a*mu*s1*t518*t533*2.0-a*mu*s2*t518*t521*2.0-a*mu*s2*t518*t533*2.0-a*mu*s3*t518*t521*8.0+a*mu*s3*t519*t521*8.0+a1*la*t368*t518*t523*4.0-a2*la*t368*t519*t523*4.0-a1*la*t518*t519*t521*4.0-a1*la*t518*t521*t533*4.0+a2*la*t518*t519*t521*4.0-a1*mu*t518*t519*t521*2.0-a1*mu*t518*t519*t523*6.0-a1*mu*t518*t521*t523*6.0-a1*mu*t518*t521*t533*2.0-a1*mu*t518*t523*t533*6.0+a2*mu*t518*t519*t521*2.0+a2*mu*t518*t519*t523*6.0+a2*mu*t519*t521*t523*6.0-la*s1*s3*t368*t523*4.0-la*s1*s2*t518*t521+la*s1*s2*t519*t521-la*s1*s3*t518*t521*4.0+la*s1*s3*t519*t521*3.0-la*s2*s3*t518*t521*3.0-mu*s1*s2*t518*t521+mu*s1*s2*t519*t521-mu*s1*s2*t518*t533+mu*s1*s2*t519*t533-mu*s1*s3*t518*t521*4.0-mu*s2*s3*t518*t521*4.0-la*t368*t519*t521*t533*4.0+la*s1*s2*t368*t518*t521-la*s1*s2*t368*t519*t521+la*s1*s2*t368*t518*t533-la*s1*s2*t368*t519*t533-la*s1*s3*t368*t519*t521*4.0+la*s2*s3*t368*t518*t521*4.0-la*s2*s3*t368*t519*t521*4.0+a*a1*k*s1*t518*t523*8.0+a*a1*k*s2*t518*t523*2.0-a*a2*k*s1*t518*t523*2.0+a*a1*k*s2*t519*t523*2.0-a*a2*k*s1*t519*t523*2.0+a*a1*k*s2*t521*t523*2.0-a*a2*k*s1*t521*t523*2.0+a*a1*k*s2*t523*t533*2.0-a*a2*k*s1*t523*t533*2.0+a*a1*k*s3*t518*t523*8.0-a*a2*k*s2*t519*t523*8.0-a*a2*k*s3*t519*t523*8.0+a*a1*la*s2*t368*t523*3.0-a*a2*la*s1*t368*t523*3.0-a*a1*la*s1*t518*t521*1.4E1-a*a1*la*s1*t518*t533*2.0-a*a1*la*s2*t518*t519+a*a2*la*s1*t518*t519-a*a1*la*s2*t518*t521*4.0+a*a2*la*s1*t518*t521*4.0-a*a1*la*s2*t519*t521*4.0+a*a2*la*s1*t519*t521*4.0-a*a1*la*s2*t518*t533+a*a2*la*s1*t518*t533-a*a1*la*s2*t519*t533+a*a2*la*s1*t519*t533-a*a1*la*s2*t521*t533*4.0+a*a2*la*s1*t521*t533*4.0-a*a1*la*s3*t518*t519*2.0-a*a1*la*s3*t518*t521*1.4E1+a*a2*la*s2*t519*t521*1.4E1+a*a2*la*s3*t518*t519*2.0+a*a2*la*s3*t519*t521*1.4E1-a*a1*mu*s1*t518*t521*4.0-a*a1*mu*s1*t518*t523*1.2E1-a*a1*mu*s2*t518*t519+a*a2*mu*s1*t518*t519-a*a1*mu*s2*t518*t521*2.0+a*a2*mu*s1*t518*t521*2.0-a*a1*mu*s2*t519*t521*2.0+a*a2*mu*s1*t519*t521*2.0-a*a1*mu*s2*t518*t523*3.0+a*a2*mu*s1*t518*t523*3.0-a*a1*mu*s2*t519*t523*3.0+a*a2*mu*s1*t519*t523*3.0-a*a1*mu*s2*t521*t523*3.0+a*a2*mu*s1*t521*t523*3.0-a*a1*mu*s2*t518*t533+a*a2*mu*s1*t518*t533-a*a1*mu*s2*t519*t533+a*a2*mu*s1*t519*t533-a*a1*mu*s2*t521*t533*2.0+a*a2*mu*s1*t521*t533*2.0-a*a1*mu*s2*t523*t533*3.0+a*a2*mu*s1*t523*t533*3.0-a*a1*mu*s3*t518*t521*4.0+a*a2*mu*s2*t519*t521*4.0-a*a1*mu*s3*t518*t523*1.2E1+a*a2*mu*s2*t519*t523*1.2E1+a*a2*mu*s3*t519*t521*4.0+a*a2*mu*s3*t519*t523*1.2E1+a1*k*s1*s2*t518*t523*4.0+a1*k*s1*s2*t521*t523*4.0+a1*k*s1*s2*t523*t533*4.0+a1*k*s1*s3*t518*t523*1.6E1-a2*k*s1*s2*t519*t523*4.0-a2*k*s1*s2*t521*t523*4.0-a2*k*s1*s2*t523*t533*4.0+a1*k*s2*s3*t518*t523*4.0-a2*k*s1*s3*t518*t523*4.0-a2*k*s1*s3*t519*t523*4.0-a2*k*s1*s3*t521*t523*4.0-a2*k*s2*s3*t519*t523*1.6E1-a*la*s1*s2*s3*t518-a*mu*s1*s2*s3*t518*2.0+a1*la*s1*s2*t368*t523*4.0-a2*la*s1*s2*t368*t523*4.0-a1*la*s1*s2*t518*t521*4.0-a1*la*s1*s2*t521*t533*4.0-a2*la*s1*s3*t368*t523*4.0-a1*la*s1*s3*t518*t521*1.2E1+a2*la*s1*s2*t519*t521*4.0+a2*la*s1*s2*t521*t533*4.0-a1*la*s2*s3*t518*t521*4.0-a1*la*s2*s3*t519*t521*4.0+a2*la*s1*s3*t519*t521*4.0+a2*la*s2*s3*t519*t521*1.2E1-a2*k*t518*t519*t521*t533*4.0-a*la*s1*t368*t519*t521*2.0-a*la*s1*t368*t519*t533*2.0-a*la*s1*t368*t521*t533*2.0-a*la*s2*t368*t519*t521*2.0+a*la*s2*t368*t518*t533*2.0-a*la*s2*t368*t519*t533*2.0+a*la*s3*t368*t518*t521*8.0-a*la*s3*t368*t519*t521*8.0-a1*mu*s1*s2*t518*t521*2.0-a1*mu*s1*s2*t518*t523*6.0-a1*mu*s1*s2*t521*t523*6.0-a1*mu*s1*s2*t521*t533*2.0-a1*mu*s1*s2*t523*t533*6.0+a2*mu*s1*s2*t519*t521*2.0-a1*mu*s1*s3*t518*t523*2.4E1+a2*mu*s1*s2*t519*t523*6.0+a2*mu*s1*s2*t521*t523*6.0+a2*mu*s1*s2*t521*t533*2.0+a2*mu*s1*s2*t523*t533*6.0-a1*mu*s2*s3*t518*t521*2.0-a1*mu*s2*s3*t519*t521*2.0+a2*mu*s1*s3*t519*t521*2.0-a1*mu*s2*s3*t518*t523*6.0-a1*mu*s2*s3*t519*t523*6.0+a2*mu*s1*s3*t519*t523*6.0-a1*mu*s2*s3*t521*t523*6.0+a2*mu*s2*s3*t519*t523*2.4E1+a1*la*t368*t518*t519*t521*2.0-a2*la*t368*t518*t519*t521*2.0-a2*la*t368*t519*t521*t533*2.0-a1*mu*t518*t519*t521*t533*6.0-a*a2*k*s1*s2*s3*t523*8.0-a*a1*la*s1*s2*s3*t518*2.0-a*a1*la*s1*s2*s3*t521*1.4E1+a*a2*la*s1*s2*s3*t519*2.0+a*a1*k*s2*t518*t519*t521*2.0-a*a2*k*s1*t518*t519*t521*2.0+a*a1*k*s2*t518*t519*t533*2.0-a*a2*k*s1*t518*t519*t533*2.0+a*a1*k*s2*t518*t521*t533*2.0-a*a2*k*s1*t518*t521*t533*2.0+a*a1*k*s2*t519*t521*t533*2.0-a*a2*k*s1*t519*t521*t533*2.0+a*a1*k*s3*t518*t519*t521*8.0-a*a2*k*s2*t519*t521*t533*8.0-a*a2*k*s3*t518*t519*t521*8.0-a*a1*mu*s1*s2*s3*t521*4.0-a*a1*mu*s1*s2*s3*t523*1.2E1+a*a1*la*s1*t368*t518*t521*4.0+a*a1*la*s2*t368*t518*t519-a*a2*la*s1*t368*t518*t519+a*a1*la*s2*t368*t518*t521*2.0-a*a2*la*s1*t368*t518*t521*2.0+a*a1*la*s2*t368*t519*t521*2.0-a*a2*la*s1*t368*t519*t521*2.0+a*a1*la*s2*t368*t518*t533-a*a2*la*s1*t368*t518*t533+a*a1*la*s2*t368*t519*t533-a*a2*la*s1*t368*t519*t533+a*a1*la*s2*t368*t521*t533*2.0-a*a2*la*s1*t368*t521*t533*2.0+a*a1*la*s3*t368*t518*t521*4.0-a*a2*la*s2*t368*t519*t521*4.0-a*a2*la*s3*t368*t519*t521*4.0-a*a1*mu*s1*t518*t521*t533*1.2E1-a*a1*mu*s2*t518*t519*t521*3.0+a*a2*mu*s1*t518*t519*t521*3.0-a*a1*mu*s2*t518*t519*t533*3.0+a*a2*mu*s1*t518*t519*t533*3.0-a*a1*mu*s2*t518*t521*t533*3.0+a*a2*mu*s1*t518*t521*t533*3.0-a*a1*mu*s2*t519*t521*t533*3.0+a*a2*mu*s1*t519*t521*t533*3.0-a*a1*mu*s3*t518*t519*t521*1.2E1+a*a2*mu*s3*t518*t519*t521*1.2E1+a1*k*s1*s2*t518*t521*t533*4.0-a2*k*s1*s2*t519*t521*t533*4.0+a1*k*s2*s3*t518*t519*t521*4.0-a2*k*s1*s3*t518*t519*t521*4.0-a*la*s1*s2*s3*t368*t519*2.0+a1*la*s1*s2*t368*t518*t521*2.0+a1*la*s1*s2*t368*t521*t533*2.0-a2*la*s1*s2*t368*t519*t521*2.0-a2*la*s1*s2*t368*t521*t533*2.0+a1*la*s2*s3*t368*t518*t521*2.0-a2*la*s1*s3*t368*t518*t521*2.0-a2*la*s1*s3*t368*t519*t521*2.0-a1*mu*s1*s2*t518*t521*t533*6.0+a2*mu*s1*s2*t519*t521*t533*6.0-a1*mu*s2*s3*t518*t519*t521*6.0+a2*mu*s1*s3*t518*t519*t521*6.0+a*a1*k*s1*s2*s3*t518*t521*8.0-a*a2*k*s1*s2*s3*t519*t521*8.0-a*a2*la*s1*s2*s3*t368*t521*4.0-a*a1*mu*s1*s2*s3*t518*t521*1.2E1+a*a2*mu*s1*s2*s3*t519*t521*1.2E1))/(t518-t519);
    

    dP_dF.x3113 = (t364*t374*t386*(t539+t588+t589+t590+t591-t592+t593+t594+t595-t596+t597-t598-t599-t600+t601+t602+t603+t604+t605+t606+t607+t608+t609+t610+t611+t612+t613+t614+t615+t616+t617+t618+t620+t623+t624+t626+t630+t631+t633+t635+t637+t639+t641+t643+t645+t647+t649+t651+t653+t656+t657+t658+t661+t664+t665+t668+t669+t670-la*t523*t533*5.0-mu*t523*t533*4.0-a*la*s3*t523*3.0-a*mu*s3*t523*2.0-a1*la*t523*t533*1.2E1+a3*la*t519*t523*1.2E1-a1*mu*t523*t533*4.0+a3*mu*t519*t523*4.0-la*s2*s3*t523*5.0-mu*s2*s3*t523*4.0-la*t368*t519*t523*4.0-la*t518*t521*t533*3.0-mu*t518*t521*t533*4.0-a*a1*la*s3*t523*9.0+a*a3*la*s1*t523*9.0-a*a1*mu*s3*t523*3.0+a*a3*mu*s1*t523*3.0-a1*la*s1*s3*t523*1.2E1-a1*la*s2*s3*t523*1.2E1+a3*la*s1*s3*t523*1.2E1+a1*k*t519*t523*t533*4.0+a1*k*t521*t523*t533*4.0-a3*k*t518*t519*t523*4.0-a3*k*t519*t521*t523*4.0-a3*k*t519*t523*t533*4.0-a*la*s1*t368*t523*2.0+a*la*s1*t518*t519+a*la*s1*t518*t521*2.0-a*la*s1*t518*t533-a*la*s1*t521*t533*3.0+a*la*s2*t519*t521*8.0-a*la*s2*t521*t533*8.0-a*la*s3*t518*t521*2.0+a*la*s3*t519*t521*3.0-a*la*s3*t518*t533-a*la*s3*t521*t533*2.0-a1*mu*s1*s3*t523*4.0-a1*mu*s2*s3*t523*4.0+a3*mu*s1*s3*t523*4.0+a*mu*s1*t518*t521*2.0-a*mu*s1*t518*t533*2.0+a*mu*s2*t519*t521*8.0-a*mu*s2*t521*t533*8.0-a*mu*s3*t518*t521*2.0+a1*la*t368*t523*t533*4.0-a1*la*t518*t521*t533*4.0-a1*la*t519*t521*t533*4.0-a3*la*t368*t519*t523*4.0+a3*la*t519*t521*t533*4.0-a1*mu*t518*t521*t533*2.0-a1*mu*t519*t521*t533*2.0-a1*mu*t518*t523*t533*6.0-a1*mu*t519*t523*t533*6.0-a1*mu*t521*t523*t533*6.0+a3*mu*t519*t521*t523*6.0+a3*mu*t519*t521*t533*2.0+a3*mu*t519*t523*t533*6.0-la*s1*s2*t368*t523*4.0+la*s1*s2*t519*t521*3.0-la*s1*s2*t521*t533*4.0+la*s1*s3*t519*t521-la*s1*s3*t521*t533-la*s2*s3*t521*t533*3.0-mu*s1*s2*t521*t533*4.0+mu*s1*s3*t518*t519+mu*s1*s3*t519*t521-mu*s1*s3*t518*t533-mu*s1*s3*t521*t533-la*t368*t518*t519*t521*4.0-la*s1*s2*t368*t519*t521*4.0-la*s1*s3*t368*t518*t519-la*s1*s3*t368*t519*t521+la*s1*s3*t368*t518*t533+la*s1*s3*t368*t521*t533-la*s2*s3*t368*t519*t521*4.0+la*s2*s3*t368*t521*t533*4.0+a*a1*k*s1*t523*t533*8.0+a*a1*k*s2*t523*t533*8.0+a*a1*k*s3*t518*t523*2.0-a*a3*k*s1*t518*t523*2.0+a*a1*k*s3*t519*t523*2.0-a*a3*k*s1*t519*t523*2.0+a*a1*k*s3*t521*t523*2.0-a*a3*k*s1*t521*t523*2.0+a*a1*k*s3*t523*t533*2.0-a*a3*k*s1*t523*t533*2.0-a*a3*k*s2*t519*t523*8.0-a*a3*k*s3*t519*t523*8.0-a*a1*la*s1*t518*t533*2.0-a*a1*la*s1*t521*t533*1.4E1+a*a1*la*s3*t368*t523*3.0-a*a3*la*s1*t368*t523*3.0-a*a1*la*s2*t519*t533*2.0-a*a1*la*s2*t521*t533*1.4E1-a*a1*la*s3*t518*t519+a*a3*la*s1*t518*t519-a*a1*la*s3*t518*t521*4.0+a*a3*la*s1*t518*t521*4.0-a*a1*la*s3*t519*t521*4.0+a*a3*la*s1*t519*t521*4.0-a*a1*la*s3*t518*t533+a*a3*la*s1*t518*t533-a*a1*la*s3*t519*t533+a*a3*la*s1*t519*t533-a*a1*la*s3*t521*t533*4.0+a*a3*la*s1*t521*t533*4.0+a*a3*la*s2*t519*t521*1.4E1+a*a3*la*s2*t519*t533*2.0+a*a3*la*s3*t519*t521*1.4E1-a*a1*mu*s1*t521*t533*4.0-a*a1*mu*s1*t523*t533*1.2E1-a*a1*mu*s2*t521*t533*4.0-a*a1*mu*s2*t523*t533*1.2E1-a*a1*mu*s3*t518*t519+a*a3*mu*s1*t518*t519-a*a1*mu*s3*t518*t521*2.0+a*a3*mu*s1*t518*t521*2.0-a*a1*mu*s3*t519*t521*2.0+a*a3*mu*s1*t519*t521*2.0-a*a1*mu*s3*t518*t523*3.0+a*a3*mu*s1*t518*t523*3.0-a*a1*mu*s3*t519*t523*3.0+a*a3*mu*s1*t519*t523*3.0-a*a1*mu*s3*t521*t523*3.0+a*a3*mu*s1*t521*t523*3.0-a*a1*mu*s3*t518*t533+a*a3*mu*s1*t518*t533-a*a1*mu*s3*t519*t533+a*a3*mu*s1*t519*t533-a*a1*mu*s3*t521*t533*2.0+a*a3*mu*s1*t521*t533*2.0-a*a1*mu*s3*t523*t533*3.0+a*a3*mu*s1*t523*t533*3.0+a*a3*mu*s2*t519*t521*4.0+a*a3*mu*s2*t519*t523*1.2E1+a*a3*mu*s3*t519*t521*4.0+a*a3*mu*s3*t519*t523*1.2E1+a1*k*s1*s2*t523*t533*1.6E1+a1*k*s1*s3*t518*t523*4.0+a1*k*s1*s3*t521*t523*4.0+a1*k*s1*s3*t523*t533*4.0-a3*k*s1*s2*t519*t523*4.0-a3*k*s1*s2*t521*t523*4.0+a1*k*s2*s3*t523*t533*4.0-a3*k*s1*s2*t523*t533*4.0-a3*k*s1*s3*t518*t523*4.0-a3*k*s1*s3*t519*t523*4.0-a3*k*s1*s3*t521*t523*4.0-a3*k*s2*s3*t519*t523*1.6E1-a*la*s1*s2*s3*t533-a*mu*s1*s2*s3*t533*2.0+a1*la*s1*s3*t368*t523*4.0-a1*la*s1*s2*t521*t533*1.2E1-a3*la*s1*s2*t368*t523*4.0-a1*la*s1*s3*t518*t521*4.0-a1*la*s1*s3*t521*t533*4.0-a3*la*s1*s3*t368*t523*4.0-a1*la*s2*s3*t519*t521*4.0+a3*la*s1*s2*t519*t521*4.0-a1*la*s2*s3*t521*t533*4.0+a3*la*s1*s3*t518*t521*4.0+a3*la*s1*s3*t519*t521*4.0+a3*la*s2*s3*t519*t521*1.2E1-a3*k*t518*t519*t521*t533*4.0-a*la*s1*t368*t518*t519*2.0-a*la*s1*t368*t519*t521*2.0+a*la*s1*t368*t521*t533*2.0-a*la*s2*t368*t519*t521*8.0+a*la*s2*t368*t521*t533*8.0-a*la*s3*t368*t518*t519*2.0-a*la*s3*t368*t519*t521*2.0+a*la*s3*t368*t518*t533*2.0-a1*mu*s1*s2*t523*t533*2.4E1-a1*mu*s1*s3*t518*t521*2.0-a1*mu*s1*s3*t518*t523*6.0-a1*mu*s1*s3*t521*t523*6.0-a1*mu*s1*s3*t521*t533*2.0-a1*mu*s1*s3*t523*t533*6.0-a1*mu*s2*s3*t519*t521*2.0+a3*mu*s1*s2*t519*t521*2.0-a1*mu*s2*s3*t519*t523*6.0+a3*mu*s1*s2*t519*t523*6.0-a1*mu*s2*s3*t521*t523*6.0-a1*mu*s2*s3*t521*t533*2.0-a1*mu*s2*s3*t523*t533*6.0+a3*mu*s1*s3*t518*t521*2.0+a3*mu*s1*s3*t519*t521*2.0+a3*mu*s1*s3*t518*t523*6.0+a3*mu*s1*s3*t519*t523*6.0+a3*mu*s1*s3*t521*t523*6.0+a3*mu*s2*s3*t519*t523*2.4E1+a1*la*t368*t519*t521*t533*2.0-a3*la*t368*t518*t519*t521*2.0-a3*la*t368*t519*t521*t533*2.0-a1*mu*t518*t519*t521*t533*6.0-a*a3*k*s1*s2*s3*t523*8.0-a*a1*la*s1*s2*s3*t521*1.4E1-a*a1*la*s1*s2*s3*t533*2.0+a*a3*la*s1*s2*s3*t519*2.0+a*a1*k*s2*t519*t521*t533*8.0+a*a1*k*s3*t518*t519*t521*2.0-a*a3*k*s1*t518*t519*t521*2.0+a*a1*k*s3*t518*t519*t533*2.0-a*a3*k*s1*t518*t519*t533*2.0+a*a1*k*s3*t518*t521*t533*2.0-a*a3*k*s1*t518*t521*t533*2.0+a*a1*k*s3*t519*t521*t533*2.0-a*a3*k*s1*t519*t521*t533*2.0-a*a3*k*s2*t519*t521*t533*8.0-a*a3*k*s3*t518*t519*t521*8.0-a*a1*mu*s1*s2*s3*t521*4.0-a*a1*mu*s1*s2*s3*t523*1.2E1+a*a1*la*s1*t368*t521*t533*4.0+a*a1*la*s2*t368*t521*t533*4.0+a*a1*la*s3*t368*t518*t519-a*a3*la*s1*t368*t518*t519+a*a1*la*s3*t368*t518*t521*2.0-a*a3*la*s1*t368*t518*t521*2.0+a*a1*la*s3*t368*t519*t521*2.0-a*a3*la*s1*t368*t519*t521*2.0+a*a1*la*s3*t368*t518*t533-a*a3*la*s1*t368*t518*t533+a*a1*la*s3*t368*t519*t533-a*a3*la*s1*t368*t519*t533+a*a1*la*s3*t368*t521*t533*2.0-a*a3*la*s1*t368*t521*t533*2.0-a*a3*la*s2*t368*t519*t521*4.0-a*a3*la*s3*t368*t519*t521*4.0-a*a1*mu*s1*t518*t521*t533*1.2E1-a*a1*mu*s2*t519*t521*t533*1.2E1-a*a1*mu*s3*t518*t519*t521*3.0+a*a3*mu*s1*t518*t519*t521*3.0-a*a1*mu*s3*t518*t519*t533*3.0+a*a3*mu*s1*t518*t519*t533*3.0-a*a1*mu*s3*t518*t521*t533*3.0+a*a3*mu*s1*t518*t521*t533*3.0-a*a1*mu*s3*t519*t521*t533*3.0+a*a3*mu*s1*t519*t521*t533*3.0+a*a3*mu*s2*t519*t521*t533*1.2E1+a1*k*s1*s3*t518*t521*t533*4.0+a1*k*s2*s3*t519*t521*t533*4.0-a3*k*s1*s2*t519*t521*t533*4.0-a3*k*s1*s3*t518*t519*t521*4.0-a*la*s1*s2*s3*t368*t519*2.0+a1*la*s1*s3*t368*t518*t521*2.0+a1*la*s1*s3*t368*t521*t533*2.0-a3*la*s1*s2*t368*t519*t521*2.0+a1*la*s2*s3*t368*t521*t533*2.0-a3*la*s1*s2*t368*t521*t533*2.0-a3*la*s1*s3*t368*t518*t521*2.0-a3*la*s1*s3*t368*t519*t521*2.0-a1*mu*s1*s3*t518*t521*t533*6.0-a1*mu*s2*s3*t519*t521*t533*6.0+a3*mu*s1*s2*t519*t521*t533*6.0+a3*mu*s1*s3*t518*t519*t521*6.0+a*a1*k*s1*s2*s3*t521*t533*8.0-a*a3*k*s1*s2*s3*t519*t521*8.0-a*a3*la*s1*s2*s3*t368*t521*4.0-a*a1*mu*s1*s2*s3*t521*t533*1.2E1+a*a3*mu*s1*s2*s3*t519*t521*1.2E1))/(t519-t533);
    dP_dF.x3223 = (t364*t374*t386*(t584-t587-t592-t597+t618-t619+t620-t621-t622+t623+t624-t625+t626-t627-t628-t629+t630+t631+t632-t633-t634+t635-t636+t637-t638+t639-t640+t641-t642+t643-t644+t645-t646+t647-t648+t649-t650+t651-t652+t653-t654-t655+t656+t657+t658-t659-t660+t661-t662-t663+t664+t665-t666-t667+t668+t669+t670-t671+la*t518*t523*5.0-la*t523*t533*5.0+mu*t518*t523*4.0-mu*t523*t533*4.0+a*la*s2*t523*3.0-a*la*s3*t523*3.0+a*mu*s2*t523*2.0-a*mu*s3*t523*2.0-a2*la*t523*t533*1.2E1+a3*la*t518*t523*1.2E1-a2*mu*t523*t533*4.0+a3*mu*t518*t523*4.0-a*a2*la*s3*t523*9.0+a*a3*la*s2*t523*9.0-a*a2*mu*s3*t523*3.0+a*a3*mu*s2*t523*3.0-a2*la*s2*s3*t523*1.2E1+a3*la*s2*s3*t523*1.2E1+a2*k*t518*t523*t533*4.0+a2*k*t519*t523*t533*4.0+a2*k*t521*t523*t533*4.0-a3*k*t518*t519*t523*4.0-a3*k*t518*t521*t523*4.0-a3*k*t518*t523*t533*4.0+a*la*s1*t518*t521*8.0-a*la*s1*t521*t533*8.0+a*la*s2*t518*t519+a*la*s2*t518*t521*2.0+a*la*s2*t519*t521*2.0-a*la*s2*t521*t533*3.0+a*la*s3*t518*t521*3.0-a*la*s3*t519*t521*2.0-a*la*s3*t519*t533-a*la*s3*t521*t533*2.0-a2*mu*s2*s3*t523*4.0+a3*mu*s2*s3*t523*4.0+a*mu*s1*t518*t521*8.0-a*mu*s1*t521*t533*8.0+a*mu*s2*t518*t519*2.0+a*mu*s2*t518*t521*2.0+a*mu*s3*t518*t521*2.0-a*mu*s3*t519*t533*2.0+a2*la*t368*t523*t533*4.0-a3*la*t368*t518*t523*4.0-a2*la*t518*t521*t533*4.0+a3*la*t518*t521*t533*4.0-a2*mu*t518*t521*t533*2.0-a2*mu*t518*t523*t533*6.0-a2*mu*t521*t523*t533*6.0+a3*mu*t518*t521*t523*6.0+a3*mu*t518*t521*t533*2.0+a3*mu*t518*t523*t533*6.0-la*s1*s2*t368*t523*4.0+la*s1*s3*t368*t523*4.0+la*s1*s2*t518*t521*3.0-la*s1*s2*t521*t533*4.0+la*s1*s3*t518*t521*4.0-la*s1*s3*t521*t533*3.0+la*s2*s3*t518*t521-la*s2*s3*t521*t533+mu*s1*s2*t518*t521*4.0-mu*s1*s2*t521*t533*4.0+mu*s1*s3*t518*t521*4.0-mu*s1*s3*t521*t533*4.0+mu*s2*s3*t518*t519+mu*s2*s3*t518*t521-mu*s2*s3*t519*t533-mu*s2*s3*t521*t533-la*t368*t518*t519*t521*4.0+la*t368*t519*t521*t533*4.0-la*s1*s2*t368*t518*t521*4.0+la*s1*s3*t368*t521*t533*4.0-la*s2*s3*t368*t518*t519-la*s2*s3*t368*t518*t521+la*s2*s3*t368*t519*t533+la*s2*s3*t368*t521*t533+a*a2*k*s1*t523*t533*8.0-a*a3*k*s1*t518*t523*8.0+a*a2*k*s2*t523*t533*8.0+a*a2*k*s3*t518*t523*2.0-a*a3*k*s2*t518*t523*2.0+a*a2*k*s3*t519*t523*2.0-a*a3*k*s2*t519*t523*2.0+a*a2*k*s3*t521*t523*2.0-a*a3*k*s2*t521*t523*2.0+a*a2*k*s3*t523*t533*2.0-a*a3*k*s2*t523*t533*2.0-a*a3*k*s3*t518*t523*8.0-a*a2*la*s1*t518*t533*2.0-a*a2*la*s1*t521*t533*1.4E1+a*a2*la*s3*t368*t523*3.0-a*a3*la*s2*t368*t523*3.0+a*a3*la*s1*t518*t521*1.4E1+a*a3*la*s1*t518*t533*2.0-a*a2*la*s2*t521*t533*1.4E1-a*a2*la*s3*t518*t519+a*a3*la*s2*t518*t519-a*a2*la*s3*t518*t521*4.0+a*a3*la*s2*t518*t521*4.0-a*a2*la*s3*t519*t521*4.0+a*a3*la*s2*t519*t521*4.0-a*a2*la*s3*t518*t533+a*a3*la*s2*t518*t533-a*a2*la*s3*t519*t533+a*a3*la*s2*t519*t533-a*a2*la*s3*t521*t533*4.0+a*a3*la*s2*t521*t533*4.0+a*a3*la*s3*t518*t521*1.4E1-a*a2*mu*s1*t521*t533*4.0-a*a2*mu*s1*t523*t533*1.2E1+a*a3*mu*s1*t518*t521*4.0+a*a3*mu*s1*t518*t523*1.2E1-a*a2*mu*s2*t521*t533*4.0-a*a2*mu*s2*t523*t533*1.2E1-a*a2*mu*s3*t518*t519+a*a3*mu*s2*t518*t519-a*a2*mu*s3*t518*t521*2.0+a*a3*mu*s2*t518*t521*2.0-a*a2*mu*s3*t519*t521*2.0+a*a3*mu*s2*t519*t521*2.0-a*a2*mu*s3*t518*t523*3.0+a*a3*mu*s2*t518*t523*3.0-a*a2*mu*s3*t519*t523*3.0+a*a3*mu*s2*t519*t523*3.0-a*a2*mu*s3*t521*t523*3.0+a*a3*mu*s2*t521*t523*3.0-a*a2*mu*s3*t518*t533+a*a3*mu*s2*t518*t533-a*a2*mu*s3*t519*t533+a*a3*mu*s2*t519*t533-a*a2*mu*s3*t521*t533*2.0+a*a3*mu*s2*t521*t533*2.0-a*a2*mu*s3*t523*t533*3.0+a*a3*mu*s2*t523*t533*3.0+a*a3*mu*s3*t518*t521*4.0+a*a3*mu*s3*t518*t523*1.2E1+a2*k*s1*s2*t523*t533*1.6E1+a2*k*s1*s3*t518*t523*4.0-a3*k*s1*s2*t518*t523*4.0+a2*k*s1*s3*t521*t523*4.0-a3*k*s1*s2*t521*t523*4.0+a2*k*s1*s3*t523*t533*4.0-a3*k*s1*s2*t523*t533*4.0-a3*k*s1*s3*t518*t523*1.6E1+a2*k*s2*s3*t519*t523*4.0+a2*k*s2*s3*t521*t523*4.0+a2*k*s2*s3*t523*t533*4.0-a3*k*s2*s3*t518*t523*4.0-a3*k*s2*s3*t519*t523*4.0-a3*k*s2*s3*t521*t523*4.0+a*la*s1*s2*s3*t518-a*la*s1*s2*s3*t533+a*mu*s1*s2*s3*t518*2.0-a*mu*s1*s2*s3*t533*2.0+a2*la*s1*s3*t368*t523*4.0-a3*la*s1*s2*t368*t523*4.0-a2*la*s1*s2*t521*t533*1.2E1+a2*la*s2*s3*t368*t523*4.0+a3*la*s1*s2*t518*t521*4.0-a2*la*s1*s3*t521*t533*4.0-a3*la*s2*s3*t368*t523*4.0+a3*la*s1*s3*t518*t521*1.2E1-a2*la*s2*s3*t519*t521*4.0-a2*la*s2*s3*t521*t533*4.0+a3*la*s2*s3*t518*t521*4.0+a3*la*s2*s3*t519*t521*4.0+a2*k*t518*t519*t521*t533*4.0-a3*k*t518*t519*t521*t533*4.0-a*la*s1*t368*t518*t521*8.0+a*la*s1*t368*t521*t533*8.0-a*la*s2*t368*t518*t519*2.0-a*la*s2*t368*t519*t521*2.0+a*la*s2*t368*t519*t533*2.0-a*la*s3*t368*t518*t519*2.0+a*la*s3*t368*t519*t521*2.0+a*la*s3*t368*t519*t533*2.0-a2*mu*s1*s2*t523*t533*2.4E1+a3*mu*s1*s2*t518*t521*2.0+a3*mu*s1*s2*t518*t523*6.0-a2*mu*s1*s3*t521*t533*2.0-a2*mu*s1*s3*t523*t533*6.0-a2*mu*s2*s3*t519*t521*2.0+a3*mu*s1*s3*t518*t523*2.4E1-a2*mu*s2*s3*t519*t523*6.0-a2*mu*s2*s3*t521*t523*6.0-a2*mu*s2*s3*t521*t533*2.0-a2*mu*s2*s3*t523*t533*6.0+a3*mu*s2*s3*t518*t521*2.0+a3*mu*s2*s3*t519*t521*2.0+a3*mu*s2*s3*t518*t523*6.0+a3*mu*s2*s3*t519*t523*6.0+a3*mu*s2*s3*t521*t523*6.0+a2*la*t368*t518*t521*t533*2.0+a2*la*t368*t519*t521*t533*2.0-a3*la*t368*t518*t519*t521*2.0-a3*la*t368*t518*t521*t533*2.0+a*a2*k*s1*s2*s3*t523*8.0-a*a3*k*s1*s2*s3*t523*8.0-a*a2*la*s1*s2*s3*t533*2.0+a*a3*la*s1*s2*s3*t518*2.0+a*a2*k*s1*t518*t521*t533*8.0-a*a3*k*s1*t518*t521*t533*8.0+a*a2*k*s2*t519*t521*t533*8.0+a*a2*k*s3*t518*t519*t521*2.0-a*a3*k*s2*t518*t519*t521*2.0+a*a2*k*s3*t518*t519*t533*2.0-a*a3*k*s2*t518*t519*t533*2.0+a*a2*k*s3*t518*t521*t533*2.0-a*a3*k*s2*t518*t521*t533*2.0+a*a2*k*s3*t519*t521*t533*2.0-a*a3*k*s2*t519*t521*t533*2.0-a*a3*k*s3*t518*t519*t521*8.0+a*a2*la*s1*t368*t521*t533*4.0-a*a3*la*s1*t368*t518*t521*4.0+a*a2*la*s2*t368*t521*t533*4.0+a*a2*la*s3*t368*t518*t519-a*a3*la*s2*t368*t518*t519+a*a2*la*s3*t368*t518*t521*2.0-a*a3*la*s2*t368*t518*t521*2.0+a*a2*la*s3*t368*t519*t521*2.0-a*a3*la*s2*t368*t519*t521*2.0+a*a2*la*s3*t368*t518*t533-a*a3*la*s2*t368*t518*t533+a*a2*la*s3*t368*t519*t533-a*a3*la*s2*t368*t519*t533+a*a2*la*s3*t368*t521*t533*2.0-a*a3*la*s2*t368*t521*t533*2.0-a*a3*la*s3*t368*t518*t521*4.0-a*a2*mu*s1*t518*t521*t533*1.2E1+a*a3*mu*s1*t518*t521*t533*1.2E1-a*a2*mu*s3*t518*t519*t521*3.0+a*a3*mu*s2*t518*t519*t521*3.0-a*a2*mu*s3*t518*t519*t533*3.0+a*a3*mu*s2*t518*t519*t533*3.0-a*a2*mu*s3*t518*t521*t533*3.0+a*a3*mu*s2*t518*t521*t533*3.0-a*a2*mu*s3*t519*t521*t533*3.0+a*a3*mu*s2*t519*t521*t533*3.0+a2*k*s1*s3*t518*t521*t533*4.0-a3*k*s1*s2*t518*t521*t533*4.0+a2*k*s2*s3*t519*t521*t533*4.0-a3*k*s2*s3*t518*t519*t521*4.0+a2*la*s1*s3*t368*t518*t521*2.0-a3*la*s1*s2*t368*t518*t521*2.0+a2*la*s1*s3*t368*t521*t533*2.0-a3*la*s1*s2*t368*t521*t533*2.0+a2*la*s2*s3*t368*t519*t521*2.0+a2*la*s2*s3*t368*t521*t533*2.0-a3*la*s2*s3*t368*t518*t521*2.0-a3*la*s2*s3*t368*t519*t521*2.0-a2*mu*s1*s3*t518*t521*t533*6.0+a3*mu*s1*s2*t518*t521*t533*6.0-a2*mu*s2*s3*t519*t521*t533*6.0+a3*mu*s2*s3*t518*t519*t521*6.0+a*a2*k*s1*s2*s3*t521*t533*8.0-a*a3*k*s1*s2*s3*t518*t521*8.0+a*a2*la*s1*s2*s3*t368*t521*4.0-a*a3*la*s1*s2*s3*t368*t521*4.0-a*a2*mu*s1*s2*s3*t521*t533*1.2E1+a*a3*mu*s1*s2*s3*t518*t521*1.2E1))/(t518-t533);
