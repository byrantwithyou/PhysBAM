...
//#####################################################################
// Class COROTATED_QUARTIC
//#####################################################################
#ifndef __COROTATED_QUARTIC__
#define __COROTATED_QUARTIC__
...
class COROTATED_QUARTIC:public ISOTROPIC_CONSTITUTIVE_MODEL<T,d>
{
...
public:
    ...
    COROTATED_QUARTIC(const T youngs_modulus_input=3e6,const T poissons_ratio_input=.475,const T Rayleigh_coefficient=.05,const T failure_threshold_input=.25);
    virtual ~COROTATED_QUARTIC();
