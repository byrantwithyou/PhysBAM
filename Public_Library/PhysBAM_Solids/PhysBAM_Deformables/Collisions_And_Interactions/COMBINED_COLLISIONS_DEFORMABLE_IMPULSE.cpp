...
template class COMBINED_COLLISIONS_DEFORMABLE_IMPULSE<VECTOR<float,1> >;
template class COMBINED_COLLISIONS_DEFORMABLE_IMPULSE<VECTOR<float,2> >;
template class COMBINED_COLLISIONS_DEFORMABLE_IMPULSE<VECTOR<float,3> >;
#ifndef COMPILE_WITHOUT_DOUBLE_SUPPORT
template class COMBINED_COLLISIONS_DEFORMABLE_IMPULSE<VECTOR<double,1> >;
template class COMBINED_COLLISIONS_DEFORMABLE_IMPULSE<VECTOR<double,2> >;
template class COMBINED_COLLISIONS_DEFORMABLE_IMPULSE<VECTOR<double,3> >;
#endif
