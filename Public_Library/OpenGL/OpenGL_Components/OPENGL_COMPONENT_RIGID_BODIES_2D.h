//#####################################################################
// Copyright 2004-2007, Eran Guendelman, Tamar Shinar, Rachel Weinstein.
// This file is part of PhysBAM whose distribution is governed by the license contained in the accompanying file PHYSBAM_COPYRIGHT.txt.
//#####################################################################
// Class OPENGL_COMPONENT_RIGID_BODIES_2D
//#####################################################################
#ifndef __OPENGL_COMPONENT_RIGID_BODIES_2D__
#define __OPENGL_COMPONENT_RIGID_BODIES_2D__
...
template<class T>
class OPENGL_COMPONENT_RIGID_BODIES_2D:public OPENGL_COMPONENT<T>
{
private:
...
public:
    ...
    OPENGL_COMPONENT_RIGID_BODIES_2D(STREAM_TYPE stream_type,const std::string& basedir);
    OPENGL_COMPONENT_RIGID_BODIES_2D(STREAM_TYPE stream_type,RIGID_BODY_COLLECTION<TV>& rigid_body_collection,const std::string& basedir);
    virtual ~OPENGL_COMPONENT_RIGID_BODIES_2D();
    ...
    DEFINE_COMPONENT_CALLBACK(OPENGL_COMPONENT_RIGID_BODIES_2D, Toggle_Velocity_Vectors, "Toggle velocity vectors");
    DEFINE_COMPONENT_CALLBACK(OPENGL_COMPONENT_RIGID_BODIES_2D, Toggle_Individual_Axes, "Toggle individual axes");
    DEFINE_COMPONENT_CALLBACK(OPENGL_COMPONENT_RIGID_BODIES_2D, Toggle_Output_Positions, "Toggle output positions");
    DEFINE_COMPONENT_CALLBACK(OPENGL_COMPONENT_RIGID_BODIES_2D, Toggle_Show_Object_Names, "Toggle show object names");
    DEFINE_COMPONENT_CALLBACK(OPENGL_COMPONENT_RIGID_BODIES_2D, Toggle_Node_Velocity_Vectors, "Toggle node velocity vectors");
    DEFINE_COMPONENT_CALLBACK(OPENGL_COMPONENT_RIGID_BODIES_2D, Toggle_Articulation_Points, "Toggle articulation points");
    DEFINE_COMPONENT_CALLBACK(OPENGL_COMPONENT_RIGID_BODIES_2D, Toggle_Linear_Muscles, "Toggle linear muscles");
    DEFINE_COMPONENT_CALLBACK(OPENGL_COMPONENT_RIGID_BODIES_2D, Toggle_Draw_Mode, "Toggle draw mode");
    DEFINE_COMPONENT_CALLBACK(OPENGL_COMPONENT_RIGID_BODIES_2D, Toggle_Forces_And_Torques, "Toggle forces and torques");
    DEFINE_COMPONENT_CALLBACK(OPENGL_COMPONENT_RIGID_BODIES_2D, Increase_Vector_Size, "Increase vector size");
    DEFINE_COMPONENT_CALLBACK(OPENGL_COMPONENT_RIGID_BODIES_2D, Decrease_Vector_Size, "Decrease vector size");
...
template<class T>
class OPENGL_SELECTION_COMPONENT_RIGID_BODIES_2D:public OPENGL_SELECTION<T>
{
public:
    ...
    OPENGL_SELECTION_COMPONENT_RIGID_BODIES_2D(OPENGL_OBJECT<T>* object,const int body_id,OPENGL_SELECTION<T>* body_selection)
