...
OPENGL_POINTS_3D(T_ARRAY& points_input,const OPENGL_COLOR& color_input,const T point_size_input)
    :points(points_input),color(color_input),point_size(point_size_input),draw_point_numbers(false),point_colors(0),point_ids(0),draw_mask(0),selected_index(-1),selected_id(-1),selected_old_color(color)
{}
//#####################################################################
// Destructor
//#####################################################################
