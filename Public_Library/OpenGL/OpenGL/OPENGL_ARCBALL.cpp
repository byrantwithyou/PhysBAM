...
//#####################################################################
template<class T> void OPENGL_ARCBALL<T>::
Update_Obj(const VECTOR<T,2> &vNow)
{
    if(!use_sphere_center){
...
//#####################################################################
template<class T> auto OPENGL_ARCBALL<T>::
MouseOnSphere(const VECTOR<T,2> &mouse,const SPHERE<TV> &sphere,const TV &previous_result) -> TV
{
...
//#####################################################################
// Function Qt_ToBallPoints
//#####################################################################
template<class T> void OPENGL_ARCBALL<T>::
Qt_ToBallPoints(const ROTATION<TV> &q,TV &arcFrom,TV &arcTo)
{
    arcFrom=q.Get_Axis().Unit_Orthogonal_Vector();
    arcTo=q.Rotate(arcFrom);
}
//#####################################################################
