...
template void TENSOR_TESTS<double>::Test_0();
template void TENSOR_TESTS<double>::Test_1<1>();
template void TENSOR_TESTS<double>::Test_1<2>();
template void TENSOR_TESTS<double>::Test_1<3>();
