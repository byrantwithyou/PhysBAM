...
int main(int argc,char *argv[])
{
    ...
    if(type_double)
        if(use_3d) Convert<double,3>(input_directory,output_filename_pattern,dump_valid);
        else Convert<double,2>(input_directory,output_filename_pattern,dump_valid);
    else
        if(use_3d) Convert<float,3>(input_directory,output_filename_pattern,dump_valid);
        else Convert<float,2>(input_directory,output_filename_pattern,dump_valid);
