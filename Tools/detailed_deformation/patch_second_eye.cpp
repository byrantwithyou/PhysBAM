...
int main(int argc,char *argv[])
{
    ...
    FILE_UTILITIES::Write_To_File<float>("left_tri.tri",tri_surf);
...
*/      
    ...
    FILE_UTILITIES::Write_To_File<float>("patched_eyes.tri",tri_surf);
    FILE_UTILITIES::Write_To_File<float>("patched_eyes.col",vertex_colors);
