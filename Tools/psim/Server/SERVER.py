...
class SERVER:
    def __init__(self):
        ...
        self.sessions={}
        self.next_id=1
        self.server_id="psim/%s"%os.environ["HOSTNAME"]
        self.hosts_client=client=SOCKET.CLIENT(CONFIG.hosts_server,CONFIG.hosts_port,
                  (open(os.path.join(CONFIG.keys_directory,CONFIG.client_private_key_file)).read(),
                   open(os.path.join(CONFIG.keys_directory,CONFIG.client_certificate_file)).read(),
                   open(os.path.join(CONFIG.keys_directory,CONFIG.ca_certificate_file)).read()))
        ...
        self.commands=["Session_Info","Session_List","Create_Session","Activate_Session","Deactivate_Session","Label_Session","Update_State","Host_List","Update_Status","Session_Directory"]
...
if __name__ == "__main__":
    server=SERVER()
    SOCKET.SERVER(socket.gethostbyname(os.environ['HOSTNAME']),CONFIG.server_port,server,
