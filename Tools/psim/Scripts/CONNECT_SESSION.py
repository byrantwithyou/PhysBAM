...
def Connect_Session(d,id):
    ...
    if machine==None:
        ...
        sys.exit(0)
    sshcommand="ssh "+machine+" -t \"cd "+session_directory+"; export PSIM_SESSION_DIRECTORY="+session_directory+";export PSIM_SESSION_ID="+str(id)+";export PSIM_SERVER_HOST="+os.environ["PSIM_SERVER_HOST"]+";export PSIM_SERVER_PORT="+os.environ["PSIM_SERVER_PORT"]+";bash\""
